...
class UserBase(BaseModel):
    ...
    is_superuser: bool = Field(default=False, description="是否为超级用户（租户内）")
    is_tenant_admin: bool = Field(default=False, description="是否为租户管理员")
...
class UserCreate(UserBase):
    ...
    Attributes:
        ...
        is_superuser: 是否为超级用户（默认 False）
        is_tenant_admin: 是否为租户管理员（默认 False）
    """
...
class UserUpdate(BaseModel):
    ...
    Attributes:
        ...
        full_name: 用户全名（可选）
        is_active: 是否激活（可选）
        is_superuser: 是否为超级用户（可选）
        is_tenant_admin: 是否为租户管理员（可选）
    """
    ...
    is_superuser: Optional[bool] = Field(None, description="是否为超级用户（租户内）")
    is_tenant_admin: Optional[bool] = Field(None, description="是否为租户管理员")
