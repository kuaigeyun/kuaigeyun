...
COMMENT ON COLUMN "core_users"."tenant_id" IS '租户 ID（外键，关联到 core_tenants 表）';
COMMENT ON COLUMN "core_users"."created_at" IS '创建时间';
COMMENT ON COLUMN "core_users"."updated_at" IS '更新时间';
COMMENT ON COLUMN "core_users"."username" IS '用户名（租户内唯一）';
...
COMMENT ON COLUMN "core_users"."is_superuser" IS '是否为超级用户（租户内）';
COMMENT ON COLUMN "core_users"."is_tenant_admin" IS '是否为租户管理员';
...
COMMENT ON COLUMN "core_roles"."tenant_id" IS '租户 ID（外键，关联到 core_tenants 表）';
COMMENT ON COLUMN "core_roles"."created_at" IS '创建时间';
COMMENT ON COLUMN "core_roles"."updated_at" IS '更新时间';
COMMENT ON COLUMN "core_roles"."name" IS '角色名称（租户内唯一）';
COMMENT ON COLUMN "core_roles"."code" IS '角色代码（租户内唯一，用于程序识别）';
...
COMMENT ON COLUMN "core_permissions"."tenant_id" IS '租户 ID（外键，关联到 core_tenants 表）';
COMMENT ON COLUMN "core_permissions"."created_at" IS '创建时间';
COMMENT ON COLUMN "core_permissions"."updated_at" IS '更新时间';
COMMENT ON COLUMN "core_permissions"."name" IS '权限名称（租户内唯一）';
COMMENT ON COLUMN "core_permissions"."code" IS '权限代码（租户内唯一，格式：resource:action）';
