...
PAGE_CODE_TO_FIXED_TEXT_PRESET: Dict[str, str] = {
    ...
    "kuaizhizao-quality-complaint": "TS",  # 质量投诉（编码中心，禁止 RC 硬编码）
    "kuaizhizao-supplier-eval": "SE",  # 供应商评价（R-03）
    "kuaizhizao-supplier-eval-template": "SET",  # 供应商评价模板
    "kuaizhizao-supplier-eval-plan": "SEP",  # 供应商评价计划
    ...
    "kuaizhizao-equipment-management-acceptance": "YS",  # 设备工装验收
    ...
    "kuaiplm-product-firmware": "GJRJ",             # 产品固件
    "kuaiplm-production-file": "SCWJ",              # 生产文件中心
    "kuaiplm-sample-process": "YPJG",               # 样品加工
    "kuaiplm-material-review": "WLPJ",              # 物料评审
    "kuaiplm-bom-collab": "BOMX",                   # BOM协同
    "kuaiplm-project-proposal": "XMJY",             # 项目建议
    "kuaiplm-mold-sample": "KMTY",                  # 开模打样
}
...
CODE_RULE_PAGES: List[CodeRulePageConfig] = [
    ...
    {
        "page_code": "kuaizhizao-production-daily-template",
        "page_name": "生产日报模板",
        "page_path": "/apps/kuaizhizao/production-execution/production-daily-templates",
        "code_field": "template_code",
        "code_field_label": "模板编码",
        "module": "快格轻制造",
        "module_icon": "tool",
    ...
    {
        "page_code": "kuaizhizao-production-daily",
        "page_name": "生产日报",
        "page_path": "/apps/kuaizhizao/production-execution/production-daily-reports",
        "code_field": "code",
        "code_field_label": "日报单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaizhizao-label-model-config",
        "page_name": "标签型号配置",
        "page_path": "/apps/kuaizhizao/production-execution/label-station",
        "code_field": "model_code",
        "code_field_label": "型号编码",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "LABEL_MODEL_CONFIG_CODE",
        "allow_manual_edit": True,
    },
    {
        "page_code": "kuaizhizao-label-station",
        "page_name": "标签工位",
        "page_path": "/apps/kuaizhizao/production-execution/label-station",
        "code_field": "station_code",
        "code_field_label": "工位编码",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "LABEL_STATION_CODE",
        "allow_manual_edit": True,
    },
    {
        "page_code": "kuaizhizao-label-station-box",
        "page_name": "标签工位箱号",
        "page_path": "/apps/kuaizhizao/production-execution/label-station",
        "code_field": "box_no",
        "code_field_label": "箱号",
        ...
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "LABEL_STATION_BOX_CODE",
        "allow_manual_edit": False,
    },
    {
        "page_code": "kuaizhizao-label-station-job",
        "page_name": "标签打印任务号",
        "page_path": "/apps/kuaizhizao/production-execution/label-station",
        "code_field": "print_job_code",
        "code_field_label": "任务号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
        "rule_code": "LABEL_STATION_JOB_CODE",
        "allow_manual_edit": False,
    },
    {
    ...
    {
        "page_code": "kuaizhizao-quality-complaint",
        "page_name": "质量投诉",
        "page_path": "/apps/kuaizhizao/quality-management/quality-complaints",
        "code_field": "code",
        "code_field_label": "投诉单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaizhizao-supplier-eval",
        "page_name": "供应商评价",
        "page_path": "/apps/kuaizhizao/quality-management/supplier-evaluations",
        "code_field": "code",
        "code_field_label": "评价单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaizhizao-supplier-eval-template",
        "page_name": "供应商评价模板",
        "page_path": "/apps/kuaizhizao/quality-management/supplier-evaluations",
        "code_field": "code",
        "code_field_label": "模板编码",
    ...
    {
        "page_code": "kuaizhizao-supplier-eval-plan",
        "page_name": "供应商评价计划",
        "page_path": "/apps/kuaizhizao/quality-management/supplier-evaluations",
        "code_field": "code",
        "code_field_label": "计划编码",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
    ...
    # 快格轻制造 - 设备工装验收（YS+日期+流水）
    {
        "page_code": "kuaizhizao-equipment-management-acceptance",
        "page_name": "设备工装验收",
        "page_path": "/apps/kuaizhizao/equipment-management/equipment-acceptances",
    ...
    {
        "page_code": "kuaizhizao-equipment-line-rebind",
        "page_name": "设备换线绑定",
        "page_path": "/apps/kuaizhizao/equipment-management/equipment-line-rebinds",
        "code_field": "document_no",
        "code_field_label": "换线单号",
        "module": "快格轻制造",
        "module_icon": "tool",
        "auto_generate": True,
    ...
    # ==================== 快研发增量 + 行业插件预留编码（INF-06）====================
    {
        "page_code": "kuaiplm-product-firmware",
        "page_name": "产品固件",
        "page_path": "/apps/kuaiplm/product-firmwares",
        "code_field": "firmware_code",
        "code_field_label": "固件单号",
        "module": "快研发",
        "module_icon": "layers",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaiplm-production-file",
        "page_name": "生产文件中心",
        "page_path": "/apps/kuaiplm/production-files",
        "code_field": "file_code",
        "code_field_label": "文件单号",
        "module": "快研发",
        "module_icon": "layers",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaiplm-trial-flow",
        "page_name": "试流管理",
        "page_path": "/apps/kuaiplm/trial-flows",
        "code_field": "trial_code",
        "code_field_label": "试流单号",
        "module": "快研发",
        "module_icon": "layers",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaiplm-lab-request",
        "page_name": "实验委托",
        "page_path": "/apps/kuaiplm/lab-requests",
        "code_field": "code",
        "code_field_label": "委托单号",
        "module": "快研发",
        "module_icon": "experiment",
        "auto_generate": True,
        "rule_code": "KUAI_PLM_LAB_REQUEST_CODE",
        "allow_manual_edit": True,
    },
    {
        "page_code": "kuaiplm-lab-judgment-rule",
        "page_name": "判定规则",
        "page_path": "/apps/kuaiplm/lab-judgment-rules",
    ...
    {
        "page_code": "kuaiplm-annual-lab-plan",
        "page_name": "年度实验计划",
        "page_path": "/apps/kuaiplm/annual-lab-plans",
        "code_field": "plan_code",
        "code_field_label": "计划单号",
        "module": "快研发",
        "module_icon": "experiment",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaiplm-project-proposal",
        "page_name": "项目建议",
        "page_path": "/apps/kuaiplm/project-proposals",
        "code_field": "proposal_code",
        "code_field_label": "建议单号",
        "module": "快研发",
        "module_icon": "layers",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaiplm-mold-sample",
        "page_name": "开模打样",
        "page_path": "/apps/kuaiplm/mold-sample-orders",
        "code_field": "order_code",
        "code_field_label": "合同/订单单号",
        "module": "快研发",
        "module_icon": "layers",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaiplm-bom-collab",
        "page_name": "BOM协同",
        "page_path": "/apps/kuaiplm/bom-collaborations",
        "code_field": "collab_code",
        "code_field_label": "协同单号",
        "module": "快研发",
        "module_icon": "layers",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaiplm-material-review",
        "page_name": "物料评审",
        "page_path": "/apps/kuaiplm/material-reviews",
        "code_field": "review_code",
        "code_field_label": "评审单号",
        "module": "快研发",
        "module_icon": "layers",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaiplm-sample-process",
        "page_name": "样品加工",
        "page_path": "/apps/kuaiplm/sample-process-applications",
        "code_field": "application_code",
        "code_field_label": "申请单号",
        "module": "快研发",
        "module_icon": "layers",
        "auto_generate": True,
    ...
    {
        "page_code": "kuaiplm-ecn",
        "page_name": "工程变更单",
        "page_path": "/apps/kuaiplm/engineering-changes",
        "code_field": "ecn_code",
        "code_field_label": "工程变更单号",
        "module": "快研发",
        "module_icon": "layers",
        "auto_generate": True,
    ...
    {
        "page_code": "industry-rework-fr",
        "page_name": "FR 流程单号",
        "page_path": "/plugins/industry/rework-fr",
        "code_field": "doc_code",
        "code_field_label": "FR 单号",
        "module": "行业插件",
        "module_icon": "layers",
        "auto_generate": False,
        "rule_code": "INDUSTRY_REWORK_FR",
        "allow_manual_edit": True,
    },
    {
        "page_code": "industry-complaint-rc",
        "page_name": "RC 投诉整改单号",
        "page_path": "/plugins/industry/complaint-rc",
        "code_field": "doc_code",
        "code_field_label": "RC 单号",
        "module": "行业插件",
        "module_icon": "layers",
        "auto_generate": False,
        "rule_code": "INDUSTRY_COMPLAINT_RC",
        "allow_manual_edit": True,
    },
    {
        "page_code": "industry-packing-box",
        "page_name": "装箱箱号",
        "page_path": "/plugins/industry/packing-box",
        "code_field": "box_code",
        "code_field_label": "箱号",
        "module": "行业插件",
        "module_icon": "layers",
    ...
    {
        "page_code": "industry-label-job",
        "page_name": "标签打印任务号",
        "page_path": "/plugins/industry/label-job",
        "code_field": "job_code",
        "code_field_label": "任务号",
        "module": "行业插件",
        "module_icon": "layers",
        "auto_generate": False,
        "rule_code": "INDUSTRY_LABEL_JOB",
        "allow_manual_edit": True,
    },
]
