...
class OperationLogResponse(BaseModel):
    ...
    user_full_name: str | None = Field(None, description="操作用户全名")
    operation_type: str = Field(..., description="操作类型")
    operation_module: str | None = Field(None, description="操作模块")
    operation_object_type: str | None = Field(None, description="操作对象类型")
    operation_object_id: int | None = Field(None, description="操作对象ID")
    operation_object_uuid: str | None = Field(None, description="操作对象UUID")
    operation_content: str | None = Field(None, description="操作内容")
    ip_address: str | None = Field(None, description="操作IP")
    user_agent: str | None = Field(None, description="用户代理")
    request_method: str | None = Field(None, description="请求方法")
