...
class ApprovalHistoryResponse(BaseModel):
    ...
    from_node: str | None = Field(None, description="来源节点")
    to_node: str | None = Field(None, description="目标节点")
    from_approver_id: int | None = Field(None, description="原审批人ID")
    to_approver_id: int | None = Field(None, description="新审批人ID")
