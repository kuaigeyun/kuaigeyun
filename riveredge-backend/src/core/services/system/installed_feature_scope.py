...
_MESSAGE_TEMPLATE_REQUIRES_APPS: Dict[str, FrozenSet[str]] = {
    ...
    "KZ_QUALITY_COMPLAINT_DUE_OVERDUE": frozenset({"kuaizhizao"}),
    "KZ_INVENTORY_VERIFY_OPEN_OVERDUE": frozenset({"kuaizhizao"}),
    "KZ_INVENTORY_VERIFY_MONTH_END": frozenset({"kuaizhizao"}),
    "KZ_INVENTORY_VERIFY_PQC_CHECKED": frozenset({"kuaizhizao"}),
    "KZ_INVENTORY_VERIFY_OQC_NOTIFIED": frozenset({"kuaizhizao"}),
    "KZ_EQUIPMENT_FAULT_REPORTED": frozenset({"kuaizhizao"}),
    "KZ_EQUIPMENT_CALIBRATION_DUE_SOON": frozenset({"kuaizhizao"}),
    "KZ_EQUIPMENT_CALIBRATION_DUE_OVERDUE": frozenset({"kuaizhizao"}),
    "KZ_EQUIPMENT_CALIBRATION_DUE_SOON_EMAIL": frozenset({"kuaizhizao"}),
    "KZ_EQUIPMENT_CALIBRATION_DUE_OVERDUE_EMAIL": frozenset({"kuaizhizao"}),
    "KZ_EQUIPMENT_CALIBRATION_DUE_SOON_SMS": frozenset({"kuaizhizao"}),
    "KZ_EQUIPMENT_CALIBRATION_DUE_OVERDUE_SMS": frozenset({"kuaizhizao"}),
    "KZ_MOLD_SIGNBACK_DUE_SOON": frozenset({"kuaizhizao"}),
    "KZ_MOLD_SIGNBACK_DUE_OVERDUE": frozenset({"kuaizhizao"}),
    "KZ_SPOT_CHECK_SUBMITTED": frozenset({"kuaizhizao"}),
    "KZ_SPOT_CHECK_DUE_OVERDUE": frozenset({"kuaizhizao"}),
    "KZ_LINE_REBIND_FORCE_SPOT_OVERDUE": frozenset({"kuaizhizao"}),
    "KZ_EQUIPMENT_FAULT_ARRIVAL_OVERDUE": frozenset({"kuaizhizao"}),
    "KZ_SUPPLIER_ENV_DUE_SOON": frozenset({"kuaizhizao"}),
    "KZ_SUPPLIER_ENV_DUE_OVERDUE": frozenset({"kuaizhizao"}),
