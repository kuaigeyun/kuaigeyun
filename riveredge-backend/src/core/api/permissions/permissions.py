...
async def get_permission_list(
    ...
    name: str | None = Query(None, description="权限名称筛选"),
    code: str | None = Query(None, description="权限代码筛选"),
    resource: str | None = Query(None, description="资源筛选"),
    permission_type: str | None = Query(None, description="权限类型筛选"),
