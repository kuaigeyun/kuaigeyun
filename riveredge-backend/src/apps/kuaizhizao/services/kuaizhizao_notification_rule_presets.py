...
KUAIZHIZAO_NOTIFICATION_RULE_PRESETS: List[Dict[str, Any]] = [
    ...
    {
        "id": "kz_preset_quality_complaint_due_overdue",
        "scene_name": "质量投诉时效到期",
        "trigger_document": DOC_QUALITY_COMPLAINT,
        "trigger_action": ACTION_DUE_OVERDUE,
        "template_code": "KZ_QUALITY_COMPLAINT_DUE_OVERDUE",
        "recipient_scopes": ["creator", "pending_approvers", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_inventory_verify_open_overdue",
        "scene_name": "库存验证未开单",
        "trigger_document": DOC_REWORK_ORDER,
        "trigger_action": ACTION_OPEN_OVERDUE,
        "template_code": "KZ_INVENTORY_VERIFY_OPEN_OVERDUE",
        "recipient_scopes": ["user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_inventory_verify_month_end",
        "scene_name": "库存验证月末未完成",
        "trigger_document": DOC_REWORK_ORDER,
        "trigger_action": ACTION_MONTH_END_OVERDUE,
        "template_code": "KZ_INVENTORY_VERIFY_MONTH_END",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_inventory_verify_pqc_checked",
        "scene_name": "库存验证PQC已核对",
        "trigger_document": DOC_REWORK_ORDER,
        "trigger_action": ACTION_PQC_CHECKED,
        "template_code": "KZ_INVENTORY_VERIFY_PQC_CHECKED",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_inventory_verify_oqc_notified",
        "scene_name": "库存验证OQC结果通知",
        "trigger_document": DOC_REWORK_ORDER,
        "trigger_action": ACTION_OQC_NOTIFIED,
        "template_code": "KZ_INVENTORY_VERIFY_OQC_NOTIFIED",
        "recipient_scopes": ["user_specified"],
        "enabled": False,
    },
    {
    ...
    {
        "id": "kz_preset_equipment_fault_arrival_overdue",
        "scene_name": "设备维修到场超时",
        "trigger_document": DOC_EQUIPMENT_FAULT,
        "trigger_action": ACTION_ARRIVAL_OVERDUE,
        "template_code": "KZ_EQUIPMENT_FAULT_ARRIVAL_OVERDUE",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_equipment_calibration_due_soon",
        "scene_name": "设备外校到期前提醒",
        "trigger_document": DOC_EQUIPMENT_CALIBRATION,
        "trigger_action": ACTION_DUE_SOON,
        "template_code": "KZ_EQUIPMENT_CALIBRATION_DUE_SOON",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_equipment_calibration_due_overdue",
        "scene_name": "设备外校过期提醒",
        "trigger_document": DOC_EQUIPMENT_CALIBRATION,
        "trigger_action": ACTION_DUE_OVERDUE,
        "template_code": "KZ_EQUIPMENT_CALIBRATION_DUE_OVERDUE",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_mold_signback_due_soon",
        "scene_name": "模具供应商回签到期前提醒",
        "trigger_document": DOC_MOLD_SIGNBACK,
        "trigger_action": ACTION_DUE_SOON,
        "template_code": "KZ_MOLD_SIGNBACK_DUE_SOON",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_mold_signback_due_overdue",
        "scene_name": "模具供应商回签过期未执行提醒",
        "trigger_document": DOC_MOLD_SIGNBACK,
        "trigger_action": ACTION_DUE_OVERDUE,
        "template_code": "KZ_MOLD_SIGNBACK_DUE_OVERDUE",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_spot_check_submitted",
        "scene_name": "设备点检待审核",
        "trigger_document": DOC_EQUIPMENT_SPOT_CHECK,
        "trigger_action": ACTION_SUBMITTED,
        "template_code": "KZ_SPOT_CHECK_SUBMITTED",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_spot_check_due_overdue",
        "scene_name": "设备点检未点检或未审核超时",
        "trigger_document": DOC_EQUIPMENT_SPOT_CHECK,
        "trigger_action": ACTION_DUE_OVERDUE,
        "template_code": "KZ_SPOT_CHECK_DUE_OVERDUE",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_line_rebind_force_spot_overdue",
        "scene_name": "设备换线后未初检超时",
        "trigger_document": DOC_EQUIPMENT_LINE_REBIND,
        "trigger_action": ACTION_DUE_OVERDUE,
        "template_code": "KZ_LINE_REBIND_FORCE_SPOT_OVERDUE",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_supplier_env_due_soon",
        "scene_name": "供应商环保资料到期前提醒",
        "trigger_document": DOC_SUPPLIER_ENV,
        "trigger_action": ACTION_DUE_SOON,
        "template_code": "KZ_SUPPLIER_ENV_DUE_SOON",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
        "id": "kz_preset_supplier_env_due_overdue",
        "scene_name": "供应商环保资料过期提醒",
        "trigger_document": DOC_SUPPLIER_ENV,
        "trigger_action": ACTION_DUE_OVERDUE,
        "template_code": "KZ_SUPPLIER_ENV_DUE_OVERDUE",
        "recipient_scopes": ["creator", "user_specified"],
        "enabled": False,
    },
    {
