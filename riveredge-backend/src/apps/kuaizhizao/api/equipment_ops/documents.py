...
async def list_spot_checks(
    ...
    check_start_date: Optional[str] = Query(None, description="点检开始日期 YYYY-MM-DD"),
    check_end_date: Optional[str] = Query(None, description="点检结束日期 YYYY-MM-DD"),
...
async def list_route_patrols(
    ...
    keyword: Optional[str] = Query(None, description="模糊搜索"),
    order_by: Optional[str] = Query(None, description="排序字段（前缀-表示降序）"),
    patrol_start_date: Optional[str] = Query(None, description="巡检开始日期 YYYY-MM-DD"),
    patrol_end_date: Optional[str] = Query(None, description="巡检结束日期 YYYY-MM-DD"),
    created_start_date: Optional[str] = Query(None, description="创建开始日期 YYYY-MM-DD"),
    created_end_date: Optional[str] = Query(None, description="创建结束日期 YYYY-MM-DD"),
    has_abnormality: Optional[bool] = Query(None, description="是否异常"),
...
async def list_scrap_applications(
    ...
    scrap_start_date: Optional[str] = Query(None, description="报废日期起"),
    scrap_end_date: Optional[str] = Query(None, description="报废日期止"),
    ...
    rows, total = await svc.scrap_application_service.list(
        ...
        search=search,
        order_by=order_by,
        scrap_start_date=scrap_start_date,
        scrap_end_date=scrap_end_date,
        created_start_date=created_start_date,
        created_end_date=created_end_date,
...
async def list_transfer_applications(
    ...
    search: Optional[str] = Query(None, description="搜索关键词（与 keyword 等价）"),
    order_by: Optional[str] = Query(None, description="排序字段"),
    transfer_start_date: Optional[str] = Query(None, description="调拨日期起"),
    transfer_end_date: Optional[str] = Query(None, description="调拨日期止"),
    created_start_date: Optional[str] = Query(None, description="创建日期起"),
    created_end_date: Optional[str] = Query(None, description="创建日期止"),
    updated_start_date: Optional[str] = Query(None, description="更新日期起"),
    updated_end_date: Optional[str] = Query(None, description="更新日期止"),
