...
class AssemblyOrder(BaseModel):
    ...
    code = fields.CharField(max_length=50, db_index=True, description="组装单号")  # 租户内未删除唯一，见迁移 462
    ...
    total_quantity = fields.DecimalField(max_digits=14, decimal_places=4, default=0, description="组装数量（成品数量）")
