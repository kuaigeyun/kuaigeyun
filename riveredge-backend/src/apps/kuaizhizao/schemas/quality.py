...
class IncomingInspectionBase(BaseSchema):
    ...
    supplier_name: str | None = Field(None, max_length=200, description="供应商名称")
    material_id: int | None = Field(None, description="物料ID（如果使用items则不需要）")
    material_code: str | None = Field(None, max_length=50, description="物料编码（如果使用items则不需要）")
    material_name: str | None = Field(None, max_length=200, description="物料名称（如果使用items则不需要）")
    ...
    inspection_quantity: float | None = Field(None, gt=0, description="检验数量（如果使用items则不需要）")
    qualified_quantity: float | None = Field(None, ge=0, description="合格数量（如果使用items则不需要）")
    unqualified_quantity: float | None = Field(None, ge=0, description="不合格数量（如果使用items则不需要）")
    inspection_result: str = Field("待检验", max_length=20, description="检验结果")
    quality_status: str = Field("合格", max_length=20, description="质量状态")
    inspector_id: int | None = Field(None, description="检验人ID")
    inspector_name: str | None = Field(None, max_length=100, description="检验人姓名")
    inspection_time: datetime | None = Field(None, description="检验时间")
    ...
    inspection_standard: str | None = Field(None, description="检验标准")
    inspection_method: str | None = Field(None, max_length=100, description="检验方法")
    test_equipment: str | None = Field(None, max_length=200, description="测试设备")
    appearance_check: str | None = Field(None, max_length=20, description="外观检查")
    dimension_check: str | None = Field(None, max_length=20, description="尺寸检查")
    performance_check: str | None = Field(None, max_length=20, description="性能检查")
    other_checks: dict | None = Field(None, description="其他检查项目（JSON格式）")
    nonconformance_reason: str | None = Field(None, description="不合格原因")
    disposition: str | None = Field(None, max_length=50, description="处理方式")
...
class IncomingInspectionCreate(IncomingInspectionBase):
    """来料检验单创建schema"""
    inspection_code: str | None = Field(None, max_length=50, description="检验单编码（可选，如果不提供则自动生成）")
    items: list[IncomingInspectionItemCreate] | None = Field(None, description="检验明细列表（如果提供items，则忽略基础schema中的物料字段）")


class IncomingInspectionUpdate(IncomingInspectionBase):
    """来料检验单更新schema"""
    inspection_code: str | None = Field(None, max_length=50, description="检验单编码")
...
class ProcessInspectionBase(BaseSchema):
    ...
    workstation_id: int | None = Field(None, description="工位ID")
    workstation_name: str | None = Field(None, max_length=100, description="工位名称")
    ...
    material_spec: str | None = Field(None, max_length=200, description="物料规格")
    batch_number: str | None = Field(None, max_length=50, description="生产批次号")
    inspection_quantity: float = Field(..., gt=0, description="检验数量")
    qualified_quantity: float = Field(0, ge=0, description="合格数量")
    unqualified_quantity: float = Field(0, ge=0, description="不合格数量")
    inspection_result: str = Field("待检验", max_length=20, description="检验结果")
    ...
    inspection_method: str | None = Field(None, max_length=100, description="检验方法")
    test_equipment: str | None = Field(None, max_length=200, description="测试设备")
    process_parameters: dict | None = Field(None, description="过程参数检查（JSON格式）")
    quality_characteristics: dict | None = Field(None, description="质量特性检查（JSON格式）")
    measurement_data: dict | None = Field(None, description="测量数据（JSON格式）")
    nonconformance_reason: str | None = Field(None, description="不合格原因")
    disposition: str | None = Field(None, max_length=50, description="处理方式")
    corrective_action: str | None = Field(None, description="纠正措施")
...
class FinishedGoodsInspectionBase(BaseSchema):
    ...
    material_spec: str | None = Field(None, max_length=200, description="成品规格")
    batch_number: str | None = Field(None, max_length=50, description="生产批次号")
    inspection_quantity: float = Field(..., gt=0, description="检验数量")
    qualified_quantity: float = Field(0, ge=0, description="合格数量")
    unqualified_quantity: float = Field(0, ge=0, description="不合格数量")
    ...
    dimension_check: str | None = Field(None, max_length=20, description="尺寸检查")
    performance_check: str | None = Field(None, max_length=20, description="性能检查")
    function_test: str | None = Field(None, max_length=20, description="功能测试")
    packaging_check: str | None = Field(None, max_length=20, description="包装检查")
    documentation_check: str | None = Field(None, max_length=20, description="文件检查")
    other_checks: dict | None = Field(None, description="其他检查项目（JSON格式）")
    measurement_data: dict | None = Field(None, description="测量数据（JSON格式）")
    nonconformance_reason: str | None = Field(None, description="不合格原因")
    disposition: str | None = Field(None, max_length=50, description="处理方式")
    corrective_action: str | None = Field(None, description="纠正措施")
    preventive_action: str | None = Field(None, description="预防措施")
    release_certificate: str | None = Field(None, max_length=100, description="放行证书号")
...
class QualityStandardBase(BaseSchema):
    ...
    material_id: int | None = Field(None, description="关联物料ID（为空则适用于所有物料）")
    material_code: str | None = Field(None, max_length=50, description="关联物料编码")
    material_name: str | None = Field(None, max_length=200, description="关联物料名称")
    inspection_items: dict[str, Any] | None = Field(None, description="检验项目列表（JSON格式）")
    inspection_methods: dict[str, Any] | None = Field(None, description="检验方法列表（JSON格式）")
    acceptance_criteria: dict[str, Any] | None = Field(None, description="合格标准（JSON格式）")
...
class QualityStandardCreate(QualityStandardBase):
    """质检标准创建schema"""
    standard_code: str | None = Field(None, max_length=50, description="标准编码（可选，如果不提供则自动生成）")


class QualityStandardUpdate(QualityStandardBase):
    """质检标准更新schema"""
    standard_code: str | None = Field(None, max_length=50, description="标准编码")
    standard_name: str | None = Field(None, max_length=200, description="标准名称")
    standard_type: str | None = Field(None, max_length=50, description="标准类型")
