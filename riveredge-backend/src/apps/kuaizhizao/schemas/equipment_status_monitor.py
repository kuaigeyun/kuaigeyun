...
class EquipmentStatusMonitorBase(BaseModel):
    ...
    runtime_hours: Decimal | None = Field(None, description="运行时长（小时）")
    last_maintenance_date: datetime | None = Field(None, description="上次维护日期")
    next_maintenance_date: datetime | None = Field(None, description="下次维护日期")
    temperature: Decimal | None = Field(None, description="温度（摄氏度）")
    pressure: Decimal | None = Field(None, description="压力")
    vibration: Decimal | None = Field(None, description="振动值")
    other_parameters: dict[str, Any] | None = Field(None, description="其他参数（JSON格式）")
...
class EquipmentStatusMonitorUpdate(BaseModel):
    ...
    更新设备状态监控记录 Schema
    """
    status: str | None = Field(None, max_length=50, description="设备状态")
    is_online: bool | None = Field(None, description="是否在线")
    runtime_hours: Decimal | None = Field(None, description="运行时长（小时）")
    last_maintenance_date: datetime | None = Field(None, description="上次维护日期")
    next_maintenance_date: datetime | None = Field(None, description="下次维护日期")
    temperature: Decimal | None = Field(None, description="温度（摄氏度）")
    ...
    vibration: Decimal | None = Field(None, description="振动值")
    other_parameters: dict[str, Any] | None = Field(None, description="其他参数（JSON格式）")
    data_source: str | None = Field(None, max_length=50, description="数据来源")
    monitored_at: datetime | None = Field(None, description="监控时间")
...
class EquipmentStatusHistoryResponse(BaseModel):
    ...
    from_status: str | None = Field(None, description="原状态")
    ...
    changed_by_name: str | None = Field(None, description="变更人姓名")
...
class EquipmentStatusUpdateRequest(BaseModel):
    ...
    is_online: bool | None = Field(None, description="是否在线")
    reason: str | None = Field(None, max_length=200, description="变更原因")
    remark: str | None = Field(None, description="备注")
