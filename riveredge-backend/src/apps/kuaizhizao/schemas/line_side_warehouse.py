...
class LineSideInventoryBase(BaseModel):
    ...
    warehouse_name: str | None = Field(None, description="线边仓名称")
    material_id: int = Field(..., description="物料ID")
    material_code: str = Field(..., description="物料编码")
    material_name: str = Field(..., description="物料名称")
    material_spec: str | None = Field(None, description="规格型号")
    material_unit: str | None = Field(None, description="单位")
    ...
    source_doc_id: int | None = Field(None, description="来源单据ID")
    source_doc_code: str | None = Field(None, description="来源单据编码")
...
class LineSideTransferInCreate(BaseModel):
    ...
    work_order_id: int | None = Field(None, description="预留工单ID")
    work_order_code: str | None = Field(None, description="预留工单编码")
...
class BackflushRecordBase(BaseModel):
    ...
    operation_id: int | None = Field(None, description="工序单ID")
    ...
    warehouse_name: str | None = Field(None, description="出库仓库名称")
