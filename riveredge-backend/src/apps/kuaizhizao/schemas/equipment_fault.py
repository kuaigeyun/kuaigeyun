...
class EquipmentFaultBase(BaseModel):
    ...
    """
    fault_no: str | None = Field(None, max_length=100, description="故障记录编号（可选，创建时自动生成）")
    ...
    reporter_id: int | None = Field(None, description="报告人ID（用户ID）")
    reporter_name: str | None = Field(None, max_length=100, description="报告人姓名")
...
class EquipmentFaultUpdate(BaseModel):
    ...
    """
    fault_date: datetime | None = Field(None, description="故障发生日期")
    fault_type: str | None = Field(None, max_length=50, description="故障类型")
    fault_description: str | None = Field(None, description="故障描述")
    fault_level: str | None = Field(None, max_length=50, description="故障级别")
    reporter_id: int | None = Field(None, description="报告人ID")
    reporter_name: str | None = Field(None, max_length=100, description="报告人姓名")
    status: str | None = Field(None, max_length=50, description="故障状态")
    repair_required: bool | None = Field(None, description="是否需要维修")
    remark: str | None = Field(None, description="备注")
...
class EquipmentRepairBase(BaseModel):
    ...
    """
    repair_no: str | None = Field(None, max_length=100, description="维修记录编号（可选，创建时自动生成）")
    equipment_fault_uuid: str | None = Field(None, description="设备故障UUID（可选）")
    equipment_uuid: str = Field(..., description="设备UUID")
    ...
    repair_cost: Decimal | None = Field(None, description="维修成本")
    repair_parts: dict[str, Any] | None = Field(None, description="维修备件（JSON格式）")
    repairer_id: int | None = Field(None, description="维修人员ID（用户ID）")
    repairer_name: str | None = Field(None, max_length=100, description="维修人员姓名")
    repair_duration: Decimal | None = Field(None, description="维修时长（小时）")
    status: str = Field(default="进行中", max_length=50, description="维修状态（进行中、已完成、已取消）")
    repair_result: str | None = Field(None, max_length=50, description="维修结果（成功、失败、部分成功）")
    remark: str | None = Field(None, description="备注")
    ...
    @classmethod
    def validate_repair_result(cls, v: str | None) -> str | None:
        if v is not None:
...
class EquipmentRepairUpdate(BaseModel):
    ...
    """
    repair_date: datetime | None = Field(None, description="维修日期")
    repair_type: str | None = Field(None, max_length=50, description="维修类型")
    repair_description: str | None = Field(None, description="维修描述")
    repair_cost: Decimal | None = Field(None, description="维修成本")
    repair_parts: dict[str, Any] | None = Field(None, description="维修备件")
    repairer_id: int | None = Field(None, description="维修人员ID")
    repairer_name: str | None = Field(None, max_length=100, description="维修人员姓名")
    repair_duration: Decimal | None = Field(None, description="维修时长（小时）")
    status: str | None = Field(None, max_length=50, description="维修状态")
    repair_result: str | None = Field(None, max_length=50, description="维修结果")
    remark: str | None = Field(None, description="备注")
...
class EquipmentRepairResponse(EquipmentRepairBase):
    ...
    tenant_id: int = Field(..., description="组织ID")
    equipment_fault_id: int | None = Field(None, description="设备故障ID")
    equipment_id: int = Field(..., description="设备ID")
    equipment_name: str = Field(..., description="设备名称")
    created_at: datetime = Field(..., description="创建时间")
    updated_at: datetime = Field(..., description="更新时间")
