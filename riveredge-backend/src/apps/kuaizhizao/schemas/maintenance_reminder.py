...
class MaintenanceReminderBase(BaseModel):
    ...
    设备维护提醒基础 Schema
    """
    maintenance_plan_uuid: str | None = Field(None, max_length=36, description="维护计划UUID")
    ...
    reminder_message: str | None = Field(None, description="提醒消息")
...
class MaintenanceReminderResponse(BaseModel):
    ...
    maintenance_plan_uuid: str | None = Field(None, description="维护计划UUID")
    ...
    read_by: int | None = Field(None, description="已读人ID")
