...
class KuaioaLicense(BaseModel):
    ...
    notify_user_ids = fields.JSONField(default=list, description="提醒接收人用户ID列表")
    notify_channels = fields.JSONField(default=list, description="提醒渠道 internal/email/sms")
    notify_enabled = fields.BooleanField(default=True, description="是否启用到期提醒")
