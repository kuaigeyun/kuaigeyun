    ...
    "apps": {
        "models": {
            "models": [
                ...
                "apps.kuaizhizao.models.shipment_notice_item",  # 发货通知明细
                "apps.kuaizhizao.models.delivery_notice_item",  # 送货单明细
