import{C as K,r as o,j as t,D as M,a8 as O,N as w,Z as H,aq as R,O as _,b3 as L,am as V,al as q,aL as G,cc as W}from"./vendor-BXoj0HS6.js";import{T as Y}from"./PremiumTerminalTemplate-CYOgaSMc.js";import{ah as Z}from"./main-DbGCCMcv.js";import{S as v}from"./clientRelease-B_GZvAgh.js";import"./design-B_8Sx7jg.js";import"./touch-CzJ4Jti_.js";import"./index.es-BuhyOxvg.js";import"./sessionCurrentUser-Bg0qLilW.js";import"./globalStore-B4H4f21p.js";import"./restoredUser-zqaRNcbu.js";import"./tokenRefresh-8_D3ndTZ.js";import"./building-2-VR6WDz95.js";import"./clearSessionQueries-Db_KN_8V.js";import"./index-I6y1s3eh.js";const{Search:X}=_,pe=()=>{const{message:a}=K.useApp(),j=Z(),[I,C]=o.useState(!1),[i,u]=o.useState(""),[f,x]=o.useState(""),[b,E]=o.useState(""),[n,k]=o.useState([]),[c,m]=o.useState(-1),y=o.useRef(null),S=o.useRef(null);o.useEffect(()=>{const e=new URLSearchParams(window.location.search),s=e.get("code"),r=e.get("programCode"),d=e.get("programUrl"),h=e.get("name")||e.get("programName");s?(u(s),x(h||"加工程序")):r?(u(r),x(h||"加工程序")):d?U(d):a.warning("请提供程序代码或程序URL")},[]);const U=async e=>{C(!0);try{const s=await fetch(e);if(!s.ok)throw new Error("加载程序失败");const r=await s.text();u(r),x("加工程序")}catch(s){a.error(s.message||"加载程序失败")}finally{C(!1)}},T=o.useCallback(e=>{if(!e||!i){k([]),m(-1);return}const s=i.split(`
