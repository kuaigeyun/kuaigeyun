import{C as K,r as o,j as t,D as M,a8 as O,N as w,Z as H,aq as R,O as _,b3 as L,am as V,al as q,aL as G,cd as W}from"./vendor-BOyyiuK3.js";import{T as Y}from"./PremiumTerminalTemplate-hegK-qKw.js";import{ak as Z}from"./main-CQJ1F-x9.js";import{S as v}from"./clientRelease-Dr-u9KJm.js";import"./design-B_8Sx7jg.js";import"./touch-CzJ4Jti_.js";import"./index.es-BiJ2UQJs.js";import"./sessionCurrentUser-8hr45TcJ.js";import"./globalStore-DdNIeBTT.js";import"./restoredUser-BZQ1l-Pq.js";import"./tokenRefresh-BxADn0y0.js";import"./building-2-CXsh_SiJ.js";import"./clearSessionQueries-Db_KN_8V.js";import"./index-CI5nDLNC.js";const{Search:X}=_,pe=()=>{const{message:a}=K.useApp(),j=Z(),[I,k]=o.useState(!1),[i,u]=o.useState(""),[f,x]=o.useState(""),[b,E]=o.useState(""),[n,C]=o.useState([]),[c,m]=o.useState(-1),y=o.useRef(null),S=o.useRef(null);o.useEffect(()=>{const e=new URLSearchParams(window.location.search),s=e.get("code"),r=e.get("programCode"),d=e.get("programUrl"),h=e.get("name")||e.get("programName");s?(u(s),x(h||"加工程序")):r?(u(r),x(h||"加工程序")):d?U(d):a.warning("请提供程序代码或程序URL")},[]);const U=async e=>{k(!0);try{const s=await fetch(e);if(!s.ok)throw new Error("加载程序失败");const r=await s.text();u(r),x("加工程序")}catch(s){a.error(s.message||"加载程序失败")}finally{k(!1)}},T=o.useCallback(e=>{if(!e||!i){C([]),m(-1);return}const s=i.split(`
`),r=[],d=e.toLowerCase();s.forEach((h,p)=>{h.toLowerCase().includes(d)&&r.push(p)}),C(r),m(r.length>0?0:-1),r.length>0?(g(r[0]),a.success(`找到 ${r.length} 个匹配项`)):a.warning("未找到匹配项")},[i,a]),g=o.useCallback(e=>{if(y.current){const s=y.current.querySelector(`[data-line="${e}"]`);s&&(s.scrollIntoView({behavior:"smooth",block:"center"}),s.classList.add("highlighted-line"),setTimeout(()=>{s.classList.remove("highlighted-line")},2e3))}},[]),z=o.useCallback(()=>{if(n.length===0)return;const e=(c+1)%n.length;m(e),g(n[e])},[n,c,g]),B=o.useCallback(()=>{if(n.length===0)return;const e=(c-1+n.length)%n.length;m(e),g(n[e])},[n,c,g]),F=o.useCallback((e,s="")=>{if(!e)return"";const r=e.split(`
