import { NODE_DANGER, NODE_SELECT, NODE_SUB_DANGER, NODE_SUB_SELECT, NODE_SUB_WARNING, NODE_WARNING } from "../FlowView/constants";
import { SelectType } from '..';
export function getClsFromSelectType(select) {
  switch (select) {
