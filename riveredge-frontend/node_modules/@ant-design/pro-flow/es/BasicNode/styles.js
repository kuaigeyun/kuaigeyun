...
export var useStyles = createStyles(function (_ref) {
  ...
  return {
    ...
    nodeDefault: css(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral([""]))),
    titleSlotRight: css(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n    width: 28px;\n    height: 28px;\n    position: absolute;\n    right: 13px;\n    top: 9px;\n  "]))),
