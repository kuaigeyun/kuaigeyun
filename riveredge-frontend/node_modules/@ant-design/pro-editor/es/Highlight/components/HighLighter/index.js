...
var HighLighter = /*#__PURE__*/memo(function (props) {
  var children = props.children,
    ...
    _props$shiki = props.shiki,
    shiki = _props$shiki === void 0 ? true : _props$shiki;
  var _useStyles = useStyles({
      lineNumber: lineNumber,
      theme: theme
    }),
    styles = _useStyles.styles;
  var _useShiki = useShiki(language, theme, shiki),
    renderShiki = _useShiki.renderShiki,
    loading = _useShiki.loading;
  var HighlightJSBlock = useMemo(function () {
    return /*#__PURE__*/_jsx(HighLightJS, {
      lineNumber: lineNumber,
      theme: theme,
      language: language,
      children: children
  ...
  return shiki === false ? HighlightJSBlock : /*#__PURE__*/_jsxs(_Fragment, {
    children: [loading ? HighlightJSBlock : /*#__PURE__*/_jsx("div", {
