...
const index_js_1 = __importDefault(require("../text/index.js"));
const constants_js_1 = require("../constants.js");
const uiRender_js_1 = require("../text/uiRender.js");
const constants_js_2 = require("../text/constants.js");
const extraFormatter_js_1 = require("../text/extraFormatter.js");
    ...
    const plugin = {
        ui: async (arg) => {
            ...
            const textElementStyle = {
                ...
                justifyContent: (0, uiRender_js_1.mapVerticalAlignToFlex)(constants_js_2.VERTICAL_ALIGN_MIDDLE),
            };
            Object.assign(textElement.style, textElementStyle);
            await index_js_1.default.ui({
                ...arg,
        ...
        propPanel: {
            schema: ({ options, i18n, activeSchema, changeSchemas }) => {
                ...
                const formatter = (0, extraFormatter_js_1.getExtraFormatterSchema)(i18n);
                formatter.buttons = formatter.buttons.filter((button) => button.key === extraFormatter_js_1.Formatter.ALIGNMENT);
