...
const layout_1 = require("../../../src/api/text/layout");
...
describe(`layoutMultilineText`, () => {
    it('should layout the text on one line when it fits near-perfectly', async () => {
        ...
        const font = await pdfDoc.embedFont(index_1.StandardFonts.Helvetica);
        const alignment = index_1.TextAlignment.Left;
        const padding = 0;
        const borderWidth = 0;
        ...
        for (let fontSize = MIN_FONT_SIZE; fontSize <= MAX_FONT_SIZE; fontSize++) {
            ...
            const multilineTextLayout = (0, layout_1.layoutMultilineText)(text, {
                alignment,
                bounds,
                font,
            });
