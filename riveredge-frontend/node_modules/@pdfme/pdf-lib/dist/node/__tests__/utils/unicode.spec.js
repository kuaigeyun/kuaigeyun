...
const withUtf8Bom = (encoding) => (0, utils_1.mergeIntoTypedArray)(utf8BOM, encoding);
const withUtf16Bom = (encoding) => new Uint16Array([...Array.from(utf16BOM), ...Array.from(encoding)]);
describe(`utf8Encode`, () => {
    it(`encodes <U+004D U+0430 U+4E8C U+10302> to UTF-8`, () => {
        ...
        const actual = (0, utils_1.utf8Encode)(input);
    ...
    it(`encodes <U+1F4A9 U+1F382> to UTF-8 (without a BOM)`, () => {
        ...
        const actual = (0, utils_1.utf8Encode)(input, false);
...
describe(`utf16Encode`, () => {
    it(`encodes <U+004D U+0430 U+4E8C U+10302> to UTF-16`, () => {
        ...
        const actual = (0, utils_1.utf16Encode)(input);
    ...
    it(`encodes <U+1F4A9 U+1F382> to UTF-16 (without a BOM)`, () => {
        ...
        const actual = (0, utils_1.utf16Encode)(input, false);
        expect(actual).toEqual(expected);
    });
...
describe(`utf16Decode`, () => {
    it(`decodes <U+004D U+0430 U+4E8C U+10302> from UTF-16`, () => {
        ...
        const actual = (0, utils_1.utf16Decode)(input, false);
        expect(actual).toEqual(expected);
    });
    ...
    it(`decodes "Дмитрий Козлюк (Dmitry Kozlyuk)" from UTF-16`, () => {
        ...
        const actual = (0, utils_1.utf16Decode)(input, true);
        expect(actual).toEqual(expected);
    });
