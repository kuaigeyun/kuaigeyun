...
const mappings = [
    ...
    [0x1e, '\u02DA'],
    [0x1f, '\u02DC'],
    ...(0, utils_1.range)(0x20, 0x7e + 1).map(identityMapping),
    [0x7f, '\uFFFD'],
    [0x80, '\u2022'],
    [0x81, '\u2020'],
    [0x82, '\u2021'],
    ...
    [0x9f, '\uFFFD'],
    [0xa0, '\u20AC'],
    ...(0, utils_1.range)(0xa1, 0xac + 1).map(identityMapping),
    [0xad, '\uFFFD'],
    ...(0, utils_1.range)(0xae, 0xff + 1).map(identityMapping),
];
describe(`pdfDocEncodingDecode`, () => {
    it(`maps all PDFDocEncoding codes from 0-255 to the correct Unicode code points`, () => {
        ...
        expect(mappings.map(([code]) => code).sort((a, b) => a - b)).toEqual((0, utils_1.range)(0, 256));
        // Now make sure that `pdfDocEncodingDecode` decodes everything correctly
        mappings.forEach(([input1, expected1]) => {
            const actual1 = (0, utils_1.pdfDocEncodingDecode)(Uint8Array.of(input1));
        ...
        const actual2 = (0, utils_1.pdfDocEncodingDecode)(input2);
        expect(actual2).toEqual(expected2);
    });
});
//# sourceMappingURL=pdfDocEncoding.spec.js.map