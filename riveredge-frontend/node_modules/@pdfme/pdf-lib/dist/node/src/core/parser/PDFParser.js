...
const PDFCrossRefSection_1 = __importDefault(require("../document/PDFCrossRefSection"));
...
const PDFObjectStreamParser_1 = __importDefault(require("./PDFObjectStreamParser"));
const PDFXRefStreamParser_1 = __importDefault(require("./PDFXRefStreamParser"));
const PDFContext_1 = __importDefault(require("../PDFContext"));
...
class PDFParser extends PDFObjectParser_1.default {
    ...
    maybeRecoverRoot() {
        const isValidCatalog = (obj) => obj instanceof PDFDict_1.default && obj.lookup(PDFName_1.default.of('Type')) === PDFName_1.default.of('Catalog');
