...
exports.PDF20 = exports.PDF17 = exports.CipherTransform = exports.CipherTransformFactory = exports.calculateSHA512 = exports.calculateSHA256 = exports.calculateMD5 = exports.ARCFourCipher = exports.AES256Cipher = exports.AES128Cipher = void 0;
exports.calculateSHA384 = calculateSHA384;
const arrays_1 = require("../utils/arrays");
const strings_1 = require("../utils/strings");
const PDFDict_js_1 = __importDefault(require("./objects/PDFDict.js"));
const PDFName_js_1 = __importDefault(require("./objects/PDFName.js"));
const DecryptStream_js_1 = __importDefault(require("./streams/DecryptStream.js"));
class ARCFourCipher {
    constructor(key) {
...
class CipherTransformFactory {
    constructor(dict, fileIdBytes, password) {
        ...
        Object.defineProperty(this, "identityName", {
            ...
            configurable: true,
            writable: true,
            value: PDFName_js_1.default.of('Identity')
        });
        ...
        const encryptMetadata = (algorithm === 4 || algorithm === 5) &&
            dict.get(PDFName_js_1.default.of('EncryptMetadata'))?.asBoolean() !== false;
        ...
        if (algorithm >= 4) {
            ...
            this.cf = cf;
            this.stmf = dict.get(PDFName_js_1.default.of('StmF')) || this.identityName;
            this.strf = dict.get(PDFName_js_1.default.of('StrF')) || this.identityName;
