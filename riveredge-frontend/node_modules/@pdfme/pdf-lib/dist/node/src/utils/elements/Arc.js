...
class Arc extends GraphElement_1.default {
    constructor(O = new Point_1.default(), A = new Point_1.default(), B = new Point_1.default(), lastSweep = 0) {
        ...
        Object.defineProperty(this, "lastSweep", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    includes(P) {
        ...
        return (this.getCircle().includes(P) &&
            Math.abs((0, maths_1.angleABC)(this.middle(), this.center(), P)) <= Math.abs(this.sweep() / 2));
    }
    orthoProjection(P) {
        ...
        if (this.includes(H))
            ...
            const coords = (0, maths_1.distanceCoords)(H.toCoords(), origin) < (0, maths_1.distanceCoords)(H.toCoords(), destination)
                ? origin
                : destination;
