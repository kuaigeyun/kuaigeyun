...
// prettier-ignore
const componentsToColor = (comps, scale = 1) => (comps?.length === 1 ? (0, exports.grayscale)(comps[0] * scale)
    : comps?.length === 3 ? (0, exports.rgb)(comps[0] * scale, comps[1] * scale, comps[2] * scale)
        : comps?.length === 4 ? (0, exports.cmyk)(comps[0] * scale, comps[1] * scale, comps[2] * scale, comps[3] * scale)
            : undefined);
