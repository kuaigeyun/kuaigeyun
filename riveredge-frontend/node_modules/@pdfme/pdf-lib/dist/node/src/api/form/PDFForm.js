...
const PDFButton_1 = __importDefault(require("./PDFButton"));
const PDFCheckBox_1 = __importDefault(require("./PDFCheckBox"));
const PDFDropdown_1 = __importDefault(require("./PDFDropdown"));
const PDFOptionList_1 = __importDefault(require("./PDFOptionList"));
const PDFRadioGroup_1 = __importDefault(require("./PDFRadioGroup"));
const PDFSignature_1 = __importDefault(require("./PDFSignature"));
const PDFTextField_1 = __importDefault(require("./PDFTextField"));
...
class PDFForm {
    constructor(acroForm, doc) {
        ...
        Object.defineProperty(this, "embedDefaultFont", {
            ...
            configurable: true,
            writable: true,
            value: () => this.doc.embedStandardFont(StandardFonts_1.StandardFonts.Helvetica)
        });
            ...
            for (let j = 0, lenWidgets = widgets.length; j < lenWidgets; j++) {
                try {
                    ...
                    const operators = [
                        ...
                        ...(0, operations_1.rotateInPlace)({ ...rectangle, rotation: 0 }),
    ...
    findWidgetAppearanceRef(field, widget) {
        ...
        if (refOrDict instanceof core_1.PDFDict &&
            ...
            const ref = refOrDict.get(value) ?? refOrDict.get(core_1.PDFName.of('Off'));
