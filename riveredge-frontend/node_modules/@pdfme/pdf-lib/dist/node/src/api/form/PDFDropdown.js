...
class PDFDropdown extends PDFField_1.default {
    constructor(acroComboBox, ref, doc) {
        ...
        (0, utils_1.assertIs)(acroComboBox, 'acroComboBox', [[core_1.PDFAcroComboBox, 'PDFAcroComboBox']]);
    ...
    updateWidgetAppearance(widget, font, provider) {
        const apProvider = provider ?? appearances_1.defaultDropdownAppearanceProvider;
