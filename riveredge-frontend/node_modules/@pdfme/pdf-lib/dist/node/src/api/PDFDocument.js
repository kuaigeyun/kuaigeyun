...
const PDFForm_1 = __importDefault(require("./form/PDFForm"));
const sizes_1 = require("./sizes");
const core_1 = require("../core");
const PDFDocumentOptions_1 = require("./PDFDocumentOptions");
const utils_1 = require("../utils");
const FileEmbedder_1 = __importStar(require("../core/embedders/FileEmbedder"));
const PDFEmbeddedFile_1 = __importDefault(require("./PDFEmbeddedFile"));
const PDFJavaScript_1 = __importDefault(require("./PDFJavaScript"));
const JavaScriptEmbedder_1 = __importDefault(require("../core/embedders/JavaScriptEmbedder"));
...
class PDFDocument {
    ...
    async attach(attachment, name, options = {}) {
        ...
        (0, utils_1.assertOrUndefined)(options.modificationDate, 'options.modificationDate', [Date]);
    ...
    async embedPdf(pdf, indices = [0]) {
        (0, utils_1.assertIs)(pdf, 'pdf', ['string', Uint8Array, ArrayBuffer, [PDFDocument, 'PDFDocument']]);
        (0, utils_1.assertIs)(indices, 'indices', [Array]);
