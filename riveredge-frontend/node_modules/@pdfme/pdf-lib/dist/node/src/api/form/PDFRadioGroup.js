...
class PDFRadioGroup extends PDFField_1.default {
    constructor(acroRadioButton, ref, doc) {
        ...
        (0, utils_1.assertIs)(acroRadioButton, 'acroRadioButton', [[core_1.PDFAcroRadioButton, 'PDFAcroRadioButton']]);
    ...
    addOptionToPage(option, page, options) {
        ...
        const widget = this.createWidget({
            ...
            backgroundColor: options?.backgroundColor ?? (0, colors_1.rgb)(1, 1, 1),
            borderColor: options?.borderColor ?? (0, colors_1.rgb)(0, 0, 0),
    ...
    updateWidgetAppearance(widget, onValue, provider) {
        const apProvider = provider ?? appearances_1.defaultRadioGroupAppearanceProvider;
