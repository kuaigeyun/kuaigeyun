...
const PDFBool_1 = __importDefault(require("../objects/PDFBool"));
...
const PDFNull_1 = __importDefault(require("../objects/PDFNull"));
const PDFNumber_1 = __importDefault(require("../objects/PDFNumber"));
const PDFRawStream_1 = __importDefault(require("../objects/PDFRawStream"));
...
const PDFCatalog_1 = __importDefault(require("../structures/PDFCatalog"));
const PDFPageLeaf_1 = __importDefault(require("../structures/PDFPageLeaf"));
const PDFPageTree_1 = __importDefault(require("../structures/PDFPageTree"));
...
Object.defineProperty(PDFObjectParser, "forBytes", {
    ...
    configurable: true,
    writable: true,
    value: (bytes, context, capNumbers) => new PDFObjectParser(ByteStream_1.default.of(bytes), context, capNumbers)
});
