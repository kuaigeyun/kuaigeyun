...
const PDFOperator_1 = __importDefault(require("./operators/PDFOperator"));
const PDFOperatorNames_1 = __importDefault(require("./operators/PDFOperatorNames"));
const PDFContentStream_1 = __importDefault(require("./structures/PDFContentStream"));
...
class PDFContext {
    ...
    flateStream(contents, dict = {}) {
        return this.stream(pako_1.default.deflate((0, utils_1.typedArrayFor)(contents)), {
            ...dict,
            Filter: 'FlateDecode',
        });
    }
