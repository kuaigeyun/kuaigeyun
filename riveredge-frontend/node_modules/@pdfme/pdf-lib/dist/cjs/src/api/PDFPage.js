...
const PDFEmbeddedPage_1 = __importDefault(require("./PDFEmbeddedPage"));
const PDFFont_1 = __importDefault(require("./PDFFont"));
const PDFImage_1 = __importDefault(require("./PDFImage"));
...
class PDFPage {
    ...
    drawText(text, options = {}) {
        ...
        contentStream.push(...(0, operations_1.drawLinesOfText)(encodedLines, {
            ...
            xSkew: options.xSkew ?? (0, rotations_1.degrees)(0),
            ySkew: options.ySkew ?? (0, rotations_1.degrees)(0),
            x: options.x ?? this.x,
            y: options.y ?? this.y,
    ...
    drawPage(embeddedPage, options = {}) {
        ...
        (0, utils_1.assertIs)(embeddedPage, 'embeddedPage', [[PDFEmbeddedPage_1.default, 'PDFEmbeddedPage']]);
        (0, utils_1.assertOrUndefined)(options.x, 'options.x', ['number']);
        (0, utils_1.assertOrUndefined)(options.y, 'options.y', ['number']);
    ...
    drawSvgPath(path, options = {}) {
        ...
        (0, utils_1.assertOrUndefined)(options.color, 'options.color', [[Object, 'Color']]);
        (0, utils_1.assertRangeOrUndefined)(options.opacity, 'opacity.opacity', 0, 1);
        (0, utils_1.assertOrUndefined)(options.borderColor, 'options.borderColor', [[Object, 'Color']]);
        (0, utils_1.assertOrUndefined)(options.borderDashArray, 'options.borderDashArray', [Array]);
        (0, utils_1.assertOrUndefined)(options.borderDashPhase, 'options.borderDashPhase', ['number']);
     ...
     */
    drawLine(options) {
        (0, utils_1.assertIs)(options.start, 'options.start', [[Object, '{ x: number, y: number }']]);
        (0, utils_1.assertIs)(options.end, 'options.end', [[Object, '{ x: number, y: number }']]);
