...
const assertFieldAppearanceOptions = (options) => {
    ...
    (0, utils_1.assertOrUndefined)(options?.textColor, 'options.textColor', [[Object, 'Color']]);
    (0, utils_1.assertOrUndefined)(options?.backgroundColor, 'options.backgroundColor', [[Object, 'Color']]);
