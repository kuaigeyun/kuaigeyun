...
const contentStreamText = `
  ...
  ET
`;
const encodedContentStream = pako_1.default.deflate((0, index_1.typedArrayFor)(contentStreamText));
const pdfBytes = (0, index_1.mergeIntoTypedArray)(`%PDF-1.7
%
...
describe(`PDFWriter`, () => {
    it(`serializes PDFContext objects using Indirect Objects and a Cross Reference table`, async () => {
        ...
        const contentStreamRef = index_1.PDFRef.of(9000);
        ...
        page.set(index_1.PDFName.of('Parent'), pagesRef);
        const catalog = context.obj({
            Type: 'Catalog',
            Pages: pagesRef,
        });
        context.trailerInfo.Root = context.register(catalog);
        const buffer = await index_1.PDFWriter.forContext(context, Infinity).serializeToBuffer();
        expect(buffer.length).toBe(pdfBytes.length);
        expect(buffer).toEqual(pdfBytes);
    });
});
//# sourceMappingURL=PDFWriter.spec.js.map