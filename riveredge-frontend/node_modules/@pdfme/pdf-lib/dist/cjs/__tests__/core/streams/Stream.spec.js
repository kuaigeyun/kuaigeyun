...
describe(`Stream`, () => {
    it('can get the stream length', () => {
        ...
        const stream = new Stream_1.default(bytes, 0, bytes.length);
        expect(stream.length).toEqual(3);
    });
    it('can detect when the stream is empty', () => {
        const stream = new Stream_1.default(Uint8Array.from([]), 0, 0);
    ...
    describe('can get the bytes from a stream', () => {
        ...
        it('when the current position is at or after the end', () => {
            const stream = new Stream_1.default(bytes, 5);
            expect(stream.getByte()).toEqual(-1);
        });
        it('when the current position is before the end', () => {
            const stream = new Stream_1.default(bytes, 0);
    ...
    it('can get unsigned sixteen bit integers', () => {
        const stream = new Stream_1.default(Uint8Array.from([1, 1, 2, 2]));
    ...
    it('can get thirty-two bit integers', () => {
        ...
        const stream = new Stream_1.default(bytes);
    ...
    describe('can get the next n bytes', () => {
        ...
        beforeEach(() => {
            stream = new Stream_1.default(bytes);
        });
    ...
    it('can peek at the next byte', () => {
        const stream = new Stream_1.default(Uint8Array.from([1, 2]));
    ...
    it('can create a substream', () => {
        const stream = new Stream_1.default(Uint8Array.from([1, 2, 3]));
