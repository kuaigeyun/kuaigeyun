...
describe(`PDFImage`, () => {
    describe(`embed() method`, () => {
        it(`clears the 'embedder' field after the first call`, async () => {
            const pdfDoc = await api_1.PDFDocument.create();
            const bytes = (0, utils_1.toUint8Array)(examplePngImage);
            const embedder = await core_1.PngEmbedder.for(bytes);
            const ref = pdfDoc.context.nextRef();
            const pdfImage = api_1.PDFImage.of(ref, pdfDoc, embedder);
...
//# sourceMappingURL=PDFImage.spec.js.map