import fs from 'fs';
import { PDFDocument, PDFTextField, PDFCheckBox, PDFButton, PDFRadioGroup, PDFOptionList, PDFDropdown, PDFDict, PDFName, PDFForm, PDFAcroForm, } from '../../../src/index';
...
const getApRefs = (widget) => {
    ...
    return [
        ...
        (aps?.normal).get(PDFName.of('Off')),
        aps?.rollover?.get(PDFName.of('Off')),
        aps?.down?.get(PDFName.of('Off')),
    ].filter(Boolean);
};
