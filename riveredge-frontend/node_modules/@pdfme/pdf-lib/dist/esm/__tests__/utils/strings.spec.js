...
describe(`breakTextIntoLines`, () => {
    ...
    it(`handles non-ascii code points and empty breaks`, async () => {
        const sourceHansBytes = fs.readFileSync('assets/fonts/source_hans_jp/SourceHanSerifJP-Regular.otf');
        ...
        const actual = breakTextIntoLines(input, [''], 125, (text) => sourceHansFont.widthOfTextAtSize(text, 24));
        expect(actual).toEqual(expected);
    });
});
