...
const sourceHansJpFont = fs.readFileSync(path.join(ASSETS_DIR, 'source_hans_jp/SourceHanSerifJP-Regular.otf'));
const DATA_DIR = path.join(__dirname, 'data');
const ubuntuFontCmap = fs.readFileSync(path.join(DATA_DIR, 'Ubuntu-R.ttf.cmap'));
const sourceHansJpFontCmap = fs.readFileSync(path.join(DATA_DIR, 'SourceHanSerifJP-Regular.otf.cmap'));
