...
import { mergeIntoTypedArray, PDFContext, PDFHexString, PDFObjectStream, PDFRef, PDFString, toCharCode, typedArrayFor, } from '../../../src/index';
describe(`PDFObjectStream`, () => {
    ...
    it(`can be constructed from PDFObjectStream.of(...)`, () => {
        expect(PDFObjectStream.withContextAndObjects(context, objects, false)).toBeInstanceOf(PDFObjectStream);
    });
    it(`can be cloned`, () => {
    ...
    it(`can be serialized when encoded`, () => {
        ...
        expect(buffer).toEqual(mergeIntoTypedArray('  <<\n/Filter /FlateDecode\n/Type /ObjStm\n/N 9\n/First 42\n/Length 110\n>>\n', 'stream\n', encodedContents, '\nendstream '));
    });
});
