...
import { PDFContext, PDFDict, PDFHexString, PDFRef, StandardFontEmbedder, } from '../../../src/index';
describe(`StandardFontEmbedder`, () => {
    ...
    it(`can encode text strings into PDFHexString objects`, () => {
        ...
        expect(String(embedder.encodeText(text))).toBe(String(PDFHexString.of('537475666620616E64207468696E677A21')));
    });
