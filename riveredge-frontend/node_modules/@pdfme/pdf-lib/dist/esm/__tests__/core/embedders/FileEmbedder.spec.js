...
const catRidingUnicornJpg = fs.readFileSync('assets/images/cat_riding_unicorn.jpg');
...
describe(`FileEmbedder`, () => {
    ...
    it(`can embed files into PDFContexts without a predefined ref`, async () => {
        ...
        const embedder = FileEmbedder.for(catRidingUnicornJpg, 'cat_riding_unicorn.jpg', {
            mimeType: 'image/jpeg',
    ...
    it(`can embed files into PDFContexts with a predefined ref`, async () => {
        ...
        const embedder = FileEmbedder.for(usConstitutionPdf, 'us_constitution.pdf', {
