...
var _ActionView = _interopRequireDefault(require("./ActionView"));
...
var SearchForm = function SearchForm(props) {
  ...
  var className = props.className,
    ...
    restProps = (0, _tslib.__rest)(props, ["className", "style", "mode", "layoutAuto", "form", "hidden", "loading", "column", "collapsed", "defaultCollapsed", "schema", "retainBtn", "closeReturnSearch", "resetAfter", "searchBtnStyle", "searchBtnClassName", "searchText", "resetText", "searchWithError", "searchOnMount", "onMount", "onSearch", "onReset", "searchBtnRender"]);
  ...
  var handleContainerResize = function handleContainerResize() {
    ...
    var resizeObserver = new ResizeObserver((0, _lodashEs.debounce)(function () {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _classnames2.default)('fr-search', _defineProperty(_defineProperty({}, className, !!className), 'fr-column-search', isColumn)),
    style: style,
    ref: containerRef,
    onKeyDown: !closeReturnSearch ? handleKeyDown : undefined
  }, /*#__PURE__*/_react.default.createElement(_formCore.default, Object.assign({
    displayType: 'row'
  }, restProps, {
    ...
    form: form,
    operateExtra: operateShow && (/*#__PURE__*/_react.default.createElement(_col.default, {
      className: (0, _classnames2.default)('search-action-col', {
        'search-action-column': getIsColumn(isColumn, properties, column)
      }),
      style: {
        minWidth: 1 / column * 100 + '%'
      }
    }, /*#__PURE__*/_react.default.createElement(_ActionView.default, Object.assign({}, actionProps, {
      retainBtn: retainBtn,
      mode: mode,
...
var _default = exports.default = (0, _withProvider.default)(SearchForm, {
  Input: _widgets.Input,
  InputNumber: _widgets.InputNumber,
  TextArea: _widgets.TextArea,
  Select: _widgets.Select,
  MultiSelect: _widgets.MultiSelect,
  Switch: _widgets.Switch,
  Radio: _widgets.Radio,
  Checkbox: _widgets.Checkbox,
  Checkboxes: _widgets.Checkboxes,
  DatePicker: _widgets.DatePicker,
  DateRange: _widgets.DateRange,
  TimePicker: _widgets.TimePicker,
  TimeRange: _widgets.TimeRange,
  TreeSelect: _widgets.TreeSelect,
  ImageInput: _widgets.ImageInput,
  UrlInput: _widgets.UrlInput,
  Slider: _widgets.Slider,
  Html: _widgets.Html,
  PercentSlider: _widgets.PercentSlider
});