...
var c2 = (e, t, n) => t in e ? l2(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var P = (e, t, n) => c2(e, typeof t != "symbol" ? t + "" : t, n);
var m3 = (e, t, n) => t.has(e) ? a2("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n);
import { Disposable as p1, createIdentifier as C1, CommandType as t3, toDisposable as f1, IUniverInstanceService as T1, DocumentFlavor as Ot, LocaleService as L1, ColorKit as V3, NAMED_STYLE_MAP as u2, IConfigService as G1, ICommandService as X1, NamedStyleType as P1, Workbook as d2, UniverInstanceType as b3, DocumentDataModel as d9, SlideDataModel as f2, remove as $t, FOCUSING_UNIVER_EDITOR as Ne, IContextService as pe, Inject as m1, Injector as V1, merge as De, convertObservableToBehaviorSubject as h2, isRealNum as C2, ErrorService as v2, RedoCommand as U3, UndoCommand as z3, IUndoRedoService as g2, EDITOR_ACTIVATED as f9, FOCUSING_FX_BAR_EDITOR as h9, Optional as C9, dedupeBy as p2, generateRandomId as Ce, throttle as m2, ThemeService as W3, LifecycleStages as L3, LifecycleUnreachableError as b2, isInternalEditorID as L2, LifecycleService as v9, ILogService as w2, DependentOn as g9, Plugin as p9, registerDependencies as m9, mergeOverrideWithDependencies as b9, ILocalStorageService as L9, touchDependencies as ne, BaselineOffset as w3, getBorderStyleType as D1, BorderStyleTypes as y2, Tools as w9 } from "@univerjs/core";
import { BehaviorSubject as k1, distinctUntilChanged as y9, Observable as ve, switchMap as _2, isObservable as Te, fromEvent as M2, Subject as E1, of as me, combineLatest as le, merge as I2, first as x2, throttleTime as y3, animationFrameScheduler as _3, map as _9, filter as Et, debounceTime as H2, startWith as S2, ReplaySubject as R2 } from "rxjs";
import { useRef as t1, createElement as M, forwardRef as I, useEffect as q, useMemo as Q, useState as Y, useCallback as n3, memo as M9, createContext as I9, useContext as r3, useImperativeHandle as V2, Fragment as Nt, useLayoutEffect as O3, cloneElement as O2 } from "react";
import { jsx as h, Fragment as o3, jsxs as K } from "react/jsx-runtime";
import { useDependency as k, useObservable as d1, useInjector as $2, connectInjector as $1 } from "@wendellhu/redi/react-bindings";
export * from "@wendellhu/redi/react-bindings";
import { clsx as n1, isBrowser as E2, resizeObserverCtor as N2, Button as M3, DropdownMenu as $3, Tooltip as Y3, InputNumber as D2, TinyMenuGroup as T2, Menu as Z2, MenuItem as E3, MenuItemGroup as N3, SubMenu as Dt, MessageType as A2, KBD as B2, divideYClassName as P2, HoverCard as F2, borderClassName as k2, Dropdown as x9, divideXClassName as Tt, borderBottomClassName as Ze, Popup as H9, borderLeftBottomClassName as j2, scrollbarClassName as U2, ConfigProvider as S9, ConfigContext as z2, ColorPicker as W2, render as Oe, unmount as R9, Confirm as Y2, Dialog as G2, Gallery as X2, Messager as q2, removeMessage as _e, message as J2, toast as Q2, Toaster as K2 } from "@univerjs/design";
import { map as Zt } from "rxjs/operators";
import { IRenderManagerService as V9, UniverRenderEnginePlugin as O9, ptToPx as e4 } from "@univerjs/engine-render";
...
const Gi = C1("ui.left-sidebar.service"), be = C1("ui.sidebar.service"), E9 = "ShortcutPanel", i3 = {
...
function x({ ref: e, ...t }) {
  const { icon: n, id: r, className: o, extend: i, ...s } = t, a = `univerjs-icon univerjs-icon-${r} ${o || ""}`.trim(), d = t1(`_${r4()}`);
  return N9(n, `${r}`, {
    defIds: n.defIds,
    idSuffix: d.current
  }, {
...
function N9(e, t, n, r, o) {
  return M(e.tag, {
    ...
    ...t4(e, n, o),
    ...r
  }, (n4(e, n).children || []).map((i, s) => N9(i, `${t}-${e.tag}-${s}`, n, void 0, o)));
}
function t4(e, t, n) {
  const r = { ...e.attrs };
  n != null && n.colorChannel1 && r.fill === "colorChannel1" && (r.fill = n.colorChannel1), e.tag === "mask" && r.id && (r.id = r.id + t.idSuffix), Object.entries(r).forEach(([i, s]) => {
    i === "mask" && typeof s == "string" && (r[i] = s.replace(/url\(#(.*)\)/, `url(#$1${t.idSuffix})`));
  });
  const { defIds: o } = t;
  return !o || o.length === 0 || (e.tag === "use" && r["xlink:href"] && (r["xlink:href"] = r["xlink:href"] + t.idSuffix), Object.entries(r).forEach(([i, s]) => {
    typeof s == "string" && (r[i] = s.replace(/url\(#(.*)\)/, `url(#$1${t.idSuffix})`));
  })), r;
}
function n4(e, t) {
  var r;
...
s6.displayName = "FontSizeReduceIcon";
const $4 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
l6.displayName = "FreezeColumnIcon";
const E4 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
h6.displayName = "HorizontalMergeIcon";
const P4 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
L6.displayName = "LeftJustifyingIcon";
const Y4 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
w6.displayName = "LeftRotationFortyFiveDegreesIcon";
const G4 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
y6.displayName = "LeftRotationNinetyDegreesIcon";
const X4 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
N6.displayName = "ReduceDigitsIcon";
const u0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
D6.displayName = "RightJustifyingIcon";
const f0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
T6.displayName = "RightRotationFortyFiveDegreesIcon";
const h0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Z6.displayName = "RightRotationNinetyDegreesIcon";
const C0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
F6.displayName = "StrikethroughIcon";
const m0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
U6.displayName = "SuperscriptIcon";
const w0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
X6.displayName = "VerticalCenterIcon";
const x0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
q6.displayName = "VerticalIntegrationIcon";
const H0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
J6.displayName = "VerticalTextIcon";
const S0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Q6.displayName = "AdjustHeightDoubleIcon";
const R0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
K6.displayName = "AdjustWidthDoubleIcon";
const V0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
en.displayName = "AutoHeightDoubleIcon";
const O0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
tn.displayName = "AutoWidthDoubleIcon";
const $0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
nn.displayName = "BackSlashDoubleIcon";
const E0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
rn.displayName = "ClearFormatDoubleIcon";
const N0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
on.displayName = "ConditionsDoubleIcon";
const D0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
ln.displayName = "DeleteCellMoveDownDoubleIcon";
const Z0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
an.displayName = "DeleteCellShiftLeftDoubleIcon";
const A0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
cn.displayName = "DeleteCellShiftRightDoubleIcon";
const B0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
un.displayName = "DeleteCellShiftUpDoubleIcon";
const P0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
dn.displayName = "DeleteColumnDoubleIcon";
const F0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
fn.displayName = "DeleteRowDoubleIcon";
const k0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
hn.displayName = "DownBorderDoubleIcon";
const j0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Cn.displayName = "FontColorDoubleIcon";
const U0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
gn.displayName = "HorizontalBorderDoubleIcon";
const W0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
pn.displayName = "InnerBorderDoubleIcon";
const Y0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
mn.displayName = "InsertCellDownDoubleIcon";
const G0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
bn.displayName = "InsertCellShiftRightDoubleIcon";
const X0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Ln.displayName = "InsertDoubleIcon";
const q0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
wn.displayName = "InsertRowAboveDoubleIcon";
const J0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
yn.displayName = "InsertRowBelowDoubleIcon";
const Q0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
_n.displayName = "LeftBorderDoubleIcon";
const K0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Mn.displayName = "LeftDoubleDiagonalDoubleIcon";
const e5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
In.displayName = "LeftInsertColumnDoubleIcon";
const t5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
xn.displayName = "LeftTridiagonalDoubleIcon";
const n5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Sn.displayName = "OuterBorderDoubleIcon";
const o5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Rn.displayName = "PaintBucketDoubleIcon";
const i5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Vn.displayName = "PasteSpecialDoubleIcon";
const s5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
On.displayName = "ReduceDoubleIcon";
const l5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
$n.displayName = "RightBorderDoubleIcon";
const a5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
En.displayName = "RightDoubleDiagonalDoubleIcon";
const c5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Nn.displayName = "RightInsertColumnDoubleIcon";
const u5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Dn.displayName = "SlashDoubleIcon";
const d5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Tn.displayName = "UpBorderDoubleIcon";
const f5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Zn.displayName = "VerticalBorderDoubleIcon";
const Me = {
  AddDigitsIcon: D9,
  AddImageIcon: T9,
  AdditionAndSubtractionIcon: Z9,
  AdjustHeightDoubleIcon: Q6,
  AdjustWidthDoubleIcon: K6,
  AlignBottomIcon: A9,
  AlignTextBothIcon: B9,
  AlignTopIcon: P9,
  AllBorderIcon: F9,
  AmplifyIcon: k9,
  AutoHeightDoubleIcon: en,
  AutoWidthDoubleIcon: tn,
  AutowrapIcon: j9,
  AvgIcon: U9,
  BackSlashDoubleIcon: nn,
  BoldIcon: z9,
  BrushIcon: W9,
  CancelFreezeIcon: Y9,
  CancelMergeIcon: G9,
  ClearFormatDoubleIcon: rn,
  CntIcon: X9,
  CodeIcon: q9,
  ConditionsDoubleIcon: on,
  CopyDoubleIcon: sn,
  DeleteCellMoveDownDoubleIcon: ln,
  DeleteCellShiftLeftDoubleIcon: an,
  DeleteCellShiftRightDoubleIcon: cn,
  DeleteCellShiftUpDoubleIcon: un,
  DeleteColumnDoubleIcon: dn,
  DeleteRowDoubleIcon: fn,
  DirectExportIcon: Q9,
  DollarIcon: K9,
  DownBorderDoubleIcon: hn,
  EuroIcon: e6,
  ExportIcon: t6,
  EyeOutlineIcon: r6,
  FolderIcon: o6,
  FontColorDoubleIcon: Cn,
  FontSizeIncreaseIcon: i6,
  FontSizeReduceIcon: s6,
  FreezeColumnIcon: l6,
  FreezeRowIcon: a6,
  ...
  HeaderFooterIcon: d6,
  HideDoubleIcon: vn,
  HorizontalBorderDoubleIcon: gn,
  HorizontallyIcon: C6,
  HorizontalMergeIcon: h6,
  InnerBorderDoubleIcon: pn,
  InsertCellDownDoubleIcon: mn,
  InsertCellShiftRightDoubleIcon: bn,
  InsertDoubleIcon: Ln,
  InsertRowAboveDoubleIcon: wn,
  InsertRowBelowDoubleIcon: yn,
  ItalicIcon: m6,
  KeyboardIcon: b6,
  LeftBorderDoubleIcon: _n,
  LeftDoubleDiagonalDoubleIcon: Mn,
  LeftInsertColumnDoubleIcon: In,
  LeftJustifyingIcon: L6,
  LeftRotationFortyFiveDegreesIcon: w6,
  LeftRotationNinetyDegreesIcon: y6,
  LeftTridiagonalDoubleIcon: xn,
  MaxIcon: _6,
  MenuIcon: M6,
  MergeAllIcon: I6,
  MinIcon: x6,
  ...
  NoRotationIcon: S6,
  OrderIcon: R6,
  OuterBorderDoubleIcon: Sn,
  OverflowIcon: V6,
  PaintBucketDoubleIcon: Rn,
  PasteSpecialDoubleIcon: Vn,
  PercentIcon: O6,
  PipingIcon: $6,
  RedoIcon: E6,
  ReduceDigitsIcon: N6,
  ReduceDoubleIcon: On,
  ReduceIcon: K3,
  RightBorderDoubleIcon: $n,
  RightDoubleDiagonalDoubleIcon: En,
  RightInsertColumnDoubleIcon: Nn,
  RightJustifyingIcon: D6,
  RightRotationFortyFiveDegreesIcon: T6,
  RightRotationNinetyDegreesIcon: Z6,
  RmbIcon: A6,
  RoubleIcon: B6,
  ShortcutIcon: P6,
  SlashDoubleIcon: Dn,
  StrikethroughIcon: F6,
  SubscriptIcon: k6,
  SumIcon: j6,
  SuperscriptIcon: U6,
  TruncationIcon: z6,
  ...
  UndoIcon: Y6,
  UnorderIcon: G6,
  UpBorderDoubleIcon: Tn,
  VerticalBorderDoubleIcon: Zn,
  VerticalCenterIcon: X6,
...
class S1 extends p1 {
  constructor() {
    ...
    for (const n in Me)
      this.register(n, Me[n]);
    this.disposeWithMe(f1(() => {
      for (const n in Me)
        this._components.delete(n), this._componentsReverse.delete(Me[n]);
    }));
  }
  register(n, r, o) {
    const { framework: i = "react" } = o || {};
    if (i === "vue3" && !this._handler.vue3)
    ...
    return this._components.has(n) && console.warn(`Component ${n} already exists.`), this._components.set(n, {
      framework: i,
      component: r
    }), this._componentsReverse.set(r, n), f1(() => {
...
k3 = new WeakMap(), j3 = new WeakMap(), m3(Ae, k3, 2147483647), m3(Ae, j3, -2147483647);
function Xi(e, t, n, r) {
  const o = e.get(T1);
  return new ve((i) => {
    const s = o.focused$.subscribe((v) => {
      if (v == null || n && n !== v || r && (Array.isArray(r) ? r.includes(v) : r === v))
        return i.next(!0);
      const g = o.getUnitType(v);
      i.next(g !== t);
    }), a = o.getFocusedUnit();
    if (a == null)
      return i.next(!0);
    const d = o.getUnitType(a.getUnitId());
    return i.next(d !== t), () => s.unsubscribe();
  });
}
function qi(e) {
  const t = e.get(T1);
  return new ve((n) => {
    ...
    }), o = t.getCurrentUniverDocInstance();
    if (o == null)
      return n.next(!0);
    const i = o == null ? void 0 : o.getSnapshot().documentStyle.documentFlavor;
    return n.next(i !== Ot.TRADITIONAL), () => r.unsubscribe();
  });
}
function h5(e, t) {
  return !t || !e || (["type", "icon", "title", "tooltip"].forEach((o) => {
    t[o] !== void 0 && (e[o] = t[o]);
...
const p5 = (e) => {
  const { value: t, selections: n } = e, r = k(L1), o = Q(() => {
    var i, s;
    return t == null ? "" : r.t((s = (i = n.find((a) => a.value === t)) == null ? void 0 : i.label) != null ? s : "");
  }, [t, n]);
  return /* @__PURE__ */ h(
    "div",
    {
...
}, m5 = "UI_PLUGIN_COMMON_LABEL_COMPONENT";
function M1(e) {
  const { className: t, title: n, icon: r, label: o, value: i, value$: s } = e, a = k(L1), d = k(S1), [v, g] = Y(i), [u, m] = Y(""), L = [];
  let y = 0;
  q(() => {
    if (s) {
      const _ = s.subscribe((D) => {
        g(D);
      });
      return () => {
        _.unsubscribe();
  ...
  const $ = Q(() => i != null ? i : v, [v, i]);
  q(() => {
    let _ = null;
    return Te(r) ? _ = r.subscribe((D) => {
      m(D);
    }) : m(r != null ? r : ""), () => {
      _ == null || _.unsubscribe();
    };
  }, [r]);
  const R = Q(() => $ && typeof $ == "string" ? new V3($).isValid : !1, [$]);
  if (r) {
    const _ = d.get(u != null ? u : "");
    _ && L.push(
      /* @__PURE__ */ h(
        _,
        {
          className: "univer-text-base",
          extend: { colorChannel1: R ? $ : "var(--univer-primary-600)" }
        },
        y++
      )
    );
  ...
  if (o) {
    const _ = typeof o == "string", D = _ ? { ...e } : { ...o == null ? void 0 : o.props, ...e }, V = _ ? o : o == null ? void 0 : o.name, A = d.get(V);
    A ? L.push(
      /* @__PURE__ */ h(
        A,
        {
  ...
  return n && L.push(
    /* @__PURE__ */ h("span", { className: t, children: typeof n == "string" ? a.t(n) : n }, y++)
  ), /* @__PURE__ */ h(o3, { children: L });
}
const b5 = (e) => {
  var i, s;
  const { value: t, text: n } = e, r = u2[t], o = k(L1);
  return /* @__PURE__ */ h(
    "span",
    {
      className: n1("univer-text-sm", {
        "univer-font-bold": r == null ? void 0 : r.bl
      }),
      style: {
        fontSize: r == null ? void 0 : r.fs,
        color: (s = (i = r == null ? void 0 : r.cl) == null ? void 0 : i.rgb) != null ? s : void 0
      },
      children: o.t(n)
    }
  );
}, L5 = "UI_COMPONENT_HEADING_ITEM";
function re(e) {
  const t = t1(e);
  return t.current = e, n3(
    ((...n) => {
      var r;
...
function w5(e, t) {
  const n = re(() => {
    if (!e || !t)
      return;
    const r = e.style, o = e.getBoundingClientRect(), { y: i, height: s } = o, a = t.getBoundingClientRect(), d = e.scrollHeight > s, v = i < 0 || i + s > a.height;
    if (!v && !d) {
      r.overflowY = "", r.maxHeight = "";
      return;
    }
    v && (r.overflowY = "auto", r.maxHeight = i < 0 ? `${e.scrollHeight + i}px` : `${a.height - i}px`);
  });
  q(() => {
    if (!E2() || !e || !t) return;
    n();
...
function Ji(e) {
  k(L1);
  const { value: t, min: n = 0, max: r = 400, disabled: o = !1, resetPoint: i = 100, shortcuts: s, onChange: a } = e, d = t1(null), [v, g] = Y(!1);
  function u() {
    o || a && a(i);
  }
  function m(_) {
  ...
  function y(_) {
    ...
    function A(S) {
      if (V) {
        let j = S.clientX - D.getBoundingClientRect().x;
        j <= 0 ? j = 0 : j >= Ie && (j = Ie);
        const z = j / Ie;
        let G = 0;
        z <= 0.5 ? G = n + z * (i - n) * 2 : G = i + (z - 0.5) * (r - i) * 2, a && a(Math.ceil(G));
      }
    }
    function w() {
      V = !1, document.removeEventListener("pointermove", A), window.removeEventListener("pointerup", w);
    }
    function E(S) {
      S.relatedTarget === null && w();
    }
    window.addEventListener("pointermove", A), window.addEventListener("pointerup", w), window.addEventListener("pointerout", E);
  }
  function $(_) {
    o || (g(!1), a && a(_));
  }
  const R = [{
    type: "radio",
    value: t.toString(),
    options: s.map((_) => ({ value: _.toString(), label: `${_}%` })),
    onSelect: (_) => $(+_)
  }];
  return /* @__PURE__ */ K(
    "div",
    {
      className: n1("univer-flex univer-select-none univer-items-center univer-gap-1", {
      ...
      children: [
        ...
        /* @__PURE__ */ h(
          "div",
          {
            ...
            children: /* @__PURE__ */ K("div", { ref: d, role: "track", className: "univer-relative univer-h-0.5", children: [
              /* @__PURE__ */ h(
                "a",
                {
              ...
              /* @__PURE__ */ h(
                "button",
                {
                  className: n1("univer-absolute univer-top-[calc(50%-6px)] univer-size-3 -univer-translate-x-1/2 univer-rounded-full univer-border-none univer-bg-white univer-shadow univer-transition-colors", {
...
const _5 = "UI_COLOR_PICKER_COMPONENT", M5 = (e) => {
  const { value: t } = e, n = k(L1), r = Q(() => {
    if (t == null) return "";
    let o = n.t(`fontFamily.${`${t != null ? t : ""}`.replace(/\s/g, "")}`);
    return o.startsWith("fontFamily.") && typeof t == "string" && (o = t.split(",")[0]), o;
  }, [t]);
  return /* @__PURE__ */ h(
    "div",
    {
...
var I5 = Object.getOwnPropertyDescriptor, x5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? I5(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, H5 = (e, t) => (n, r) => t(n, r, e);
const An = C1("univer.font-service"), At = [{
  value: "Arial",
...
let T3 = class {
  ...
  dispose() {
    this.resetToDefaults(), this.fonts$.complete();
  }
  getFonts() {
    return this.fonts$.getValue();
  }
  getFontByValue(e) {
    return this.getFonts().find((t) => t.value === e);
  }
  /**
  ...
  isFontSupported(e) {
    ...
    const o = n.measureText(r).width;
    return n.font = `12px "${e}", monospace`, n.measureText(r).width !== o;
  }
  addFont(e) {
    if (this.getFontByValue(e.value))
      throw new Error(`[FontService]: Font with value "${e.value}" already exists.`);
    const n = [...this.getFonts(), e].sort();
    this.fonts$.next(n);
  }
  updateFont(e, t) {
    const n = this.getFonts(), r = n.findIndex((s) => s.value === e);
    if (r === -1)
      throw new Error(`Font with value "${e}" not found.`);
    const o = { ...n[r], ...t }, i = [...n];
    i[r] = o, this.fonts$.next(i);
  }
  removeFont(e) {
    const t = this.getFonts(), n = t.findIndex((i) => i.value === e);
    if (n === -1 || !t[n].isCustom)
      return !1;
    const o = t.filter((i) => i.value !== e);
    return this.fonts$.next(o), !0;
  }
  resetToDefaults() {
    this.fonts$.next([...At]);
  }
...
const S5 = ({ id: e, value: t }) => {
  const n = k(X1), r = k(An), [o, i] = Y([]);
  q(() => {
    const d = r.fonts$.subscribe((v) => {
      i(v);
    });
    return () => {
      d.unsubscribe();
  ...
  return /* @__PURE__ */ h(
    "ul",
    {
      ...
      style: { fontFamily: t },
      children: o.map((d) => /* @__PURE__ */ h("li", { children: /* @__PURE__ */ K(
        "button",
        {
          className: "univer-flex univer-h-7 univer-w-full univer-appearance-none univer-items-center univer-justify-between univer-gap-6 univer-rounded univer-border-none univer-bg-transparent univer-px-2 hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700",
          style: {
            fontFamily: d.value
          },
          type: "button",
...
}, R5 = "UI_FONT_FAMILY_COMPONENT", V5 = "UI_FONT_FAMILY_ITEM_COMPONENT", O5 = (e) => {
  const { value: t, min: n, max: r, onChange: o, disabled$: i } = e, s = d1(i), [a, d] = Y(Number(t != null ? t : 0)), v = Q(() => Number(t != null ? t : a), [t]);
  function g(m) {
    m !== null && d(m);
  }
  function u(m) {
    m.stopPropagation(), m.code === "Enter" && o(a.toString());
  }
  return /* @__PURE__ */ h("div", { className: "univer-h-6 univer-w-7 univer-text-sm", children: /* @__PURE__ */ h(
    D2,
    {
...
], $5 = "UI_FONT_SIZE_COMPONENT", e7 = (e, t) => {
  const n = t1(!1);
  q(() => {
    if (n.current)
      return e();
...
const Bt = (e) => typeof e == "number";
function E5(e) {
  const t = t1(e);
  return t.current = e, t;
}
const r7 = (e, t) => {
  const { containerTarget: n, itemHeight: r, overscan: o = 5 } = t, i = E5(r), [s, a] = Y(null), d = t1(!1), [v, g] = Y([]), [u, m] = Y({ height: void 0, marginTop: void 0 }), L = (V, A) => {
    if (typeof i.current == "number")
      return Math.ceil(V / i.current);
    let w = 0, E = 0;
    for (let S = A; S < e.length; S++) {
      const B = i.current(S, e[S]);
      if (w += B, E = S, w >= V)
        break;
    }
    return E - A;
    ...
    if (Bt(i.current))
      return Math.floor(V / i.current);
    let A = 0, w = 0;
    for (let E = 0; E < e.length; E++) {
      const S = i.current(E, e[E]);
      if (A += S, A >= V) {
        w = E;
        break;
      }
    ...
    return w + 1;
  }, $ = (V) => typeof i.current == "number" ? V * i.current : e.slice(0, V).reduce((w, E, S) => w + i.current(S, e[S]), 0), R = Q(() => Bt(i.current) ? e.length * i.current : e.reduce(
    (V, A, w) => V + i.current(w, e[w]),
    0
  ), [e]), _ = () => {
    const V = n.current;
    if (V) {
      const { scrollTop: A, clientHeight: w } = V, E = y(A), S = L(w, E), B = Math.max(0, E - o), j = Math.min(e.length, E + S + o), z = $(B);
      m({
        height: `${R - z}px`,
        marginTop: `${z}px`
      }), g(
  ...
  return q(() => {
    if (n.current) {
      const V = () => {
        ...
        (w !== (s == null ? void 0 : s.width) || E !== (s == null ? void 0 : s.height)) && a({ width: w, height: E });
      };
      V();
    ...
    !(s != null && s.width) || !(s != null && s.height) || _();
  }, [s == null ? void 0 : s.width, s == null ? void 0 : s.height, e]), [
    v,
    {
      wrapperStyle: u,
      scrollTo: re((V) => {
        const A = n.current;
        A && (d.current = !0, A.scrollTop = $(V), _());
      }),
      containerProps: {
        onScroll: (V) => {
          if (d.current) {
...
var N5 = Object.getOwnPropertyDescriptor, D5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? N5(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, Pt = (e, t) => (n, r) => t(n, r, e);
const T5 = "FOCUSING_UNIVER", Z5 = [
  "app-layout",
  // 'univer-toolbar-btn',
  // 'univer-menu-item',
  "button",
...
let Pe = class extends p1 {
  ...
  focus() {
    ...
    if (!t)
      return;
    let n;
    t instanceof d2 ? n = this._focusHandlers.get(b3.UNIVER_SHEET) : t instanceof d9 ? n = this._focusHandlers.get(b3.UNIVER_DOC) : t instanceof f2 && (n = this._focusHandlers.get(b3.UNIVER_SLIDE)), n && n(t.getUnitId());
  }
  registerFocusHandler(t, n) {
    ...
    return this._focusHandlers.set(t, n), f1(() => this._focusHandlers.delete(t));
  }
  registerContentElement(t) {
    if (this._contentElements.indexOf(t) === -1)
      return this._contentElements.push(t), f1(() => $t(this._contentElements, t));
  ...
  registerContainerElement(t) {
    if (this._allContainers.indexOf(t) === -1)
      return this._allContainers.push(t), f1(() => $t(this._allContainers, t));
  ...
  _initUniverFocusListener() {
    this.disposeWithMe(
      M2(window, "focusin").subscribe((t) => {
        var r;
        const n = t.target;
        if ((r = this._rootContainerElement) != null && r.contains(n) && Z5.some((o) => n.dataset.uComp === o)) {
          queueMicrotask(() => this.focus());
          return;
        }
        n && this.checkElementInCurrentContainers(n) ? this._isFocused = !0 : this._isFocused = !1, this._contextService.setContextValue(T5, this._isFocused), this._contextService.setContextValue(Ne, Ft());
      })
    );
  }
  _initEditorStatus() {
    this._contextService.setContextValue(Ne, Ft());
  }
};
Pe = D5([
  Pt(0, pe),
...
var H1 = /* @__PURE__ */ ((e) => (e[e.BUTTON = 0] = "BUTTON", e[e.SELECTOR = 1] = "SELECTOR", e[e.BUTTON_SELECTOR = 2] = "BUTTON_SELECTOR", e[e.SUBITEMS = 3] = "SUBITEMS", e))(H1 || {}), Fe = /* @__PURE__ */ ((e) => (e.RIBBON = "ribbon", e.CONTEXT_MENU = "contextMenu", e))(Fe || {}), _1 = /* @__PURE__ */ ((e) => (e.START = "ribbon.start", e.INSERT = "ribbon.insert", e.FORMULAS = "ribbon.formulas", e.DATA = "ribbon.data", e.VIEW = "ribbon.view", e.OTHERS = "ribbon.others", e))(_1 || {}), Y1 = /* @__PURE__ */ ((e) => (e.HISTORY = "ribbon.start.history", e.FORMAT = "ribbon.start.format", e.LAYOUT = "ribbon.start.layout", e.OTHERS = "ribbon.start.others", e))(Y1 || {}), $e = /* @__PURE__ */ ((e) => (e.EDIT = "ribbon.insert.edit", e.MEDIA = "ribbon.insert.media", e.OTHERS = "ribbon.insert.others", e))($e || {}), Z3 = /* @__PURE__ */ ((e) => (e.BASIC = "ribbon.formulas.basic", e.OTHERS = "ribbon.formulas.others", e))(Z3 || {}), fe = /* @__PURE__ */ ((e) => (e.FORMULAS = "ribbon.data.formulas", e.RULES = "ribbon.data.rules", e.ORGANIZATION = "ribbon.data.organization", e.OTHERS = "ribbon.data.others", e))(fe || {}), Ee = /* @__PURE__ */ ((e) => (e.DISPLAY = "ribbon.view.display", e.VISIBILITY = "ribbon.view.Visibility", e.OTHERS = "ribbon.view.others", e))(Ee || {}), Bn = /* @__PURE__ */ ((e) => (e.OTHERS = "ribbon.others.others", e))(Bn || {}), W1 = /* @__PURE__ */ ((e) => (e.MAIN_AREA = "contextMenu.mainArea", e.COL_HEADER = "contextMenu.colHeader", e.ROW_HEADER = "contextMenu.rowHeader", e.FOOTER_TABS = "contextMenu.footerTabs", e.FOOTER_MENU = "contextMenu.footerMenu", e.PARAGRAPH = "contextMenu.paragraph", e))(W1 || {}), c1 = /* @__PURE__ */ ((e) => (e.QUICK = "contextMenu.quick", e.FORMAT = "contextMenu.format", e.LAYOUT = "contextMenu.layout", e.DATA = "contextMenu.data", e.OTHERS = "contextMenu.others", e))(c1 || {}), A5 = Object.getOwnPropertyDescriptor, B5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? A5(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, kt = (e, t) => (n, r) => t(n, r, e);
...
let ke = class extends p1 {
  ...
  mergeMenu(t, n) {
    ...
    for (const [o, i] of Object.entries(r))
      if (o in t) {
        const s = o;
        r[s] = De({}, r[s], t[s]), this.menuChanged$.next();
      } else typeof i == "object" && this.mergeMenu(t, i);
  }
  appendRootMenu(t) {
    this._menu = De({}, this._menu, t), this.menuChanged$.next();
  }
  _buildMenuSchema(t) {
    const n = [];
    for (const [r, o] of Object.entries(t)) {
      ...
      if (o.menuItemFactory) {
        const s = this._injector.invoke(o.menuItemFactory);
        if (s) {
          const a = this._configService.getConfig("menu");
          if (a && s.id in a) {
            const d = s.id;
            i.item = h5(s, a[d]);
          } else
      ...
      if (typeof o == "object") {
        const s = this._buildMenuSchema(o);
        s.length > 0 && (i.children = s.sort((a, d) => a.order - d.order)), (i.item || i.children) && n.push(i);
      }
    }
    return n;
  }
   ...
   */
  getFlatMenuByPositionKey(t) {
    const n = this.getMenuByPositionKey(t);
    function r(o) {
      return o.reduce((i, s) => s.children ? [...i, s, ...r(s.children)] : [...i, s], []);
    }
    return r(n);
  }
};
...
function P5(e) {
  const { item: t, onOptionSelect: n } = e, [r, o] = Y([]), i = k(S1), s = k(L1);
  return q(() => {
    if (!t.children) return;
    const a = t.children.map((v) => {
      var g, u;
      return h2((u = (g = v.item) == null ? void 0 : g.activated$) != null ? u : me(!1), !1);
    }), d = le(a).subscribe((v) => {
      const g = v.map((u, m) => ({ actived: u, item: t.children[m].item.id })).filter((u) => u.actived);
      g.length === 0 ? o([]) : o(g.map((u) => u.item));
    });
    return () => {
      d.unsubscribe(), a.forEach((v) => {
        v.complete();
      });
    };
  }, [t]), t.children ? /* @__PURE__ */ h(
    T2,
    {
      items: t.children.map((a) => {
        var d, v;
        return {
          key: a.key,
          onClick: () => {
            ...
            n == null || n({
              value: "",
              label: a.key,
              commandId: (g = a.item) == null ? void 0 : g.commandId,
              id: (u = a.item) == null ? void 0 : u.id,
              tooltip: ((m = a.item) == null ? void 0 : m.tooltip) && s.t((L = a.item) == null ? void 0 : L.tooltip)
            });
          },
          className: "",
          Icon: i.get(a.item.icon),
          active: r.includes((v = (d = a.item) == null ? void 0 : d.id) != null ? v : "")
        };
      })
    }
  ) : null;
}
const he = "univer-inline-flex univer-gap-2 univer-items-center", jt = "univer-size-3.5 univer-text-gray-900 dark:!univer-text-white";
function Pn(e) {
  const { menuType: t, onOptionSelect: n } = e, r = k(L1), o = k(Z1), i = Q(() => t ? o.getMenuByPositionKey(t) : [], [t, o]), [s, a] = Y({}), d = Q(() => i.filter((v) => {
    var u;
    if (!v.children) return v;
    const g = ((u = v.key) == null ? void 0 : u.toString()) || "";
    return !s[g];
  }), [i, s]);
  return q(() => {
    const v = i.map((g) => {
      if (!g.children) return null;
      const u = g.children.map((m) => {
        var L, y;
        return (y = (L = m.item) == null ? void 0 : L.hidden$) != null ? y : me(!1);
      });
      return le(u).subscribe((m) => {
        const L = m.every((y) => y === !0);
        a((y) => ({
          ...y,
          [g.key]: L
        }));
    ...
    return () => {
      v.forEach((g) => g == null ? void 0 : g.unsubscribe()), a({});
    };
  }, [i]), t ? d && d.map((v) => {
    var g;
    return v.item ? /* @__PURE__ */ h(
      Ut,
      {
        menuItem: v.item,
        onClick: (u) => {
          n == null || n({ value: "", label: v.key, ...u });
        }
      },
      v.key
    ) : (g = v.children) != null && g.length ? v.key === c1.QUICK ? /* @__PURE__ */ h(P5, { item: v, onOptionSelect: n }, v.key) : /* @__PURE__ */ h(N3, { eventKey: v.key, title: v.title ? r.t(v.title) : void 0, children: v.children.map((u) => u.item && /* @__PURE__ */ h(
      Ut,
      {
        menuItem: u.item,
        onClick: (m) => {
          n == null || n({ value: "", label: u.key, ...m });
        }
      },
      u.key
    )) }, v.key) : null;
...
function Fn(e) {
  var i;
  const { options: t, value: n, onOptionSelect: r, parentKey: o } = e;
  return (i = t == null ? void 0 : t.map((s, a) => {
    var m, L, y;
    const d = `${o}-${(m = s.label) != null ? m : s.id}-${a}`, v = ($) => {
      r == null || r({ value: $, label: s == null ? void 0 : s.label, commandId: s == null ? void 0 : s.commandId });
    }, g = () => {
      typeof s.value > "u" || r == null || r({
        ...s
      });
    }, u = n1({
      "univer-bg-none": typeof s.label != "string" && !((L = s.label) != null && L.hoverable)
    });
    return /* @__PURE__ */ h(E3, { disabled: s.disabled, eventKey: d, className: u, onClick: g, children: /* @__PURE__ */ K(
      "span",
      {
        className: n1(he, {
...
const F5 = (e) => {
  const { overViewport: t, style: n, ...r } = e, [o, i] = Y(), s = k(j1);
  w5(t === "scroll" ? o : null, s.rootContainerElement);
  function a(d) {
    d && i(d.list);
  }
  return /* @__PURE__ */ K(
...
function Ut({ menuItem: e, onClick: t }) {
  const n = k(Z1), r = d1(e.disabled$, !1), o = d1(e.activated$, !1), i = d1(e.hidden$, !1), s = d1(e.value$), a = e, d = d1(Te(a.selections) ? a.selections : void 0), [v, g] = Y(s);
  if (q(() => {
    g(s);
  }, [s]), i)
    return null;
  const u = (R) => {
    const _ = C2(R) && typeof R == "string" ? Number.parseInt(R) : R;
    g(_);
  }, m = () => {
    const R = e, { title: _, label: D } = R;
    return /* @__PURE__ */ h(
      E3,
      {
        eventKey: R.id,
        ...
        onClick: () => {
          t({ commandId: R.commandId, value: v, id: R.id });
        },
        children: /* @__PURE__ */ h("span", { className: he, children: /* @__PURE__ */ h(
          M1,
          {
            value: s,
            title: _,
    ...
    var _;
    const R = (_ = d != null ? d : a.selections) != null ? _ : [];
    return R.length > 0 ? /* @__PURE__ */ h(
      Dt,
      {
        eventKey: a.id,
        popupOffset: [18, 0],
        title: /* @__PURE__ */ K("span", { className: he, children: [
          /* @__PURE__ */ h(
            M1,
            {
              title: a.title,
        ...
        expandIcon: /* @__PURE__ */ h(D3, { className: jt }),
        children: /* @__PURE__ */ h(N3, { children: R.length > 0 && /* @__PURE__ */ h(
          Fn,
          {
            parentKey: a.id,
            menuType: a.id,
            options: R,
            onOptionSelect: (D) => {
              t({ value: D.value, id: a.id, commandId: D.commandId });
            }
          }
        ) })
      },
      a.id
    ) : /* @__PURE__ */ h(E3, { eventKey: a.id, children: /* @__PURE__ */ K("span", { className: he, children: [
      /* @__PURE__ */ h(
        M1,
        {
          title: a.title,
  ...
  }, y = e.id ? n.getMenuByPositionKey(e.id) : [], $ = () => {
    const R = e;
    return /* @__PURE__ */ h(
      Dt,
      {
        eventKey: R.id,
        popupOffset: [18, 0],
        title: /* @__PURE__ */ h("span", { className: he, children: /* @__PURE__ */ h(M1, { title: R.title, icon: R.icon, label: R.label, onChange: u }) }),
        expandIcon: /* @__PURE__ */ h(D3, { className: jt }),
        children: /* @__PURE__ */ h(N3, { children: y.length && /* @__PURE__ */ h(Pn, { menuType: R.id, parentKey: R.id, onOptionSelect: t }) })
      },
      R.id
    );
  };
  return /* @__PURE__ */ K(o3, { children: [
...
function i7(e) {
  const { barColor: t, progress: n, onTerminate: r, onClearProgress: o } = e, { count: i, done: s, label: a = "" } = n, d = t1(null), [v, g] = Y(!1);
  return q(() => {
    const u = d.current;
    if (i === 0 && s === 0) {
      g(!1), u.style.width = "0%";
      ...
      g(!0);
      const L = Math.floor(s / i * 100);
      s === i ? requestAnimationFrame(() => {
        u.style.width = `${L - 1}%`, requestAnimationFrame(() => {
          u.style.width = `${L}%`;
        });
      }) : u.style.width = `${L}%`;
    }
    ...
    return u.addEventListener("transitionend", m), () => {
      u.removeEventListener("transitionend", m);
    };
  }, [i, s]), /* @__PURE__ */ K(
    "div",
    {
      className: n1("univer-mx-2 univer-flex univer-items-center univer-gap-2", {
        "univer-flex": v,
...
const s7 = "UNI_DISABLE_CHANGING_FOCUS", et = C1("ui.message.service");
var k5 = Object.getOwnPropertyDescriptor, j5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? k5(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, zt = (e, t) => (n, r) => t(n, r, e);
...
const kn = (e, t) => {
  const n = e.get(g2), r = e.get(pe);
  return le([
    n.undoRedoStatus$.pipe(Zt((o) => t ? o.undos <= 0 : o.redos <= 0)),
    I2([me({}), r.contextChanged$])
  ]).pipe(Zt(([o]) => o || r.getContextValue(f9) || r.getContextValue(h9)));
};
function z5(e) {
  return {
    id: z3.id,
...
var y1 = /* @__PURE__ */ ((e) => (e[e.SHIFT = 1024] = "SHIFT", e[e.ALT = 2048] = "ALT", e[e.CTRL_COMMAND = 4096] = "CTRL_COMMAND", e[e.MAC_CTRL = 8192] = "MAC_CTRL", e))(y1 || {});
function X5(e, t, n) {
...
var q5 = Object.getOwnPropertyDescriptor, J5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? q5(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, xe = (e, t) => (n, r) => t(n, r, e);
...
let je = class extends p1 {
  ...
  registerShortcut(t) {
    const n = this._getBindingFromItem(t);
    if (!n) return f1(() => {
    });
    const r = this._shortCutMapping.get(n);
    r ? r.add(t) : this._shortCutMapping.set(n, /* @__PURE__ */ new Set([t]));
    const o = t.id, i = this._commandIDMapping.get(o);
    return i ? i.add(t) : this._commandIDMapping.set(o, /* @__PURE__ */ new Set([t])), this._emitShortcutChanged(), f1(() => {
      var s, a, d, v;
      (s = this._shortCutMapping.get(n)) == null || s.delete(t), ((a = this._shortCutMapping.get(n)) == null ? void 0 : a.size) === 0 && this._shortCutMapping.delete(n), (d = this._commandIDMapping.get(o)) == null || d.delete(t), ((v = this._commandIDMapping.get(o)) == null ? void 0 : v.size) === 0 && this._commandIDMapping.delete(o), this._emitShortcutChanged();
    });
  }
  ...
  getShortcutDisplay(t) {
    ...
    const n = this._getBindingFromItem(t);
    if (!n) return null;
    const r = n & y1.CTRL_COMMAND, o = n & y1.SHIFT, i = n & y1.ALT, s = n & y1.MAC_CTRL, a = (d = G5[n & 255]) != null ? d : "<->";
    return this._platformService.isMac ? `${r ? "⌘+" : ""}${o ? "⇧+" : ""}${i ? "⌥+" : ""}${s ? "⌃+" : ""}${a}` : `${r ? "Ctrl+" : ""}${o ? "Shift+" : ""}${i ? "Alt+" : ""}${a}`;
  }
  _emitShortcutChanged() {
    this._shortcutChanged$.next();
  }
  forceEscape() {
    return this._forceEscaped = !0, f1(() => this._forceEscaped = !1);
  }
  forceDisable() {
    return this._forceDisabled = !0, f1(() => {
      this._forceDisabled = !1;
    });
  }
  ...
  dispatch(t) {
    if (this._forceEscaped || this._forceDisabled || this._layoutService && !this._layoutService.checkElementInCurrentContainers(t.target))
      return;
    const n = this._deriveBindingFromEvent(t);
    if (n === null)
      return;
    const r = this._shortCutMapping.get(n);
    return r === void 0 ? void 0 : Array.from(r).sort((i, s) => {
      var a, d;
      return ((a = s.priority) != null ? a : 0) - ((d = i.priority) != null ? d : 0);
    }).find((i) => {
      var s, a;
      return (a = (s = i.preconditions) == null ? void 0 : s.call(i, this._contextService)) != null ? a : !0;
    });
  }
  ...
  _deriveBindingFromEvent(t) {
    const { shiftKey: n, metaKey: r, altKey: o, keyCode: i } = t;
    let s = i;
    return n && (s |= y1.SHIFT), o && (s |= y1.ALT), (this._platformService.isMac ? r : t.ctrlKey) && (s |= y1.CTRL_COMMAND), this._platformService.isMac && t.ctrlKey && (s |= y1.MAC_CTRL), s;
  }
};
je = J5([
  xe(0, X1),
...
var Q5 = Object.getOwnPropertyDescriptor, K5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Q5(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, Xt = (e, t) => (n, r) => t(n, r, e);
function Yn(e) {
  return e.getContextValue(Ne);
}
function Gn(e) {
  return e.getContextValue(Ne) && !(e.getContextValue(f9) || e.getContextValue(h9));
}
const eo = {
  id: jn.id,
  description: "shortcut.copy",
  group: "1_common-edit",
  binding: q1.C | y1.CTRL_COMMAND,
  preconditions: Yn
}, to = {
  id: Un.id,
  description: "shortcut.cut",
  group: "1_common-edit",
  binding: q1.X | y1.CTRL_COMMAND,
  preconditions: Yn
}, no = {
  id: zn.id,
  description: "shortcut.paste",
  group: "1_common-edit",
  binding: q1.V | y1.CTRL_COMMAND,
  preconditions: () => !1
}, ro = {
  id: z3.id,
  description: "shortcut.undo",
  group: "1_common-edit",
  binding: q1.Z | y1.CTRL_COMMAND,
  preconditions: Gn
}, oo = {
  id: U3.id,
...
let ie = class extends p1 {
  ...
  _registerShortcuts() {
    const e = [ro, oo];
    e.push(to, eo, no), e.forEach((t) => this.disposeWithMe(this._shortcutService.registerShortcut(t)));
  }
};
ie = K5([
  Xt(0, Le),
...
function io() {
  const e = k(Le), t = k(L1), n = d1(t.currentLocale$), [r, o] = Y([]), i = n3(() => {
    var v;
    const s = /* @__PURE__ */ new Map(), a = e.getAllShortcuts().filter((g) => !!g.group);
    for (const g of a) {
      const u = g.group, m = {
        title: t.t((v = g.description) != null ? v : g.id),
        shortcut: e.getShortcutDisplay(g)
      };
      if (!/\d+_[a-zA-Z0-9]/.test(u))
        throw new Error(`[ShortcutPanel]: Invalid shortcut group: ${u}!`);
      s.has(u) || s.set(u, []), s.get(u).push(m);
    }
    const d = Array.from(s.entries()).map(([g, u]) => {
      const m = g.split("_")[0], L = g.slice(m.length + 1);
      return {
        sequence: +m,
        name: t.t(L),
        items: p2(u, (y) => y.title + y.shortcut)
      };
    }).sort((g, u) => g.sequence - u.sequence);
    o(d);
  }, [e, t, n]);
  return q(() => {
    i();
    const s = e.shortcutChanged$.subscribe(() => i());
    return () => s.unsubscribe();
  }, [e, i]), /* @__PURE__ */ h(
    "ul",
    {
      className: "univer-m-0 univer-list-none univer-p-0 univer-text-gray-900 dark:!univer-text-white",
      children: r.map((s) => /* @__PURE__ */ K("li", { children: [
        /* @__PURE__ */ h("div", { className: "univer-flex univer-h-10 univer-items-center univer-text-sm univer-font-semibold", children: s.name }),
        /* @__PURE__ */ h(
          "ul",
          {
            className: n1("univer-list-none univer-p-0", P2),
            children: s.items.map((a) => /* @__PURE__ */ K(
              "li",
              {
                ...
                children: [
                  /* @__PURE__ */ h("span", { className: "univer-line-clamp-2", children: a.title }),
                  a.shortcut && /* @__PURE__ */ h(B2, { keyboard: a.shortcut })
                ]
              },
              `${a.title}-${a.shortcut}`
            ))
...
var so = Object.getOwnPropertyDescriptor, lo = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? so(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, de = (e, t) => (n, r) => t(n, r, e);
const ao = {
  id: i3.id,
  binding: y1.CTRL_COMMAND | q1.BACK_SLASH,
  description: "shortcut.shortcut-panel",
  group: "10_global-shortcut"
};
let se = class extends p1 {
  constructor(e, t, n, r, o) {
    super(), this._menuManagerService = r, this.disposeWithMe(t.register(E9, io)), this.disposeWithMe(o.registerCommand(i3)), this.disposeWithMe(n.registerShortcut(ao));
  }
};
se = lo([
  de(0, m1(V1)),
...
class Xn extends p1 {
  ...
  registerComponent(n, r) {
    const o = r(), i = (this._componentsByPart.get(n) || this._componentsByPart.set(n, /* @__PURE__ */ new Set()).get(n)).add(o);
    return this._componentRegistered$.next(n), f1(() => {
      i.delete(o), i.size === 0 && this._componentsByPart.delete(n), this._componentRegistered$.next(n);
    });
  }
  getComponents(n) {
...
class nt {
  ...
  updateFloatDom(t, n) {
    const r = this._domLayerMap.get(t);
    r && (this._domLayerMap.set(t, {
      ...r,
      ...n
    }), this._notice());
  }
...
const co = M9((e) => {
  var _, D;
  const { layer: t, id: n } = e, r = Q(() => t.position$.pipe(
    y9(
      (V, A) => V.absolute.left === A.absolute.left && V.absolute.top === A.absolute.top && V.endX - V.startX === A.endX - A.startX && V.endY - V.startY === A.endY - A.startY
    )
  ), [t.position$]), o = k(T1), i = d1(Q(() => t.position$.pipe(x2()), [t.position$])), s = t1(null), a = t1(null), d = t1(`transform: rotate(${i == null ? void 0 : i.rotate}deg) translate(${i == null ? void 0 : i.startX}px, ${i == null ? void 0 : i.startY}px)`), v = t1((_ = i == null ? void 0 : i.startY) != null ? _ : 0), g = t1((D = i == null ? void 0 : i.startX) != null ? D : 0), u = t1({}), m = typeof t.componentKey == "string" ? k(S1).get(t.componentKey) : t.componentKey, L = Q(() => ({
    data: t.data,
    ...t.props
  }), [t.data, t.props]);
  q(() => {
    const V = t.position$.subscribe((w) => {
      var E;
      d.current = `rotate(${w.rotate}deg)`, v.current = w.startY, g.current = w.startX, s.current && (s.current.style.transform = d.current, s.current.style.top = `${v.current}px`, s.current.style.left = `${g.current}px`, s.current.style.opacity = `${(E = w.opacity) != null ? E : 1}`);
    }), A = r.subscribe((w) => {
      if (s.current && (s.current.style.width = `${Math.max(w.endX - w.startX - 2, 0)}px`, s.current.style.height = `${Math.max(w.endY - w.startY - 2, 0)}px`), a.current) {
        const E = {
          width: `${w.width - 4}px`,
        ...
        a.current.style.width = E.width, a.current.style.height = E.height, a.current.style.left = E.left, a.current.style.top = E.top, a.current.style.right = E.right, a.current.style.bottom = E.bottom, u.current = E;
      }
    });
    return () => {
      V.unsubscribe(), A.unsubscribe();
    };
  }, [t.position$, r]);
  const y = o.getUnit(t.unitId), $ = y instanceof d9 ? y.getDisabled() : void 0, R = Q(() => m ? /* @__PURE__ */ h(
    m,
    {
      ...L,
      unitId: t.unitId,
  ...
  return i ? /* @__PURE__ */ h(
    "div",
    {
      ...
      style: {
        ...
        top: v.current,
        left: g.current,
        width: Math.max(i.endX - i.startX - 2, 0),
        height: Math.max(i.endY - i.startY - 2, 0),
        transform: d.current,
        overflow: "hidden",
        transformOrigin: "center center"
      },
      onPointerMove: (V) => {
        t.onPointerMove(V.nativeEvent);
      },
      onPointerDown: (V) => {
        t.onPointerDown(V.nativeEvent);
      },
      onPointerUp: (V) => {
        t.onPointerUp(V.nativeEvent);
      },
      onWheel: (V) => {
        t.onWheel(V.nativeEvent);
      },
      children: /* @__PURE__ */ h(
        "div",
        {
...
const Qn = I9({ current: void 0 }), ee = 8;
function Kn(e) {
  const { position: t, width: n, height: r, containerHeight: o, containerWidth: i, direction: s = "vertical", noPushMinimumGap: a = !1 } = e, d = a ? -1 / 0 : ee, v = a ? 1 / 0 : o - r - ee, g = a ? -1 / 0 : ee, u = a ? 1 / 0 : i - n - ee;
  if (s === "vertical" || s.indexOf("top") === 0 || s.indexOf("bottom") === 0) {
    const { left: D, top: V, right: A, bottom: w } = t, E = s === "vertical" && w > v || s.indexOf("top") > -1 ? { top: Math.max(V - r, d) } : { top: Math.min(w, v) };
    let S;
    if (s.includes("center")) {
      const j = (A - D - n) / 2;
      S = Math.max(D + j, g) + n > i ? { left: Math.max(Math.min(u, A - n - j), g) } : { left: Math.max(g, Math.min(D + j, u)) };
    } else s.includes("right") ? S = { left: Math.max(A - n, g) } : s.includes("left") ? S = { left: Math.min(D, u) } : S = D + n > i ? Math.max(A - n, g) < ee ? { left: Math.min(D, u) } : { left: Math.max(A - n, g) } : { left: Math.min(D, u) };
    return { ...E, ...S };
  }
  const { left: m, top: L, right: y, bottom: $ } = t, R = s.includes("left") ? { left: Math.max(m - n, g) } : { left: Math.min(y, u) };
  let _;
  if (s.includes("center")) {
    const V = ($ - L - r) / 2;
    _ = Math.max(L + V, d) + r > o ? { top: Math.max(Math.min(v, $ - r - V), d) } : { top: Math.max(d, Math.min(L + V, v)) };
  } else s.includes("top") ? _ = {
    top: Math.min(L, v)
  } : s.includes("bottom") ? _ = {
    top: Math.max($ - r, d)
...
function ot(e) {
  ...
  const {
    ...
    noPushMinimumGap: _,
    autoRelayout: D = !0
  } = e, V = t1(null), A = re(s != null ? s : (() => {
  })), w = re(L != null ? L : (() => {
  })), E = t1({
    top: -9999,
    left: -9999
  }), S = d, B = k(G1), j = t1(void 0), z = B.getConfig(ae), G = (X = z == null ? void 0 : z.popupRootId) != null ? X : "univer-popup-portal", U = re((W) => {
    requestAnimationFrame(() => {
      if (!V.current) return;
      const { clientWidth: i1, clientHeight: a1 } = V.current, b1 = window.innerWidth, w1 = window.innerHeight;
      E.current = Kn(
        {
          position: W,
          width: i1,
      ...
      ), V.current.style.top = `${E.current.top}px`, V.current.style.left = `${E.current.left}px`;
    });
  });
  q(() => {
    let W;
    return V.current && (W = new ResizeObserver(() => {
      D && j.current && U(j.current);
    }), W.observe(V.current)), () => {
      W == null || W.disconnect();
    };
  }, [V.current, D]), q(() => {
    const W = o.subscribe((i1) => {
      j.current = i1, U(i1);
    });
    ...
    const W = (i1) => {
      var l1;
      if (a && (a.indexOf(i1.target) > -1 || a.some(
        (e1) => e1.contains(i1.target)
      )))
        return;
      const a1 = i1.clientX, b1 = i1.clientY, w1 = [...(l1 = S == null ? void 0 : S.current) != null ? l1 : []];
      j.current && w1.push(j.current);
      for (const e1 of w1)
        if (a1 <= e1.right && a1 >= e1.left && b1 <= e1.bottom && b1 >= e1.top)
          return;
      A(i1);
    };
    return window.addEventListener("pointerdown", W), () => {
      window.removeEventListener("pointerdown", W);
    };
  }, [A, a, S]), q(() => {
    const W = (i1) => {
      i1.ctrlKey && i1.button === 0 || w();
    };
    return window.addEventListener("contextmenu", W), () => {
      window.removeEventListener("contextmenu", W);
    };
  }, [w]);
  const o1 = /* @__PURE__ */ K(o3, { children: [
    t && /* @__PURE__ */ h(
      "div",
      {
    ...
    /* @__PURE__ */ h(
      "section",
      {
        ...
        ref: V,
        className: n1("univer-pointer-events-auto univer-fixed univer-left-[-9999px] univer-top-[-9999px] univer-z-[1020]", {
          "univer-hidden": m,
          "univer-animate-in univer-fade-in-70": !m
        }),
        ...
        onPointerEnter: v,
        onPointerLeave: g,
        children: /* @__PURE__ */ h(Qn.Provider, { value: j, children: r })
      }
    )
  ] });
  return n ? document.getElementById(G) ? $9(o1, document.getElementById(G)) : null : o1;
}
ot.calcPopupPosition = Kn;
ot.useContext = () => r3(Qn);
const uo = ({ popup: e, children: t }) => {
  const [n, r] = Y(!1), o = Q(() => e.anchorRect$.pipe(
    y3(0, _3),
    _9((u) => {
      var D;
      const { bottom: m, left: L, right: y, top: $ } = u, [R = 0, _ = 0] = (D = e.offset) != null ? D : [];
      return {
        left: L - R,
        right: y + R,
        top: $ - _,
  ...
  ), [e.anchorRect$, e.offset]), i = Q(() => {
    var u, m;
    return (m = (u = e.hiddenRects$) == null ? void 0 : u.pipe(y3(0, _3))) != null ? m : me([]);
  }, [e.hiddenRects$]), s = Q(() => {
    var u;
    return (u = e.excludeRects$) == null ? void 0 : u.pipe(y3(0, _3));
  }, [e.excludeRects$]), a = g5(s, e.excludeRects), { canvasElement: d, hideOnInvisible: v = !0, hiddenType: g = "destroy" } = e;
  return q(() => {
    if (!v)
      return;
    const u = le([o, i]).subscribe(([m, L]) => {
      const y = d.getBoundingClientRect(), { top: $, left: R, bottom: _, right: D } = y, V = m.bottom - m.top, A = m.right - m.left, w = L.some((E) => m.top >= E.top - 0.5 * V && m.bottom <= E.bottom + 0.5 * V && m.left >= E.left - 0.5 * A && m.right <= E.right + 0.5 * A);
      m.bottom < $ || m.top > _ || m.right < R || m.left > D || w ? r(!0) : r(!1);
    });
    ...
    ot,
    {
      ...
      ...e.customActive ? null : {
        onPointerEnter: () => {
          var u;
          return (u = e.onActiveChange) == null ? void 0 : u.call(e, !0);
        },
        onPointerLeave: () => {
          var u;
          return (u = e.onActiveChange) == null ? void 0 : u.call(e, !1);
        }
      },
      onClick: e.onClick,
...
function er() {
  ...
  return d1(e.popups$, void 0, !0).map((r) => {
    ...
    return /* @__PURE__ */ h(
      ...
      {
        popup: i,
        children: s ? /* @__PURE__ */ h(s, { popup: i }) : null
      },
      o
    );
  });
...
function x1(e) {
  ...
  return !t || t.size === 0 ? n != null ? n : null : Array.from(t.values()).map((o, i) => {
    var s;
    return M(o, { key: `${(s = o.displayName) != null ? s : i}`, ...r });
  });
}
function I1(e, t) {
  var a;
  ...
  return Q(() => n.isUIVisible(e) ? n.getComponents(e) : /* @__PURE__ */ new Set(), [s]);
}
function fo({
  ribbon: e,
  activatedTab: t,
  ...
  return /* @__PURE__ */ h(
    "div",
    {
      className: "univer-flex univer-h-full univer-w-full univer-items-center univer-justify-center univer-gap-1 univer-overflow-x-auto univer-rounded-md univer-bg-gray-50 univer-px-3 dark:!univer-bg-gray-900",
      role: "tablist",
      "aria-label": r.t("ribbon.menu"),
      children: e.map((o) => {
        const i = t === o.key;
        return /* @__PURE__ */ h(
          "button",
          {
            ...
            title: r.t(o.key),
            onClick: () => n(o),
            className: n1("univer-focus:outline-none univer-focus:ring-2 univer-focus:ring-primary-500 dark:!univer-focus:ring-primary-300 univer-flex univer-cursor-pointer univer-appearance-none univer-items-center univer-gap-1 univer-rounded-sm univer-border-none univer-px-2 univer-py-1 univer-text-sm univer-transition-colors", i ? `
...
function Co({
  ...
  return /* @__PURE__ */ h(
    F2,
    {
      ...
      align: "start",
      open: o,
      overlay: /* @__PURE__ */ h("div", { className: "univer-grid univer-gap-1 univer-px-2 univer-py-1", children: e.map((a) => {
        const d = ho[a.key];
        return /* @__PURE__ */ K(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ h(
                "span",
                {
                  className: n1("univer-box-border univer-flex univer-size-9 univer-flex-shrink-0 univer-items-center univer-justify-center univer-rounded-lg", k2),
                  children: /* @__PURE__ */ h(
                    d,
                    {
              ...
              /* @__PURE__ */ K("span", { className: "univer-flex univer-flex-col", children: [
                /* @__PURE__ */ h(
                  "strong",
                  {
                ...
                /* @__PURE__ */ h("span", { className: "univer-text-xs univer-text-gray-400", children: r.t(`${a.key}Desc`) })
              ] })
            ]
          },
          a.key
...
function vo(e) {
  ...
  return /* @__PURE__ */ h(
    "button",
    {
      ...
      className: n1(tr, {
        "univer-px-2": s,
        "!univer-bg-gray-200 dark:!univer-bg-gray-500": i
      }),
      style: r,
      disabled: o,
      onClick: g,
...
function go(e) {
  const { disabled$: t, hidden$: n, activated$: r, value$: o } = e, [i, s] = Y(), [a, d] = Y(!1), [v, g] = Y(!1), [u, m] = Y(!1);
  return q(() => {
    const L = [];
...
const it = I9({
  ...
  const { children: n, ...r } = e, o = t1(null), [i, s] = Y(!1), [a, d] = Y(!1);
  function v(m) {
    s(a ? !1 : m);
  }
  function g(m) {
...
function mo(e) {
  ...
  return /* @__PURE__ */ h(
    ...
    {
      align: o,
      overlay: /* @__PURE__ */ h("div", { className: "univer-grid univer-gap-2", children: n }),
      disabled: r,
      open: i,
      onOpenChange: a,
      children: /* @__PURE__ */ h("div", { className: "univer-h-full", onClick: (d) => d.stopPropagation(), children: t })
    }
  );
}
function He({ icon: e, value: t, option: n, onOptionSelect: r }) {
  var s;
  const o = (a) => {
    r == null || r({ value: a, label: n == null ? void 0 : n.label, commandId: n == null ? void 0 : n.commandId });
  }, i = typeof n.label == "string" || typeof n.label == "object" && ((s = n.label) == null ? void 0 : s.selectable) !== !1;
  return /* @__PURE__ */ K(
    "div",
    {
      className: n1("univer-relative univer-flex univer-items-center univer-gap-2", {
        "univer-pl-6": i
      }),
      children: [
...
function qt({
  ...
  const { dropdownVisible: a, setDropdownVisible: d } = r3(it), v = k(Z1), [g, u] = Y({}), m = Q(() => e ? v.getMenuByPositionKey(e) : [], [e]), L = Q(() => m.filter((R) => {
    ...
    if (!R.children)
      return !g[R.key];
    const _ = ((D = R.key) == null ? void 0 : D.toString()) || "";
    return !g[_];
  }), [m, g]);
  function y(R) {
    d(R);
  ...
  if (q(() => {
    ...
    return m.forEach((_) => {
      var D;
      if (_.children) {
        const V = _.children.map((w) => {
          var E, S;
          return (S = (E = w.item) == null ? void 0 : E.hidden$) != null ? S : me(!1);
        }), A = le(V).subscribe((w) => {
          const E = w.every((S) => S === !0);
          u((S) => ({
            ...S,
            [_.key]: E
          }));
        ...
        R.push(A);
      } else if ((D = _.item) != null && D.hidden$) {
        const V = _.item.hidden$.subscribe((A) => {
          u((w) => ({
            ...w,
            [_.key]: A
          }));
      ...
      R.forEach((_) => _ == null ? void 0 : _.unsubscribe()), u({});
    };
  }, [m]), t)
    return /* @__PURE__ */ h(
      mo,
  ...
  if (r != null && r.length) {
    const R = r.map((_) => {
      ...
      return {
        type: "item",
        className: n1({
          "focus:univer-bg-white": typeof _.label != "string" && ((D = _.label) == null ? void 0 : D.hoverable) === !1
        }),
        children: /* @__PURE__ */ h(
          He,
          {
    ...
    for (const _ of L) {
      if (!_.item) continue;
      const { title: D, id: V, commandId: A, icon: w } = _.item;
      if (!D)
...
const Se = I((e, t) => {
  const n = k(L1), r = k(X1), o = k(j1), i = k(S1), { value: s, hidden: a, disabled: d, activated: v } = go(e), g = (X, W) => {
    o.focus(), r.executeCommand(X, W);
  }, { tooltip: u, shortcut: m, icon: L, title: y, label: $, id: R, commandId: _, type: D, slot: V, params: A } = e, w = n.t(u != null ? u : "") + (m ? ` (${m})` : ""), { selections: E } = e, S = Q(() => Te(E) ? E : new ve((X) => {
    X.next(E);
  }), [E]), B = d1(S), j = Q(() => Te(L) ? L : new ve((X) => {
    var i1, a1;
    const W = (a1 = (i1 = B == null ? void 0 : B.find((b1) => b1.value === s)) == null ? void 0 : i1.icon) != null ? a1 : L;
    X.next(W);
  }), [L, B, s]), z = d1(j, void 0, !0);
  function G(X) {
    var e1;
    ...
    return X === H1.BUTTON_SELECTOR ? /* @__PURE__ */ K(
      "div",
      {
        "data-u-command": R,
        "data-disabled": d,
        className: n1("univer-animate-in univer-fade-in univer-group univer-relative univer-flex univer-h-6 univer-cursor-pointer univer-items-center univer-rounded univer-pr-5 univer-text-sm univer-transition-colors hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700", {
        ...
        children: [
          /* @__PURE__ */ h(
            "div",
            {
              className: n1("univer-relative univer-z-[1] univer-flex univer-h-full univer-items-center univer-rounded-l univer-px-1 univer-transition-colors hover:univer-bg-gray-200 dark:hover:!univer-bg-gray-600", {
                "univer-bg-gray-200 dark:!univer-bg-gray-500": v,
                "univer-bg-gray-100": v && d
              }),
              onClick: l1,
              children: /* @__PURE__ */ h(
                M1,
          ...
          /* @__PURE__ */ h(
            qt,
            {
              ...
              children: /* @__PURE__ */ h(
                "div",
                {
                  className: n1("univer-absolute univer-right-0 univer-top-0 univer-box-border univer-flex univer-h-6 univer-w-5 univer-items-center univer-justify-center univer-rounded-r univer-transition-colors hover:univer-bg-gray-200 dark:hover:!univer-bg-gray-600", {
                    "univer-pointer-events-none univer-cursor-not-allowed univer-text-gray-300 dark:!univer-text-gray-600": d,
                    "univer-bg-gray-200 dark:!univer-bg-gray-500": v,
                    "univer-bg-gray-100": v && d
                  }),
      ...
      qt,
      {
        ...
        children: /* @__PURE__ */ K(
          ...
          {
            "data-u-command": R,
            className: n1("univer-animate-in univer-fade-in univer-relative univer-flex univer-h-6 univer-cursor-pointer univer-items-center univer-gap-2 univer-whitespace-nowrap univer-rounded univer-px-1 univer-transition-colors hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700", {
              "univer-text-gray-900 dark:!univer-text-white": !d,
              "univer-pointer-events-none univer-cursor-not-allowed univer-text-gray-300 dark:!univer-text-gray-600": d,
              "univer-bg-gray-200": v,
              "univer-bg-gray-100": v && d
            }),
            children: [
              /* @__PURE__ */ h(
              ...
              /* @__PURE__ */ h(
                "div",
                {
                  className: n1("univer-flex univer-h-full univer-items-center", {
                    "univer-pointer-events-none univer-cursor-not-allowed univer-text-gray-300 dark:!univer-text-gray-600": d
                  }),
                  children: /* @__PURE__ */ h(ge, {})
                }
  ...
  function U() {
    var i1;
    const X = i.get(typeof $ == "string" ? $ : (i1 = $ == null ? void 0 : $.name) != null ? i1 : ""), W = (s != null ? s : typeof A == "function") ? A() : A;
    return /* @__PURE__ */ h(
      vo,
      {
        "data-u-command": R,
        ...
        onClick: () => {
          var a1;
          return g((a1 = e.commandId) != null ? a1 : e.id, W);
        },
        onDoubleClick: () => e.subId && g(e.subId),
        children: X ? /* @__PURE__ */ h(M1, { title: y, value: s, label: $ }) : L ? /* @__PURE__ */ h(M1, { icon: L }) : /* @__PURE__ */ h(M1, { title: y })
      }
    );
  }
  function o1() {
...
function bo(e) {
  const { ribbonType: t, headerMenuComponents: n, headerMenu: r = !0 } = e, o = k(Z1), i = k(T1), s = k(L1), [a, d] = Y(0), v = d1(i.focused$);
  q(() => {
    const S = o.menuChanged$.subscribe(() => {
      d((B) => B + 1);
    });
    return () => {
      S.unsubscribe();
  ...
  const g = t1(null), u = t1({}), [m, L] = Y([]), [y, $] = Y(_1.START), [R, _] = Y([]), [D, V] = Y(!1), A = n3((S) => {
    u.current = {}, $(S.key);
  }, []);
  q(() => {
    var z;
    const S = o.getMenuByPositionKey(Fe.RIBBON), B = [], j = [];
    for (const G of S)
      if (G.children) {
        for (const U of G.children)
          if (U.children)
            for (const o1 of U.children)
              (z = o1.item) != null && z.hidden$ && (B.push(o1.item.hidden$), j.push(`${G.key}/${U.key}/${o1.key}`));
      }
    le(B).subscribe((G) => {
      var X, W, i1, a1, b1, w1;
      const U = [], o1 = G.map((l1, e1) => l1 ? j[e1] : null).filter((l1) => !!l1);
      for (const l1 of S) {
          ...
          for (const v1 of l1.children) {
            ...
            if ((W = v1.children) != null && W.length) {
              ...
              (a1 = R1.children) != null && a1.every((J1) => {
                var Q1;
                return ((Q1 = J1.children) == null ? void 0 : Q1.length) === 0;
              }) && (U1 = !1);
            }
  ...
  const w = Q(() => {
    var z, G;
    const S = (G = (z = m.find((U) => U.key === y)) == null ? void 0 : z.children) != null ? G : [], B = [], j = [];
    for (const U of S)
      if (U.children) {
        const o1 = U.children.filter((X) => !R.includes(X.key));
        o1.length > 0 && B.push({
          ...U,
          children: o1
        }), o1.length < U.children.length && j.push({
          ...U,
          children: U.children.filter((X) => R.includes(X.key))
        });
      }
    return {
      allGroups: S,
  ...
  q(() => {
    let S = null;
    const B = new ResizeObserver(m2((j) => {
      for (const z of j)
        V(!0), S = requestAnimationFrame(() => {
          var b1, w1;
          const { width: G } = z.contentRect, o1 = Object.values(u.current).sort((l1, e1) => l1.order - e1.order || l1.groupOrder - e1.groupOrder || l1.itemOrder - e1.itemOrder), X = [];
          let W = 32;
    ...
    return B.observe(g.current), () => {
      S && cancelAnimationFrame(S), B.disconnect();
    };
  }, [m, y]);
  const E = Q(() => /* @__PURE__ */ h(
    "div",
    {
      "aria-hidden": "true",
      className: n1("univer-invisible univer-absolute -univer-left-[99999] -univer-top-[99999] univer-box-border univer-flex univer-h-10 univer-min-w-min univer-items-center univer-px-3 univer-opacity-0", {
        "univer-hidden": !D
      }, Tt, Ze),
      children: w.allGroups.map((S, B) => {
        var j, z;
        return (((j = S.children) == null ? void 0 : j.length) || S.item) && /* @__PURE__ */ h(Nt, { children: /* @__PURE__ */ h("div", { className: "univer-grid univer-shrink-0 univer-grid-flow-col univer-gap-2 univer-px-2", children: S.children && ((z = S.children) == null ? void 0 : z.map((G) => G.item && /* @__PURE__ */ h(
          Se,
          {
            ...G.item,
            ref: (U) => {
              U != null && U.el && (u.current[G.key] = {
                el: U.el,
                key: G.key,
                order: B,
                groupOrder: S.order,
  ...
  return /* @__PURE__ */ K(o3, { children: [
    /* @__PURE__ */ K(
      "div",
      {
        ...
        className: n1("univer-relative univer-select-none", {
          "univer-h-9": t === "classic" || n && n.size > 0
        }),
        children: [
          t === "classic" && m.length > 1 && /* @__PURE__ */ h(
            fo,
            {
              ribbon: m,
              activatedTab: y,
          ...
          r && n && n.size > 0 && /* @__PURE__ */ h(
            "div",
            {
              ...
              children: /* @__PURE__ */ h(x1, { components: n })
            }
          )
        ]
      }
    ...
    /* @__PURE__ */ K(
      "div",
      {
        className: n1("univer-box-border univer-grid univer-h-10 univer-grid-flow-col univer-items-center univer-px-3", {
          "univer-grid-cols-[1fr] univer-justify-center": t === "classic",
          "univer-grid-cols-[auto,1fr]": m.length > 1 && t !== "classic",
          "univer-grid-cols-none": m.length === 1
        }, Ze),
        children: [
          t === "default" && m.length > 1 && /* @__PURE__ */ h(
            Co,
            {
              ribbon: m,
              activatedTab: y,
          ...
          /* @__PURE__ */ K(
            "div",
            {
              ...
              ref: g,
              className: n1("univer-flex univer-overflow-hidden", Tt, {
                "univer-justify-center": t === "classic"
              }),
              role: "toolbar",
              "aria-label": s.t(y),
              children: [
                w.visibleGroups.map((S) => {
                  var B, j;
                  return (((B = S.children) == null ? void 0 : B.length) || S.item) && /* @__PURE__ */ h(Nt, { children: /* @__PURE__ */ h("div", { className: "univer-grid univer-shrink-0 univer-grid-flow-col univer-gap-2 univer-px-2", children: S.children && ((j = S.children) == null ? void 0 : j.map((z) => z.item && /* @__PURE__ */ h(Se, { ...z.item }, z.key))) }) }, S.key);
                }),
                      ...
                      x9,
                      {
                        ...
                        overlay: /* @__PURE__ */ h(
                          "div",
                          {
                            ...
                            children: w.hiddenGroups.map((S) => {
                              var B;
                              return /* @__PURE__ */ h(
                                "div",
                                {
                                  className: "univer-flex univer-items-center univer-gap-2",
                                  children: /* @__PURE__ */ h("div", { className: "univer-flex univer-flex-wrap univer-gap-2", children: S.children ? (B = S.children) == null ? void 0 : B.map((j) => j.item && /* @__PURE__ */ h(Se, { ...j.item }, j.key)) : S.item && /* @__PURE__ */ h(Se, { ...S.item }, S.key) })
                                },
                                S.key
                              );
                            })
  ...
  injectThemeToHead(n) {
    function r(a, d = "--univer") {
      ...
      function g(u, m = "") {
        for (const L in u) {
          const y = u[L], $ = m ? `${m}-${L}` : L;
          typeof y == "object" && y !== null ? g(y, $) : v.push(`${d}-${$}: ${y};`);
        }
      }
      return g(a), v.join(`
`);
    }
    const o = r(n), i = document.getElementById(this._styleSheetId);
    i && i.remove();
    const s = document.createElement("style");
    s.setAttribute("id", this._styleSheetId), s.innerHTML = `:root {
${o}
...
class nr extends p1 {
  ...
  registerContextMenuHandler(n) {
    ...
    return this._currentHandler = n, f1(() => this._currentHandler = null);
  }
}
function Lo() {
  const e = t1(null), [t, n] = Y(!1), [r, o] = Y(""), [i, s] = Y([0, 0]), a = t1(t), d = k(l3), v = k(X1), g = $2();
  a.current = t, q(() => {
    ...
    function y($) {
      e.current && !e.current.contains($.target) && m();
    }
    return document.addEventListener("pointerdown", y), document.addEventListener("wheel", m), () => {
      document.removeEventListener("pointerdown", y), document.removeEventListener("wheel", m), L.dispose();
    };
  }, [d]);
  function u(L, y) {
    n(!1), requestAnimationFrame(() => {
      o(y), s([L.clientX, L.clientY]), n(!0);
    });
  }
  function m() {
    n(!1);
  }
  return /* @__PURE__ */ h(H9, { visible: t, offset: i, children: /* @__PURE__ */ h("section", { ref: e, children: r && /* @__PURE__ */ h(
    F5,
    {
      menuType: r,
      onOptionSelect: (L) => {
        const { label: y, commandId: $, value: R } = L;
        v && v.executeCommand($ != null ? $ : y, { value: R }), g.get(j1).focus(), n(!1);
      }
    }
  ) }) });
}
...
function rr() {
  ...
  return q(() => {
    const s = e.visible$.subscribe((a) => {
      n(a);
    });
    return () => {
      s.unsubscribe();
    };
  }, [e.visible$]), t ? /* @__PURE__ */ h(
    "section",
    {
      className: n1(
        ...
        {
          "univer-hidden": !t,
          "univer-inset-0 univer-z-[100] univer-block univer-size-full": t
        }
      ),
...
function or() {
  const e = k(be), t = d1(e.sidebarOptions$), n = t1(null), r = Q(() => {
    if (!t)
      return null;
    const s = { ...t };
    for (const a of ["children", "header", "footer"]) {
      const d = a;
      if (t[d]) {
        const { key: v, ...g } = t[d];
        g && (s[d] = /* @__PURE__ */ h(M1, { ...g }, v));
      }
    }
    return s;
  }, [t]);
  q(() => (n.current && e.setContainer(n.current), () => {
  ...
  const o = Q(() => r != null && r.visible ? typeof r.width == "number" ? `${r.width}px` : r.width : 0, [r]);
  function i() {
    var a;
    const s = {
      ...t,
    ...
    e.options.visible = !1, e.sidebarOptions$.next(s), (a = s == null ? void 0 : s.onClose) == null || a.call(s);
  }
  return /* @__PURE__ */ h(
    "section",
    {
      "data-u-comp": "sidebar",
      className: n1("univer-relative univer-h-full univer-bg-white univer-text-gray-900 dark:!univer-bg-gray-900 dark:!univer-text-white", {
      ...
      children: /* @__PURE__ */ K(
        ...
        {
          ref: n,
          className: n1("univer-box-border univer-grid univer-h-0 univer-min-h-full univer-grid-rows-[auto_1fr_auto] univer-overflow-y-auto", j2, U2),
          children: [
            /* @__PURE__ */ K(
              "header",
              {
            ...
            /* @__PURE__ */ h("section", { className: "univer-box-border univer-px-4", style: r == null ? void 0 : r.bodyStyle, children: r == null ? void 0 : r.children }),
            (r == null ? void 0 : r.footer) && /* @__PURE__ */ h(
              "footer",
              {
...
function ir() {
  ...
  return /* @__PURE__ */ h(
    "section",
    {
      className: n1("univer-absolute univer-z-[-1] univer-flex", {
        "univer-animate-in univer-fade-in univer-inset-0 univer-z-[100] univer-bg-gray-100": t,
        "univer-hidden": i
      }),
      children: /* @__PURE__ */ h("div", { className: "univer-relative univer-flex-1", children: a && /* @__PURE__ */ h(a, {}) })
    }
  );
}
function wo(e) {
  const t = y5(ae);
  return /* @__PURE__ */ h(yo, { ...e, ...t });
}
function yo(e) {
  var o1;
  const {
    ...
    mountContainer: a,
    onRendered: d
  } = e, v = k(L1), g = k(W3), u = k(s3), m = t1(null), y = k(G1).getConfig(ae), $ = I1(u1.CUSTOM_HEADER), R = I1(u1.FOOTER), _ = I1(u1.HEADER), D = I1(u1.HEADER_MENU), V = I1(u1.CONTENT), A = I1(u1.LEFT_SIDEBAR), w = I1(u1.GLOBAL), E = I1(u1.TOOLBAR), S = (o1 = y == null ? void 0 : y.popupRootId) != null ? o1 : "univer-popup-portal";
  O3(() => {
    const X = g.currentTheme$.subscribe((W) => {
      u.injectThemeToHead(W);
    });
    return () => {
      X.unsubscribe();
    };
  ...
  const [B, j] = Y(!1);
  O3(() => {
    const X = g.darkMode$.subscribe((W) => {
      j(W), W ? document.documentElement.classList.add("univer-dark") : document.documentElement.classList.remove("univer-dark");
    });
    return () => {
      X.unsubscribe();
    };
  }, []), q(() => {
    m.current && (d == null || d(m.current));
  }, [d]);
  const [z, G] = Y(v.getLocales()), U = Q(() => document.createElement("div"), []);
  return q(() => {
    document.body.appendChild(U);
    const X = [
      v.localeChanged$.subscribe(() => {
        G(v.getLocales());
      })
    ];
    return () => {
      X.forEach((W) => W.unsubscribe()), document.body.removeChild(U);
    };
  }, [v, a, U]), /* @__PURE__ */ K(S9, { locale: z == null ? void 0 : z.design, mountContainer: U, children: [
    /* @__PURE__ */ K(
      "div",
      {
        "data-u-comp": "workbench-layout",
        className: n1("univer-flex univer-h-full univer-min-h-0 univer-flex-col univer-bg-white dark:!univer-bg-gray-800", {
          "univer-dark": B
        }),
        tabIndex: -1,
        ...
        children: [
          /* @__PURE__ */ h(
            "div",
            {
              ...
              children: /* @__PURE__ */ h(x1, { components: $ }, "custom-header")
            }
          ),
          t && n && /* @__PURE__ */ h(
            "header",
          ...
          /* @__PURE__ */ K("section", { className: "univer-relative univer-flex univer-min-h-0 univer-flex-1 univer-flex-col", children: [
            /* @__PURE__ */ K(
              "div",
              {
                className: "univer-grid univer-h-full univer-grid-cols-[auto_1fr_auto] univer-grid-rows-[100%] univer-overflow-hidden",
                children: [
                  /* @__PURE__ */ h("aside", { "data-u-comp": "left-sidebar", className: "univer-h-full", children: /* @__PURE__ */ h(x1, { components: A }, "left-sidebar") }),
                  /* @__PURE__ */ K(
                    "section",
                    {
                      className: n1("univer-relative univer-grid univer-flex-1 univer-grid-rows-[auto_1fr] univer-overflow-hidden univer-bg-white dark:!univer-bg-gray-800", Ze),
                      children: [
                        /* @__PURE__ */ h("header", { children: t && /* @__PURE__ */ h(x1, { components: _ }, "header") }),
                        /* @__PURE__ */ h(
                          "section",
                          {
                            ...
                            onContextMenu: (X) => X.preventDefault(),
                            children: /* @__PURE__ */ h(x1, { components: V }, "content")
                          }
                        )
                      ]
                    }
                  ),
                  /* @__PURE__ */ h("aside", { "data-u-comp": "right-sidebar", className: "univer-h-full", children: /* @__PURE__ */ h(or, {}) })
                ]
              }
            ),
            r && /* @__PURE__ */ h("footer", { children: /* @__PURE__ */ h(x1, { components: R, sharedProps: { contextMenu: i } }, "footer") }),
            /* @__PURE__ */ h(ir, {})
          ] })
        ]
      }
    ),
    /* @__PURE__ */ h(x1, { components: w }, "global"),
    /* @__PURE__ */ h(rr, {}),
    i && /* @__PURE__ */ h(Lo, {}),
    /* @__PURE__ */ h(_o, {}),
    /* @__PURE__ */ h("div", { id: S })
...
function _o() {
  const { mountContainer: e } = r3(z2), t = I1(u1.FLOATING);
...
class sr extends p1 {
  ...
  _bootstrapWorkbench() {
    this.disposeWithMe(this.bootstrap(async (n, r) => {
      ...
      try {
        await this._lifecycleService.onStage(L3.Ready), this._renderTimeout = window.setTimeout(() => {
          const o = this._renderManagerService.getRenderAll();
          for (const [i] of o)
            if (this._changeRenderUnit(i, n)) break;
          this.disposeWithMe(this._instanceService.focused$.subscribe((i) => {
            i && this._changeRenderUnit(i, n);
          })), this.disposeWithMe(this._renderManagerService.created$.subscribe((i) => {
            var s;
            i.unitId === ((s = this._instanceService.getFocusedUnit()) == null ? void 0 : s.getUnitId()) && this._changeRenderUnit(i.unitId, n);
          })), this.disposeWithMe(this._renderManagerService.disposed$.subscribe((i) => {
            this._currentRenderId === i && (this._currentRenderId = null);
          })), this._lifecycleService.stage = L3.Rendered, this._steadyTimeout = window.setTimeout(() => {
            this._lifecycleService.stage = L3.Steady;
          }, Mo);
        }, 300);
      } catch (o) {
        if (o instanceof b2)
  ...
  _changeRenderUnit(n, r) {
    if (this._currentRenderId === n) return !1;
    const o = this._renderManagerService.getRenderById(n);
    if (!o || !o.unitId || L2(o.unitId)) return !1;
    const i = this._currentRenderId ? this._renderManagerService.getRenderById(this._currentRenderId) : null;
    return i == null || i.deactivate(), i == null || i.engine.unmount(), o.engine.mount(r), o.activate(), this._currentRenderId = n, !0;
  }
}
var Io = Object.getOwnPropertyDescriptor, xo = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Io(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, F1 = (e, t) => (n, r) => t(n, r, e);
let A3 = class extends sr {
  constructor(e, t, n, r, o, i, s, a, d) {
    super(t, i, o, n, r), this._config = e, this._componentManager = d, s.mergeMenu(Y5), this._initBuiltinComponents(a), this._registerComponents(), this._bootstrapWorkbench();
  }
  _registerComponents() {
    [
      [m5, p5],
  ...
  bootstrap(e) {
    return Ho(this._injector, this._config, e);
  }
  _initBuiltinComponents(e) {
    this.disposeWithMe(e.registerComponent(u1.FLOATING, () => $1(er, this._injector))), this.disposeWithMe(e.registerComponent(u1.CONTENT, () => $1(qn, this._injector))), this.disposeWithMe(e.registerComponent(u1.TOOLBAR, () => $1(bo, this._injector)));
  }
};
A3 = xo([
  F1(1, m1(V1)),
...
function Ho(e, t, n) {
  ...
  return a(), f1(() => {
    Oe(/* @__PURE__ */ h("div", {}), r), setTimeout(() => Oe(/* @__PURE__ */ h("div", {}), r), 200), setTimeout(() => R9(r), 500);
  });
}
function Jt(e) {
...
function So(e) {
  ...
  if (!t)
    return null;
  const o = Q(() => {
    const i = r.getMenuByPositionKey(t);
    function s(a) {
      return a.reduce((d, v) => v.children ? [...d, ...s(v.children)] : [...d, v], []);
    }
    return s(i);
  }, [t]);
  return /* @__PURE__ */ h(
    "div",
    {
      ...
      children: o.map((i) => i.item && /* @__PURE__ */ h(
        Ro,
        {
          menuItem: i.item,
          onClick: (s) => n == null ? void 0 : n({ value: "", label: i.key, ...s })
        },
        i.key
      ))
    }
...
function Ro(e) {
  const { menuItem: t, onClick: n } = e, { id: r, type: o, title: i, label: s, icon: a } = t;
  if (o !== H1.BUTTON)
    throw new Error(`[MobileMenuItem]: on mobile devices only "BUTTON" type menu items are supported. Please check "${r}".`);
  const d = d1(t.disabled$, !1), v = d1(t.value$);
  return /* @__PURE__ */ h(
    "button",
    {
      type: "button",
      className: n1("univer-w-18 univer-flex univer-flex-col univer-items-center univer-justify-center univer-border-none univer-bg-transparent univer-text-white [&>span]:univer-mt-0.5 [&>span]:univer-w-full [&>span]:univer-truncate [&>span]:univer-text-sm [&>svg]:univer-size-[18px] [&>svg]:univer-text-lg"),
      disabled: d,
      onClick: () => n({ id: r }),
      children: /* @__PURE__ */ h(M1, { value: v, title: i, label: s, icon: a })
    },
    r
  );
}
function Vo() {
  const [e, t] = Y(!1), [n, r] = Y(""), [o, i] = Y([0, 0]), s = t1(e), a = k(l3), d = k(X1);
  s.current = e, q(() => {
    const u = a.registerContextMenuHandler({
      handleContextMenu: v,
      hideContextMenu() {
        t(!1);
      },
    ...
    return document.addEventListener("pointerdown", g), document.addEventListener("wheel", g), () => {
      document.removeEventListener("pointerdown", g), document.removeEventListener("wheel", g), u.dispose();
    };
  }, [a]);
  function v(u, m) {
    r(m), i([u.clientX, u.clientY]), t(!0);
  }
  function g() {
    t(!1);
  }
  return /* @__PURE__ */ h(H9, { visible: e, offset: o, children: /* @__PURE__ */ h("section", { onPointerDown: (u) => u.stopPropagation(), children: n && // TODO@wzhudev: change to mobile menu
  /* @__PURE__ */ h(
    So,
    {
      menuType: n,
      onOptionSelect: (u) => {
        const { label: m, value: L, commandId: y } = u;
        d && d.executeCommand(y != null ? y : m, { value: L }), t(!1);
      }
    }
  ) }) });
}
function Oo(e) {
  const {
    ...
    mountContainer: o,
    onRendered: i
  } = e, s = k(L1), a = k(W3), d = k(s3), v = t1(null), g = I1(u1.FOOTER), u = I1(u1.HEADER), m = I1(u1.CONTENT), L = I1(u1.LEFT_SIDEBAR), y = I1(u1.GLOBAL), [$, R] = Y(!1);
  q(() => {
    const A = a.darkMode$.subscribe((w) => {
      R(w);
    });
    return () => {
      A.unsubscribe();
    ...
    v.current && (i == null || i(v.current));
  }, [i]);
  const [_, D] = Y(s.getLocales()), V = Q(() => document.createElement("div"), []);
  return O3(() => {
    const A = a.currentTheme$.subscribe((w) => {
    ...
    return () => {
      A.forEach((w) => w.unsubscribe()), document.body.removeChild(V);
    };
  }, [s, o, V]), /* @__PURE__ */ K(S9, { locale: _ == null ? void 0 : _.design, mountContainer: V, children: [
    /* @__PURE__ */ K(
      "div",
      {
        "data-u-comp": "app-layout",
        className: n1("univer-relative univer-flex univer-h-full univer-min-h-0 univer-flex-col univer-bg-white dark:!univer-bg-gray-800", {
          "univer-dark": $
        }),
        tabIndex: -1,
        onBlur: (A) => A.stopPropagation(),
        children: [
          t && /* @__PURE__ */ h("header", { className: "univer-relative univer-z-10 univer-w-full" }),
          /* @__PURE__ */ K("section", { className: "univer-relative univer-flex univer-min-h-0 univer-flex-1 univer-flex-col", children: [
            /* @__PURE__ */ K(
              "div",
              {
                className: "univer-grid univer-h-full univer-grid-cols-[auto_1fr_auto] univer-grid-rows-[100%] univer-overflow-hidden",
                children: [
                  /* @__PURE__ */ h("aside", { className: "univer-h-full", children: /* @__PURE__ */ h(x1, { components: L }, "left-sidebar") }),
                  /* @__PURE__ */ K(
                    "section",
                    {
                      className: n1("univer-relative univer-grid univer-flex-1 univer-grid-rows-[auto_1fr] univer-overflow-hidden univer-bg-white dark:!univer-bg-gray-800", Ze),
                      children: [
                        /* @__PURE__ */ h("header", { className: "univer-w-screen", children: t && /* @__PURE__ */ h(x1, { components: u }, "header") }),
                        /* @__PURE__ */ h(
                          "section",
                          {
                            ref: v,
                            ...
                            children: /* @__PURE__ */ h(x1, { components: m }, "content")
                          }
                        )
                      ]
                    }
                  ),
                  /* @__PURE__ */ h("aside", { className: "univer-h-full", children: /* @__PURE__ */ h(or, {}) })
                ]
              }
            ),
            n && /* @__PURE__ */ h("footer", { children: /* @__PURE__ */ h(x1, { components: g }, "footer") }),
            /* @__PURE__ */ h(rr, {}),
            /* @__PURE__ */ h(ir, {})
          ] })
        ]
    ...
    /* @__PURE__ */ h(x1, { components: y }, "global"),
    r && /* @__PURE__ */ h(Vo, {})
  ] });
}
var $o = Object.getOwnPropertyDescriptor, Eo = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? $o(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, te = (e, t) => (n, r) => t(n, r, e);
let B3 = class extends sr {
  constructor(e, t, n, r, o, i, s) {
    super(t, i, o, n, r), this._config = e, this._initBuiltinComponents(s), this._bootstrapWorkbench();
  }
  bootstrap(e) {
    return No(this._injector, this._config, e);
  }
  _initBuiltinComponents(e) {
    this.disposeWithMe(e.registerComponent(u1.CONTENT, () => $1(er, this._injector))), this.disposeWithMe(e.registerComponent(u1.CONTENT, () => $1(qn, this._injector)));
  }
};
B3 = Eo([
  te(1, m1(V1)),
...
var Do = Object.getOwnPropertyDescriptor, To = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Do(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, Zo = (e, t) => (n, r) => t(n, r, e);
const lr = C1("univer.ui.before-close-service");
let ze = class {
  constructor(e) {
...
const Kt = "text/plain", e9 = "text/html", Fo = "image/png", ko = "image/jpeg", jo = "image/bmp", Uo = "image/webp", a7 = "image/svg+xml", c7 = /* @__PURE__ */ new Set([
  jo,
  ko,
  Uo,
  Fo
...
let We = class extends p1 {
  ...
  _legacyCopyHtml(e) {
    const t = document.activeElement, n = Wo();
  ...
  _legacyCopyText(e) {
    const t = document.activeElement, n = zo();
...
const Yo = (e) => {
  const { children: t, onClose: n, onConfirm: r } = e, [o] = Y({}), i = t ? O2(t, { hooks: o }) : null;
  return /* @__PURE__ */ h(
    Y2,
    {
      ...e,
...
function Go() {
  ...
  const r = t.map((o) => {
    const { children: i, title: s, ...a } = o, d = a;
    for (const v of ["children", "title"]) {
      const g = v, u = o[g];
      u && (d[g] = /* @__PURE__ */ h(M1, { ...u }));
    }
    return d;
  });
  return r == null ? void 0 : r.map((o, i) => /* @__PURE__ */ h(Yo, { ...o, children: o.children }, i));
}
var Xo = Object.getOwnPropertyDescriptor, qo = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Xo(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, n9 = (e, t) => (n, r) => t(n, r, e);
let Ye = class extends p1 {
  ...
  open(t) {
    return this._confirmOptions.find((n) => n.id === t.id) ? this._confirmOptions = this._confirmOptions.map((n) => ({
      ...
      ...t,
      visible: !0
    }), this.confirmOptions$.next(this._confirmOptions), f1(() => {
  ...
  _initUIPart() {
    this.disposeWithMe(
      this._uiPartsService.registerComponent(u1.GLOBAL, () => $1(Go, this._injector))
    );
  }
};
Ye = qo([
...
function Jo() {
  const e = k(ct), [t, n] = Y([]);
  q(() => {
    const i = e.getDialogs$().subscribe((s) => {
      n(s);
    });
    return () => i.unsubscribe();
  }, []);
  const r = Q(() => t.map((o) => {
    const { children: i, title: s, footer: a, ...d } = o, v = d;
    for (const g of ["children", "title", "footer"]) {
      const u = g, m = o[u];
      m && (v[u] = /* @__PURE__ */ h(M1, { ...m }));
    }
    return v;
  }), [t]);
  return r == null ? void 0 : r.map((o) => /* @__PURE__ */ h(G2, { ...o }, o.id));
}
var Qo = Object.getOwnPropertyDescriptor, Ko = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Qo(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, r9 = (e, t) => (n, r) => t(n, r, e);
let Ge = class extends p1 {
  ...
  open(t) {
    return this._dialogOptions.find((n) => n.id === t.id) ? this._dialogOptions = this._dialogOptions.map((n) => ({
      ...n.id === t.id ? t : n,
      open: n.id === t.id ? !0 : n.open
    })) : this._dialogOptions.push({
      ...t,
      open: !0
    }), this._dialogOptions$.next(this._dialogOptions), f1(() => {
  ...
  _initUIPart() {
    this.disposeWithMe(
      this._uiPartsService.registerComponent(u1.GLOBAL, () => $1(Jo, this._injector))
    );
  }
};
Ge = Ko([
...
function ei() {
  ...
  return t ? /* @__PURE__ */ h(X2, { ...t }) : null;
}
var ti = Object.getOwnPropertyDescriptor, ni = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? ti(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, o9 = (e, t) => (n, r) => t(n, r, e);
let Xe = class extends p1 {
  ...
  _initUIPart() {
    this.disposeWithMe(
      this._uiPartsService.registerComponent(u1.GLOBAL, () => $1(ei, this._injector))
    );
  }
};
Xe = ni([
...
var ri = Object.getOwnPropertyDescriptor, oi = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? ri(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, ii = (e, t) => (n, r) => t(n, r, e);
let qe = class {
  ...
  set(e, t) {
    return this._componentManager.register(e, t), this.componentKey$.next(e), this._componentKey = e, f1(() => {
...
class cr extends p1 {
  openFile(t) {
    return new Promise((n) => {
      ...
      r.type = "file", r.accept = (o = t == null ? void 0 : t.accept) != null ? o : "", r.multiple = (i = t == null ? void 0 : t.multiple) != null ? i : !1, r.onchange = (s) => {
...
const ur = C1("univer-ui.local-file.service");
    ...
    (function(n) {
      ...
      return (function n(r, o, i) {
        function s(v, g) {
          if (!o[v]) {
            if (!r[v]) {
              var u = typeof Ve == "function" && Ve;
              if (!g && u) return u(v, !0);
              if (a) return a(v, !0);
              var m = new Error("Cannot find module '" + v + "'");
              throw m.code = "MODULE_NOT_FOUND", m;
            }
            var L = o[v] = { exports: {} };
            r[v][0].call(L.exports, function(y) {
              var $ = r[v][1][y];
              return s($ || y);
            }, L, L.exports, n, r, o, i);
          }
        ...
        for (var a = typeof Ve == "function" && Ve, d = 0; d < i.length; d++) s(i[d]);
        return s;
      })({ 1: [function(n, r, o) {
        (function(i) {
          var s = i.MutationObserver || i.WebKitMutationObserver, a;
          if (s) {
            var d = 0, v = new s(y), g = i.document.createTextNode("");
            v.observe(g, {
              characterData: !0
            }), a = function() {
              g.data = d = ++d % 2;
            ...
            var u = new i.MessageChannel();
            u.port1.onmessage = y, a = function() {
              u.port2.postMessage(0);
            };
          } else "document" in i && "onreadystatechange" in i.document.createElement("script") ? a = function() {
            var R = i.document.createElement("script");
            R.onreadystatechange = function() {
              y(), R.onreadystatechange = null, R.parentNode.removeChild(R), R = null;
        ...
        var a = {}, d = ["REJECTED"], v = ["FULFILLED"], g = ["PENDING"];
        r.exports = u;
        function u(w) {
          if (typeof w != "function")
            throw new TypeError("resolver must be a function");
          this.state = g, this.queue = [], this.outcome = void 0, w !== s && $(this, w);
        }
        u.prototype.catch = function(w) {
          return this.then(null, w);
        }, u.prototype.then = function(w, E) {
          if (typeof w != "function" && this.state === v || typeof E != "function" && this.state === d)
            return this;
          var S = new this.constructor(s);
          if (this.state !== g) {
            var B = this.state === v ? w : E;
            L(S, B, this.outcome);
          } else
            this.queue.push(new m(S, w, E));
          return S;
        };
        function m(w, E, S) {
          this.promise = w, typeof E == "function" && (this.onFulfilled = E, this.callFulfilled = this.otherCallFulfilled), typeof S == "function" && (this.onRejected = S, this.callRejected = this.otherCallRejected);
        }
        ...
        function L(w, E, S) {
          i(function() {
            ...
            B === w ? a.reject(w, new TypeError("Cannot resolve promise with itself")) : a.resolve(w, B);
          });
        }
        a.resolve = function(w, E) {
          var S = R(y, E);
          if (S.status === "error")
            return a.reject(w, S.value);
          var B = S.value;
          if (B)
            $(w, B);
          else {
            w.state = v, w.outcome = E;
            for (var j = -1, z = w.queue.length; ++j < z; )
              w.queue[j].callFulfilled(E);
          }
          return w;
        }, a.reject = function(w, E) {
          w.state = d, w.outcome = E;
          for (var S = -1, B = w.queue.length; ++S < B; )
            w.queue[S].callRejected(E);
          return w;
        };
        function y(w) {
          var E = w && w.then;
        ...
        u.resolve = _;
        function _(w) {
          return w instanceof this ? w : a.resolve(new this(s), w);
        }
        u.reject = D;
        function D(w) {
          var E = new this(s);
        ...
        function V(w) {
          ...
          if (!S)
            return this.resolve([]);
          for (var j = new Array(S), z = 0, G = -1, U = new this(s); ++G < S; )
            o1(w[G], G);
          return U;
          function o1(X, W) {
            E.resolve(X).then(i1, function(a1) {
              B || (B = !0, a.reject(U, a1));
            });
            function i1(a1) {
              j[W] = a1, ++z === S && !B && (B = !0, a.resolve(U, j));
            }
          }
        }
        u.race = A;
        function A(w) {
          ...
          if (!S)
            return this.resolve([]);
          for (var j = -1, z = new this(s); ++j < S; )
            G(w[j]);
          return z;
          function G(U) {
            E.resolve(U).then(function(o1) {
              B || (B = !0, a.resolve(z, o1));
            }, function(o1) {
              B || (B = !0, a.reject(z, o1));
            });
          }
        ...
        function v() {
          try {
            if (!d || !d.open)
              return !1;
            var l = typeof openDatabase < "u" && /(Safari|iPhone|iPad|iPod)/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent) && !/BlackBerry/.test(navigator.platform), f = typeof fetch == "function" && fetch.toString().indexOf("[native code") !== -1;
            return (!l || f) && typeof indexedDB < "u" && // some outdated implementations of IDB that appear on Samsung
        ...
        function g(l, f) {
          ...
          try {
            ...
            if (C.name !== "TypeError")
              throw C;
            for (var c = typeof BlobBuilder < "u" ? BlobBuilder : typeof MSBlobBuilder < "u" ? MSBlobBuilder : typeof MozBlobBuilder < "u" ? MozBlobBuilder : WebKitBlobBuilder, p = new c(), b = 0; b < l.length; b += 1)
              p.append(l[b]);
            return p.getBlob(f.type);
          }
        }
        ...
        function L(l, f, c) {
          typeof f == "function" && l.then(f), typeof c == "function" && l.catch(c);
        }
        function y(l) {
        ...
        var R = "local-forage-detect-blob-support", _ = void 0, D = {}, V = Object.prototype.toString, A = "readonly", w = "readwrite";
        function E(l) {
          for (var f = l.length, c = new ArrayBuffer(f), p = new Uint8Array(c), b = 0; b < f; b++)
            p[b] = l.charCodeAt(b);
          return c;
        }
        function S(l) {
          return new u(function(f) {
            var c = l.transaction(R, w), p = g([""]);
            c.objectStore(R).put(p, "key"), c.onabort = function(b) {
              b.preventDefault(), b.stopPropagation(), f(!1);
            }, c.oncomplete = function() {
              var b = navigator.userAgent.match(/Chrome\/(\d+)/), C = navigator.userAgent.match(/Edge\//);
              f(C || !b || parseInt(b[1], 10) >= 43);
            };
          }).catch(function() {
            return !1;
          });
        ...
        function B(l) {
          return typeof _ == "boolean" ? u.resolve(_) : S(l).then(function(f) {
            return _ = f, _;
          });
        }
        function j(l) {
          var f = D[l.name], c = {};
          c.promise = new u(function(p, b) {
        ...
        function z(l) {
          var f = D[l.name], c = f.deferredOperations.pop();
          if (c)
            return c.resolve(), c.promise;
        }
        function G(l, f) {
          var c = D[l.name], p = c.deferredOperations.pop();
          if (p)
            return p.reject(f), p.promise;
        }
        function U(l, f) {
          return new u(function(c, p) {
            ...
            var b = [l.name];
            f && b.push(l.version);
            var C = d.open.apply(d, b);
            f && (C.onupgradeneeded = function(H) {
              var O = C.result;
              try {
                O.createObjectStore(l.storeName), H.oldVersion <= 1 && O.createObjectStore(R);
              } catch (N) {
                if (N.name === "ConstraintError")
                  console.warn('The database "' + l.name + '" has been upgraded from version ' + H.oldVersion + " to version " + H.newVersion + ', but the storage "' + l.storeName + '" already exists.');
                else
                  throw N;
              }
            }), C.onerror = function(H) {
              H.preventDefault(), p(C.error);
            }, C.onsuccess = function() {
              var H = C.result;
              H.onversionchange = function(O) {
                O.target.close();
              }, c(H), z(l);
            };
          });
        ...
        function W(l, f) {
          if (!l.db)
            return !0;
          var c = !l.db.objectStoreNames.contains(l.storeName), p = l.version < l.db.version, b = l.version > l.db.version;
          if (p && (l.version !== f && console.warn('The database "' + l.name + `" can't be downgraded from version ` + l.db.version + " to version " + l.version + "."), l.version = l.db.version), b || c) {
            if (c) {
              var C = l.db.version + 1;
              C > l.version && (l.version = C);
            }
            return !0;
          }
          return !1;
        ...
        function i1(l) {
          return new u(function(f, c) {
            var p = new FileReader();
            p.onerror = c, p.onloadend = function(b) {
              var C = btoa(b.target.result || "");
              f({
                __local_forage_encoded_blob: !0,
                data: C,
                type: l.type
              });
            }, p.readAsBinaryString(l);
          });
        }
        function a1(l) {
          var f = E(atob(l.data));
          return g([f], { type: l.type });
        }
        function b1(l) {
        ...
        function l1(l) {
          j(l);
          for (var f = D[l.name], c = f.forages, p = 0; p < c.length; p++) {
            var b = c[p];
            b._dbInfo.db && (b._dbInfo.db.close(), b._dbInfo.db = null);
          }
          return l.db = null, o1(l).then(function(C) {
            return l.db = C, W(l) ? X(l) : C;
          }).then(function(C) {
            l.db = f.db = C;
        ...
        function e1(l, f, c, p) {
          p === void 0 && (p = 1);
          try {
            var b = l.db.transaction(l.storeName, f);
            c(null, b);
          } catch (C) {
            if (p > 0 && (!l.db || C.name === "InvalidStateError" || C.name === "NotFoundError"))
              return u.resolve().then(function() {
                if (!l.db || C.name === "NotFoundError" && !l.db.objectStoreNames.contains(l.storeName) && l.version <= l.db.version)
                  return l.db && (l.version = l.db.version + 1), X(l);
              }).then(function() {
                return l1(l).then(function() {
                  e1(l, f, c, p - 1);
                });
              }).catch(c);
            c(C);
        ...
        function R1(l) {
          ...
          for (var O = 0; O < b.forages.length; O++) {
            var N = b.forages[O];
            N !== f && C.push(N._initReady().catch(H));
          }
          var T = b.forages.slice(0);
          return u.all(C).then(function() {
            return c.db = b.db, o1(c);
          }).then(function(Z) {
        ...
        function U1(l, f) {
          var c = this;
          l = y(l);
          var p = new u(function(b, C) {
            c.ready().then(function() {
              e1(c._dbInfo, A, function(H, O) {
                if (H)
                  return C(H);
                try {
                  var N = O.objectStore(c._dbInfo.storeName), T = N.get(l);
                  T.onsuccess = function() {
                    var Z = T.result;
                    Z === void 0 && (Z = null), b1(Z) && (Z = a1(Z)), b(Z);
                  }, T.onerror = function() {
                    C(T.error);
                  };
                } catch (Z) {
        ...
        function J1(l, f) {
          var c = this, p = new u(function(b, C) {
            c.ready().then(function() {
              e1(c._dbInfo, A, function(H, O) {
                if (H)
                  return C(H);
        ...
        function Q1(l, f, c) {
          var p = this;
          l = y(l);
          var b = new u(function(C, H) {
            var O;
            p.ready().then(function() {
              return O = p._dbInfo, V.call(f) === "[object Blob]" ? B(O.db).then(function(N) {
                return N ? f : i1(f);
              }) : f;
            }).then(function(N) {
              e1(p._dbInfo, w, function(T, Z) {
                if (T)
                  return H(T);
                try {
                  ...
                  Z.oncomplete = function() {
                    ...
                    var r1 = J.error ? J.error : J.transaction.error;
                    H(r1);
                  };
                } catch (r1) {
                  H(r1);
        ...
        function Cr(l, f) {
          ...
          var p = new u(function(b, C) {
            c.ready().then(function() {
              e1(c._dbInfo, w, function(H, O) {
                if (H)
                  return C(H);
                try {
                  var N = O.objectStore(c._dbInfo.storeName), T = N.delete(l);
                  O.oncomplete = function() {
                    b();
                  }, O.onerror = function() {
                    C(T.error);
                  }, O.onabort = function() {
                    var Z = T.error ? T.error : T.transaction.error;
                    C(Z);
                  };
                } catch (Z) {
                  C(Z);
        ...
        function vr(l) {
          var f = this, c = new u(function(p, b) {
            f.ready().then(function() {
              e1(f._dbInfo, w, function(C, H) {
                if (C)
                  return b(C);
                try {
                  var O = H.objectStore(f._dbInfo.storeName), N = O.clear();
                  H.oncomplete = function() {
                    p();
                  }, H.onabort = H.onerror = function() {
                    var T = N.error ? N.error : N.transaction.error;
                    b(T);
                  };
                } catch (T) {
                  b(T);
        ...
        function gr(l) {
          var f = this, c = new u(function(p, b) {
            f.ready().then(function() {
              e1(f._dbInfo, A, function(C, H) {
                if (C)
                  return b(C);
                try {
                  var O = H.objectStore(f._dbInfo.storeName), N = O.count();
            ...
            f.ready().then(function() {
              e1(f._dbInfo, A, function(C, H) {
                if (C)
                  return b(C);
                try {
                  var O = H.objectStore(f._dbInfo.storeName), N = O.openKeyCursor(), T = [];
                  N.onsuccess = function() {
                    var Z = N.result;
                    if (!Z) {
                      p(T);
        ...
        function br(l, f) {
          ...
          var c = this.config();
          l = typeof l != "function" && l || {}, l.name || (l.name = l.name || c.name, l.storeName = l.storeName || c.storeName);
          var p = this, b;
          if (!l.name)
            b = u.reject("Invalid arguments");
          else {
            var C = l.name === c.name && p._dbInfo.db, H = C ? u.resolve(p._dbInfo.db) : o1(l).then(function(O) {
            ...
            l.storeName ? b = H.then(function(O) {
              if (O.objectStoreNames.contains(l.storeName)) {
                var N = O.version + 1;
                j(l);
                ...
                return r1.then(function(s1) {
                  ...
                  throw (G(l, s1) || u.resolve()).catch(function() {
                  }), s1;
                });
              }
            }) : b = H.then(function(O) {
        ...
        var A1 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", yr = "~~local_forage_type~", ft = /^~~local_forage_type~([^~]+)~/, we = "__lfsc__:", c3 = we.length, u3 = "arbf", d3 = "blob", ht = "si08", Ct = "ui08", vt = "uic8", gt = "si16", pt = "si32", mt = "ur16", bt = "ui32", Lt = "fl32", wt = "fl64", yt = c3 + u3.length, _t = Object.prototype.toString;
        function Mt(l) {
          var f = l.length * 0.75, c = l.length, p, b = 0, C, H, O, N;
          l[l.length - 1] === "=" && (f--, l[l.length - 2] === "=" && f--);
          var T = new ArrayBuffer(f), Z = new Uint8Array(T);
          for (p = 0; p < c; p += 4)
            C = A1.indexOf(l[p]), H = A1.indexOf(l[p + 1]), O = A1.indexOf(l[p + 2]), N = A1.indexOf(l[p + 3]), Z[b++] = C << 2 | H >> 4, Z[b++] = (H & 15) << 4 | O >> 2, Z[b++] = (O & 3) << 6 | N & 63;
          return T;
        }
        function f3(l) {
          var f = new Uint8Array(l), c = "", p;
          for (p = 0; p < f.length; p += 3)
            c += A1[f[p] >> 2], c += A1[(f[p] & 3) << 4 | f[p + 1] >> 4], c += A1[(f[p + 1] & 15) << 2 | f[p + 2] >> 6], c += A1[f[p + 2] & 63];
          return f.length % 3 === 2 ? c = c.substring(0, c.length - 1) + "=" : f.length % 3 === 1 && (c = c.substring(0, c.length - 2) + "=="), c;
        }
        function _r(l, f) {
          var c = "";
          if (l && (c = _t.call(l)), l && (c === "[object ArrayBuffer]" || l.buffer && _t.call(l.buffer) === "[object ArrayBuffer]")) {
            var p, b = we;
            l instanceof ArrayBuffer ? (p = l, b += u3) : (p = l.buffer, c === "[object Int8Array]" ? b += ht : c === "[object Uint8Array]" ? b += Ct : c === "[object Uint8ClampedArray]" ? b += vt : c === "[object Int16Array]" ? b += gt : c === "[object Uint16Array]" ? b += mt : c === "[object Int32Array]" ? b += pt : c === "[object Uint32Array]" ? b += bt : c === "[object Float32Array]" ? b += Lt : c === "[object Float64Array]" ? b += wt : f(new Error("Failed to get type for BinaryArray"))), f(b + f3(p));
          } else if (c === "[object Blob]") {
            var C = new FileReader();
            C.onload = function() {
              var H = yr + l.type + "~" + f3(this.result);
              f(we + d3 + H);
            ...
            try {
              ...
              console.error("Couldn't convert value into a JSON string: ", l), f(null, H);
            }
        }
        function Mr(l) {
          if (l.substring(0, c3) !== we)
            return JSON.parse(l);
          var f = l.substring(yt), c = l.substring(c3, yt), p;
          if (c === d3 && ft.test(f)) {
            var b = f.match(ft);
            p = b[1], f = f.substring(b[0].length);
          }
          var C = Mt(f);
          switch (c) {
            case u3:
        ...
        function It(l, f, c, p) {
          l.executeSql("CREATE TABLE IF NOT EXISTS " + f.storeName + " (id INTEGER PRIMARY KEY, key unique, value)", [], c, p);
        }
        function Ir(l) {
          var f = this, c = {
            db: null
          ...
          if (l)
            for (var p in l)
              c[p] = typeof l[p] != "string" ? l[p].toString() : l[p];
          var b = new u(function(C, H) {
            try {
          ...
          return c.serializer = h3, b;
        }
        function B1(l, f, c, p, b, C) {
          l.executeSql(c, p, b, function(H, O) {
            O.code === O.SYNTAX_ERR ? H.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?", [f.storeName], function(N, T) {
              T.rows.length ? C(N, O) : It(N, f, function() {
                N.executeSql(c, p, b, C);
              }, C);
            }, C) : C(H, O);
          }, C);
        }
          ...
          var p = new u(function(b, C) {
            c.ready().then(function() {
              ...
              H.db.transaction(function(O) {
                B1(O, H, "SELECT * FROM " + H.storeName + " WHERE key = ? LIMIT 1", [l], function(N, T) {
                  var Z = T.rows.length ? T.rows.item(0).value : null;
                  Z && (Z = H.serializer.deserialize(Z)), b(Z);
                }, function(N, T) {
                  C(T);
                });
              });
        ...
        function Rr(l, f) {
          ...
          var p = new u(function(b, C) {
            c.ready().then(function() {
              var H = c._dbInfo;
              H.db.transaction(function(O) {
                B1(O, H, "DELETE FROM " + H.storeName + " WHERE key = ?", [l], function() {
                  b();
                }, function(N, T) {
                  C(T);
                });
        ...
        function Vr(l) {
          var f = this, c = new u(function(p, b) {
            f.ready().then(function() {
              var C = f._dbInfo;
              C.db.transaction(function(H) {
                B1(H, C, "DELETE FROM " + C.storeName, [], function() {
                  p();
                }, function(O, N) {
                  b(N);
                });
        ...
        function Or(l) {
          var f = this, c = new u(function(p, b) {
            f.ready().then(function() {
              var C = f._dbInfo;
              C.db.transaction(function(H) {
                B1(H, C, "SELECT COUNT(key) as c FROM " + C.storeName, [], function(O, N) {
        ...
        function $r(l, f) {
          var c = this, p = new u(function(b, C) {
            c.ready().then(function() {
              var H = c._dbInfo;
              H.db.transaction(function(O) {
                B1(O, H, "SELECT key FROM " + H.storeName + " WHERE id = ? LIMIT 1", [l + 1], function(N, T) {
                  var Z = T.rows.length ? T.rows.item(0).key : null;
                  b(Z);
                }, function(N, T) {
                  C(T);
                });
        ...
        function Er(l) {
          var f = this, c = new u(function(p, b) {
            f.ready().then(function() {
              var C = f._dbInfo;
              C.db.transaction(function(H) {
                B1(H, C, "SELECT key FROM " + C.storeName, [], function(O, N) {
                  for (var T = [], Z = 0; Z < N.rows.length; Z++)
                    T.push(N.rows.item(Z).key);
                  p(T);
                }, function(O, N) {
                  b(N);
                });
        ...
        function Nr(l) {
          return new u(function(f, c) {
            l.transaction(function(p) {
              p.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name <> '__WebKitDatabaseInfoTable__'", [], function(b, C) {
                for (var H = [], O = 0; O < C.rows.length; O++)
                  H.push(C.rows.item(O).name);
                f({
                  db: l,
                  storeNames: H
                });
        ...
        function Dr(l, f) {
          ...
          l = typeof l != "function" && l || {}, l.name || (l.name = l.name || c.name, l.storeName = l.storeName || c.storeName);
          var p = this, b;
          return l.name ? b = new u(function(C) {
            var H;
            l.name === c.name ? H = p._dbInfo.db : H = openDatabase(l.name, "", "", 0), l.storeName ? C({
              db: H,
          ...
          }) : b = u.reject("Invalid arguments"), m(b, f), b;
        }
        var Tr = {
        ...
        function Ht(l, f) {
          var c = l.name + "/";
          return l.storeName !== f.storeName && (c += l.storeName + "/"), c;
        }
        function Ar() {
        ...
        function Br() {
          return !Ar() || localStorage.length > 0;
        }
        function Pr(l) {
          var f = this, c = {};
          if (l)
            for (var p in l)
              c[p] = l[p];
          return c.keyPrefix = Ht(l, f._defaultConfig), Br() ? (f._dbInfo = c, c.serializer = h3, u.resolve()) : u.reject();
        }
        function Fr(l) {
          var f = this, c = f.ready().then(function() {
            for (var p = f._dbInfo.keyPrefix, b = localStorage.length - 1; b >= 0; b--) {
        ...
        function kr(l, f) {
          var c = this;
          l = y(l);
          var p = c.ready().then(function() {
            var b = c._dbInfo, C = localStorage.getItem(b.keyPrefix + l);
            return C && (C = b.serializer.deserialize(C)), C;
          });
          return m(p, f), p;
        }
        function jr(l, f) {
          var c = this, p = c.ready().then(function() {
        ...
        function Ur(l, f) {
          var c = this, p = c.ready().then(function() {
            var b = c._dbInfo, C;
            try {
              C = localStorage.key(l);
            } catch {
              C = null;
            }
            return C && (C = C.substring(b.keyPrefix.length)), C;
          });
          return m(p, f), p;
        }
        function zr(l) {
          var f = this, c = f.ready().then(function() {
            for (var p = f._dbInfo, b = localStorage.length, C = [], H = 0; H < b; H++) {
              var O = localStorage.key(H);
              O.indexOf(p.keyPrefix) === 0 && C.push(O.substring(p.keyPrefix.length));
            }
            return C;
          });
          return m(c, l), c;
        ...
        function Wr(l) {
          var f = this, c = f.keys().then(function(p) {
            return p.length;
          });
          return m(c, l), c;
        }
        function Yr(l, f) {
          ...
          var p = c.ready().then(function() {
            var b = c._dbInfo;
            localStorage.removeItem(b.keyPrefix + l);
          });
          return m(p, f), p;
        }
        function Gr(l, f, c) {
          ...
          var b = p.ready().then(function() {
            ...
            return new u(function(H, O) {
              var N = p._dbInfo;
              N.serializer.serialize(f, function(T, Z) {
                if (Z)
                  O(Z);
                else
                  try {
        ...
        function Xr(l, f) {
          if (f = $.apply(this, arguments), l = typeof l != "function" && l || {}, !l.name) {
            var c = this.config();
            l.name = l.name || c.name, l.storeName = l.storeName || c.storeName;
          }
          var p = this, b;
          return l.name ? b = new u(function(C) {
            l.storeName ? C(Ht(l, p._defaultConfig)) : C(l.name + "/");
          }).then(function(C) {
        ...
        var qr = {
          ...
          WEBSQL: Tr,
          LOCALSTORAGE: qr
        }, Kr = [K1.INDEXEDDB._driver, K1.WEBSQL._driver, K1.LOCALSTORAGE._driver], ye = ["dropInstance"], C3 = ["clear", "getItem", "iterate", "key", "keys", "length", "removeItem", "setItem"].concat(ye), e2 = {
          description: "",
          driver: Kr.slice(),
          name: "localforage",
        ...
        function v3() {
          for (var l = 1; l < arguments.length; l++) {
            ...
            if (f)
              for (var c in f)
                f.hasOwnProperty(c) && (St(f[c]) ? arguments[0][c] = f[c].slice() : arguments[0][c] = f[c]);
          }
          return arguments[0];
        }
        var n2 = (function() {
          function l(f) {
            s(this, l);
            for (var c in K1)
              if (K1.hasOwnProperty(c)) {
                var p = K1[c], b = p._driver;
                this[c] = b, ce[b] || this.defineDriver(p);
              }
            this._defaultConfig = v3({}, e2), this._config = v3({}, this._defaultConfig, f), this._driverSet = null, this._initDriver = null, this._ready = !1, this._dbInfo = null, this._wrapLibraryMethodsWithReady(), this.setDriver(this._config.driver).catch(function() {
            });
          }
          return l.prototype.config = function(c) {
            if ((typeof c > "u" ? "undefined" : i(c)) === "object") {
              if (this._ready)
                return new Error("Can't call config() after localforage has been used.");
              for (var p in c) {
                if (p === "storeName" && (c[p] = c[p].replace(/\W/g, "_")), p === "version" && typeof c[p] != "number")
          ...
          }, l.prototype.defineDriver = function(c, p, b) {
            var C = new u(function(H, O) {
              try {
                var N = c._driver, T = new Error("Custom driver not compliant; see https://mozilla.github.io/localForage/#definedriver");
                if (!c._driver) {
                  O(T);
                  return;
                }
                for (var Z = C3.concat("_initStorage"), F = 0, J = Z.length; F < J; F++) {
                  var r1 = Z[F], s1 = !Qr(ye, r1);
                ...
                var g1 = function() {
                  for (var ue = function(i2) {
                    return function() {
                      var s2 = new Error("Method " + i2 + " is not implemented by the current driver"), Vt = u.reject(s2);
                      return m(Vt, arguments[arguments.length - 1]), Vt;
                    };
                  }, g3 = 0, o2 = ye.length; g3 < o2; g3++) {
                    var p3 = ye[g3];
                    c[p3] || (c[p3] = ue(p3));
                  }
                };
                ...
                "_support" in c ? c._support && typeof c._support == "function" ? c._support().then(h1, O) : h1(!!c._support) : h1(!0);
              } catch (O1) {
                O(O1);
              }
            });
          ...
          }, l.prototype.getDriver = function(c, p, b) {
            var C = ce[c] ? u.resolve(ce[c]) : u.reject(new Error("Driver not found."));
            return L(C, p, b), C;
          }, l.prototype.getSerializer = function(c) {
            var p = u.resolve(h3);
            return L(p, c), p;
          }, l.prototype.ready = function(c) {
            var p = this, b = p._driverSet.then(function() {
              return p._ready === null && (p._ready = p._initDriver()), p._ready;
            });
            return L(b, c, c), b;
          }, l.prototype.setDriver = function(c, p, b) {
            var C = this;
            St(c) || (c = [c]);
            var H = this._getSupportedDrivers(c);
            function O() {
            ...
            return !!Rt[c];
          }, l.prototype._extend = function(c) {
            v3(this, c);
          }, l.prototype._getSupportedDrivers = function(c) {
            for (var p = [], b = 0, C = c.length; b < C; b++) {
              var H = c[b];
              this.supports(H) && p.push(H);
            }
            return p;
          }, l.prototype._wrapLibraryMethodsWithReady = function() {
            for (var c = 0, p = C3.length; c < p; c++)
              t2(this, C3[c]);
          }, l.prototype.createInstance = function(c) {
            return new l(c);
          }, l;
        })(), r2 = new n2();
        r.exports = r2;
...
var ai = li();
const z1 = /* @__PURE__ */ si(ai);
class dr {
  getItem(t) {
    return z1.getItem(t);
  }
  setItem(t, n) {
    return z1.setItem(t, n);
  }
  removeItem(t) {
    return z1.removeItem(t);
  }
  clear() {
    return z1.clear();
  }
...
var ci = Object.getOwnPropertyDescriptor, ui = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? ci(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, s9 = (e, t) => (n, r) => t(n, r, e);
let Je = class extends p1 {
  ...
  _initUIPart() {
    this.disposeWithMe(
      this._uiPartsService.registerComponent(u1.GLOBAL, () => $1(q2, this._injector))
    );
  }
  dispose() {
    _e();
  ...
  show(e) {
    let t = e;
    return typeof e.id > "u" && (t = Object.assign({}, e, { id: `message-${Date.now()}` })), J2(t), f1(() => _e(t.id));
  }
  remove(e) {
    _e(e);
  }
...
function di() {
  ...
  return /* @__PURE__ */ h(K2, { theme: t ? "dark" : "light" });
}
const fi = {
  show: (e) => {
    const {
...
var hi = Object.getOwnPropertyDescriptor, Ci = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? hi(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, l9 = (e, t) => (n, r) => t(n, r, e);
let Qe = class extends p1 {
  ...
  _initUIPart() {
    this.disposeWithMe(
      this._uiPartsService.registerComponent(u1.GLOBAL, () => $1(di, this._injector))
    );
  }
};
Qe = Ci([
...
class fr {
  ...
  open(t) {
    return this._sidebarOptions = {
      ...
      id: t.id,
      visible: !0
    }, this.sidebarOptions$.next(this._sidebarOptions), f1(() => {
      this.close();
    });
  }
  close(t) {
...
var vi = Object.getOwnPropertyDescriptor, gi = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? vi(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, pi = (e, t) => (n, r) => t(n, r, e);
let Ke = class {
  ...
  set(e, t) {
    return this._componentManager.register(e, t), this.componentKey$.next(e), f1(() => {
      this._componentManager.delete(e), this.visible$.complete(), this.componentKey$.complete();
    });
  }
  open() {
...
var mi = Object.defineProperty, bi = Object.getOwnPropertyDescriptor, Li = (e, t, n) => t in e ? mi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, wi = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? bi(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, H3 = (e, t) => (n, r) => t(n, r, e), yi = (e, t, n) => Li(e, t + "", n);
const _i = "UNIVER_MOBILE_UI_PLUGIN", Mi = "DISABLE_AUTO_FOCUS";
let P3 = class extends p9 {
  constructor(e = Be, t, n, r) {
    super(), this._config = e, this._contextService = t, this._injector = n, this._configService = r;
    const { menu: o, ...i } = De(
      {
        popupRootId: `univer-popup-portal-${Ce(6)}`
      },
      Be,
      this._config
    );
    i.disableAutoFocus && this._contextService.setContextValue(Mi, !0), o && this._configService.setConfig("menu", o, { merge: !0 }), this._configService.setConfig(ae, i);
  }
  onStarting() {
    m9(this._injector, b9([
      ...
      [oe],
      [se]
    ], this._config.override)), ne(this._injector, [
      [Ue],
      [oe]
    ]);
  }
...
var Ii = Object.defineProperty, xi = Object.getOwnPropertyDescriptor, Hi = (e, t, n) => t in e ? Ii(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, Si = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? xi(t, n) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = s(o) || o);
  return o;
}, S3 = (e, t) => (n, r) => t(n, r, e), Ri = (e, t, n) => Hi(e, t + "", n);
const Vi = "UNIVER_UI_PLUGIN", Oi = "DISABLE_AUTO_FOCUS";
let F3 = class extends p9 {
  constructor(e = Be, t, n, r) {
    super(), this._config = e, this._contextService = t, this._injector = n, this._configService = r;
    const { menu: o, ...i } = De(
      {
    ...
    i.disableAutoFocus && this._contextService.setContextValue(Oi, !0), o && this._configService.setConfig("menu", o, { merge: !0 }), this._configService.setConfig(ae, i);
  }
  onStarting() {
    m9(this._injector, b9([
      [S1],
...
function hr(e) {
  ...
  const n = [];
  let r = 0, o = 0, i = e.textContent || "";
  i += `\r
`;
  for (let d = 0; d < t.length; d++) {
    let v = t[`${d}`], g;
    v.nodeName === "#text" ? (g = (a = v.textContent) != null ? a : "", v = v.parentElement) : g = v.innerText;
    const u = dt(v);
    Ei(g).forEach((L) => {
      const y = L.length;
      o += y, r = o - y;
...
function dt(e, t = "") {
  ...
  return r.forEach((d) => {
    var m;
    const v = d.toLowerCase(), g = R3(v.substr(0, v.indexOf(":"))), u = R3(v.substr(v.indexOf(":") + 1));
    if (g === "font-weight")
      u === "bold" || u === "700" ? o.bl = 1 : o.bl = 0;
    else if (g === "font-style")
      u === "italic" ? o.it = 1 : o.it = 0;
    else if (g === "font-family") {
      const L = R3(d), y = Ti(L);
      o.ff = y;
    } else if (g === "font-size") {
      let L = Number.parseInt(u);
      n.indexOf("vertical-align") > -1 && (n.indexOf("sub") > -1 || n.indexOf("sup") > -1) && (L *= 2), u.indexOf("px") !== -1 && (L = Di(Number.parseInt(u, 10))), o.fs = L;
    } else if (g === "color") {
      const L = new V3(u);
      o.cl = {
      ...
      u === "underline" ? (o.ul || (o.ul = { s: 1 }), o.ul.s = 1) : u === "line-through" ? (o.st || (o.st = { s: 1 }), o.st.s = 1) : u === "overline" && (o.ol || (o.ol = { s: 1 }), o.ol.s = 1);
    else if (g === "text-decoration-color")
      o.hasOwnProperty("ul") && (o.ul || (o.ul = { s: 1, cl: { rgb: u } }), o.ul.cl = {
        rgb: u
      }), o.hasOwnProperty("st") && (o.st || (o.st = { s: 1, cl: { rgb: u } }), o.st.cl = {
        rgb: u
      }), o.hasOwnProperty("ol") && (o.ol || (o.ol = { s: 1, cl: { rgb: u } }), o.ol.cl = {
        rgb: u
      });
    else if (g === "text-decoration-style")
      o.hasOwnProperty("ul") && (o.ul || (o.ul = { s: 1, t: Number(u) }), o.ul.t = Number(u)), o.hasOwnProperty("st") && (o.st || (o.st = { s: 1, t: Number(u) }), o.st.t = Number(u)), o.hasOwnProperty("ol") && (o.ol || (o.ol = { s: 1, t: Number(u) }), o.ol.t = Number(u));
    else if (g === "text-decoration" || g === "univer-strike") {
      const L = (m = u.split(" ")) == null ? void 0 : m[0];
    ...
    if (g === "univer-underline" && (o.ul = {
      s: 1
    }), g === "vertical-align" && (u === "sub" ? o.va = w3.SUBSCRIPT : u === "super" ? o.va = w3.SUPERSCRIPT : u === "top" ? o.vt = 1 : u === "middle" ? o.vt = 2 : u === "bottom" ? o.vt = 3 : o.va = w3.NORMAL), g === "transform") {
      const L = u.split(")"), y = L.findIndex(($) => $.includes("rotate"));
      if (y > -1) {
        const $ = L[y].match(/\d+/g);
        let R = 0, _ = 0;
        $ != null && $.length && (R = +$[0]), e != null && e.dataset.vertical && (_ = +e.dataset.vertical), o.tr = {
          a: R,
          v: _
        };
      }
    }
    if (g === "text-align" && (u === "left" ? o.ht = 1 : u === "center" ? o.ht = 2 : u === "right" ? o.ht = 3 : u === "justify" ? o.ht = 4 : o.ht = 0), o.tb !== 1 && (g === "overflow-wrap" || g === "word-wrap" ? u === "break-word" && (o.tb = 3) : g === "text-overflow" ? u === "clip" && (o.tb = 2) : g === "text-break" && u === "overflow" && (o.tb = 1)), g === "white-space" && (u === "nowrap" ? o.tb = 1 : u === "normal" ? o.tb = 3 : u === "clip" && (o.tb = 2)), g === "border-color") {
      const L = u9(u, ")");
      if (o.bd)
        for (const y in L)
          o.bd[y].cl.rgb = L[y];
    ...
    if (g === "border-bottom" || g === "border-top" || g === "border-left" || g === "border-right" || g === "border") {
      ...
      const L = /[+-]?\d+/, y = u.match(L);
      u === "(0deg ,1)" ? o.tr = { a: 0, v: 1 } : y && (o.tr = { a: Number(y[0]) });
    }
...
function u9(e, t) {
  let n;
  t === " " ? n = e.trim().split(t) : n = e.trim().split(t).slice(0, -1), n.forEach((o) => `${o.trim()})`);
  let r = {};
  return n.length === 1 ? r = {
    t: n[0],
    r: n[0],
...
function h7(e) {
  ...
  for (let o = 0; o < r.length; o++) {
    const i = r[o], s = i.getAttribute("span");
    if (s && +s > 1)
      for (let a = 0; a < +s; a++) {
        const d = e3(i.getAttribute("width"), 72);
        n.push(d);
      }
    else {
      const a = e3(i.getAttribute("width"), 72);
      n.push(a);
    }
  }
  return n;
...
function e3(e, t) {
  if (!e) return t;
  let n;
  return e.includes("pt") ? n = e4(Number.parseFloat(e)) : e.includes("px") ? n = Number.parseFloat(e) : n = Number.parseFloat(e) * 72 / 96, n;
}
function C7(e) {
  const t = document.createElement("DIV"), n = [];
  t.innerHTML = e;
  ...
  if (!r.length) return [];
  for (let o = 0; o < r.length; o++) {
    const s = r[o].querySelectorAll("td");
    let a = e3(s[0].style.height, 19);
    for (let d = 0; d < s.length; d++) {
      const v = s[d].getAttribute("rowSpan");
      if (!(v && +v > 1)) {
        a = e3(s[d].style.height, 19);
        break;
      }
    }
    n.push(a);
...
function v7(e) {
  ...
  o[0].querySelectorAll("td").forEach((a) => {
    let d = 0;
    const v = a.getAttribute("colSpan");
    v !== null ? d = +v : d = 1, r += d;
  });
  ...
  return o.forEach((a) => {
    let d = 0;
    a.querySelectorAll("td").forEach((v) => {
      var L, y;
      const g = {};
      if (v.querySelectorAll("span").length || v.querySelectorAll("font").length) {
        const $ = hr(v);
        typeof $ != "string" && (g.p = $);
      }
      const u = v.innerText;
      u.trim().length === 0 ? g.v = "" : g.v = u;
      const m = dt(v);
      for (w9.isPlainObject(m) && (g.s = m); d < r && t[s][d] != null; )
        d++;
      if (d !== r) {
        if (t[s][d] == null) {
          t[s][d] = g;
          const $ = (L = Number(v.getAttribute("rowSpan"))) != null ? L : 1, R = (y = Number(v.getAttribute("colSpan"))) != null ? y : 1;
          if ($ > 1 || R > 1) {
            const _ = { rs: +$ - 1, cs: +R - 1, r: s, c: d };
            t[s][d].mc = _;
            for (let D = 0; D < $; D++)
              for (let V = 0; V < R; V++)
                D === 0 && V === 0 || (t[s + D][d + V] = { mc: null });
          }
        }
        d++;
      }
...
`), i = o[0].split("	").length;
  for (let s = 0; s < o.length; s++)
    o[s].split("	").length < i || t.push(o[s].split("	"));
  for (let s = 0; s < t.length; s++)
    for (let a = 0; a < t[s].length; a++)
      t[s][a].length ? t[s][a] = {
        v: t[s][a] || "",
        m: t[s][a] || ""
      } : t[s][a] = null;
...
function p7(e, t) {
  ...
  for (let i = 0; i < e.length; i++)
    for (let s = 0; s < e[i].length; s++)
      if (e[i][s] && typeof e[i][s] == "object" && "mc" in e[i][s])
        if (e[i][s].mc) {
          const a = e[i][s].mc, d = a.r + n, v = d + a.rs, g = a.c + r, u = g + a.cs;
          o.push({ startRow: d, endRow: v, startColumn: g, endColumn: u }), delete e[i][s].mc;
        } else
          e[i][s] = null;
  return {
    data: e,
...
function m7(e) {
  ...
  n.innerHTML = e;
  const r = (v = n.querySelector("style")) == null ? void 0 : v.innerText;
  if (!r) return;
  const o = Ni(r);
  if (t = new Array(n.querySelectorAll("table tr").length), !t.length) return [];
  let i = 0;
  const s = n.querySelectorAll("table tr");
  s[0].querySelectorAll("td").forEach((g) => {
    let u = 0;
    const m = g.getAttribute("colSpan");
    m !== null ? u = +m : u = 1, i += u;
  });
  ...
  return s.forEach((g) => {
    let u = 0;
    g.querySelectorAll("td").forEach((m) => {
      var _, D;
      const L = {};
      if (m.querySelectorAll("span").length || m.querySelectorAll("font").length) {
        const V = hr(m);
        typeof V != "string" && (L.p = V);
      }
      const y = m.innerText;
      y.trim().length === 0 ? L.v = "" : L.v = y;
      let $ = "";
      for (const V in o)
        m.classList.contains(V) && ($ += o[V]);
      const R = dt(m, $);
      for (w9.isPlainObject(R) && (L.s = R); u < i && t[d][u] != null; )
        u++;
      if (u !== i) {
        if (t[d][u] == null) {
          t[d][u] = L;
          const V = (_ = Number(m.getAttribute("rowSpan"))) != null ? _ : 1, A = (D = Number(m.getAttribute("colSpan"))) != null ? D : 1;
          if (V > 1 || A > 1) {
            const w = { rs: +V - 1, cs: +A - 1, r: d, c: u };
            t[d][u].mc = w;
            for (let E = 0; E < V; E++)
              for (let S = 0; S < A; S++)
                E === 0 && S === 0 || (t[d + E][u + S] = { mc: null });
          }
        }
        u++;
      }
...
`, "").split("}");
  for (let o = 0; o < r.length; o++) {
    if (!r[o]) continue;
    let i = r[o].split("{")[0].trim();
    i.includes(".") && (i = i.slice(1));
    const s = r[o].split("{")[1].trim();
    t[i] = s;
  }
  return t;
}
...
const b7 = M9((e) => {
  ...
  a.current = `rotate(${r.rotate}deg)`, d.current = r.startY, v.current = r.startX;
  const L = o.getUnit(t.unitId), y = Q(() => g ? /* @__PURE__ */ h(
    g,
    {
      ...u,
      unitId: t.unitId,
  ...
  return r ? /* @__PURE__ */ h(
    "div",
    {
      ...
      onPointerMove: (_) => {
        t.onPointerMove(_.nativeEvent);
      },
      onPointerDown: (_) => {
        t.onPointerDown(_.nativeEvent);
      },
      onPointerUp: (_) => {
        t.onPointerUp(_.nativeEvent);
      },
      onWheel: (_) => {
        t.onWheel(_.nativeEvent);
      },
      children: /* @__PURE__ */ h(
        "div",
        {
...
export {
  ...
  p5 as CommonLabel,
  x1 as ComponentContainer,
  S1 as ComponentManager,
  Lo as ContextMenu,
  c1 as ContextMenuGroup,
  ...
  ze as DesktopBeforeCloseService,
  Ye as DesktopConfirmService,
  Ge as DesktopDialogService,
  Xe as DesktopGalleryService,
  qe as DesktopGlobalZoneService,
  Pe as DesktopLayoutService,
  cr as DesktopLocalFileService,
  dr as DesktopLocalStorageService,
  F5 as DesktopMenu,
  Je as DesktopMessageService,
  Qe as DesktopNotificationService,
  fr as DesktopSidebarService,
  A3 as DesktopUIController,
  Ke as DesktopZenZoneService,
  ...
  ar as IClipboardInterfaceService,
  ...
  $e as RibbonInsertGroup,
  Bn as RibbonOthersGroup,
  _1 as RibbonPosition,
  Y1 as RibbonStartGroup,
  Ee as RibbonViewGroup,
  ...
  s7 as UNI_DISABLE_CHANGING_FOCUS_KEY,
  ro as UndoShortcutItem,
  P3 as UniverMobileUIPlugin,
