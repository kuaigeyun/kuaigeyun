...
//#region ts/shape-left-right-ribbon-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const ShapeLeftRightRibbonIcon = (0, react.forwardRef)(function ShapeLeftRightRibbonIcon$1(props, ref) {
	return (0, react.createElement)(ts_base.IconBase, Object.assign({}, props, {
		id: "shape-left-right-ribbon-icon",
		ref,
		icon: element
	}));
});
ShapeLeftRightRibbonIcon.displayName = "ShapeLeftRightRibbonIcon";
var shape_left_right_ribbon_icon_default = ShapeLeftRightRibbonIcon;

//#endregion
exports.ShapeLeftRightRibbonIcon = ShapeLeftRightRibbonIcon;
exports.default = shape_left_right_ribbon_icon_default;