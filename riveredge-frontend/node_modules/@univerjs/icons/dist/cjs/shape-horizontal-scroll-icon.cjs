...
//#region ts/shape-horizontal-scroll-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const ShapeHorizontalScrollIcon = (0, react.forwardRef)(function ShapeHorizontalScrollIcon$1(props, ref) {
	return (0, react.createElement)(ts_base.IconBase, Object.assign({}, props, {
		id: "shape-horizontal-scroll-icon",
		ref,
		icon: element
	}));
});
ShapeHorizontalScrollIcon.displayName = "ShapeHorizontalScrollIcon";
var shape_horizontal_scroll_icon_default = ShapeHorizontalScrollIcon;

//#endregion
exports.ShapeHorizontalScrollIcon = ShapeHorizontalScrollIcon;
exports.default = shape_horizontal_scroll_icon_default;