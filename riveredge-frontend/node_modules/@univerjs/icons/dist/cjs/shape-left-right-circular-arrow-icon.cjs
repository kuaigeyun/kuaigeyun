...
//#region ts/shape-left-right-circular-arrow-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const ShapeLeftRightCircularArrowIcon = (0, react.forwardRef)(function ShapeLeftRightCircularArrowIcon$1(props, ref) {
	return (0, react.createElement)(ts_base.IconBase, Object.assign({}, props, {
		id: "shape-left-right-circular-arrow-icon",
		ref,
		icon: element
	}));
});
ShapeLeftRightCircularArrowIcon.displayName = "ShapeLeftRightCircularArrowIcon";
var shape_left_right_circular_arrow_icon_default = ShapeLeftRightCircularArrowIcon;

//#endregion
exports.ShapeLeftRightCircularArrowIcon = ShapeLeftRightCircularArrowIcon;
exports.default = shape_left_right_circular_arrow_icon_default;