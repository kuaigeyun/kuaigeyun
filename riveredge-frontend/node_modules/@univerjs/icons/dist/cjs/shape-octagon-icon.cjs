...
//#region ts/shape-octagon-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const ShapeOctagonIcon = (0, react.forwardRef)(function ShapeOctagonIcon$1(props, ref) {
	return (0, react.createElement)(ts_base.IconBase, Object.assign({}, props, {
		id: "shape-octagon-icon",
		ref,
		icon: element
	}));
});
ShapeOctagonIcon.displayName = "ShapeOctagonIcon";
var shape_octagon_icon_default = ShapeOctagonIcon;

//#endregion
exports.ShapeOctagonIcon = ShapeOctagonIcon;
exports.default = shape_octagon_icon_default;