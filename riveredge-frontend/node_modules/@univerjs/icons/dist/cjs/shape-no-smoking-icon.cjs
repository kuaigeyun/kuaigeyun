...
//#region ts/shape-no-smoking-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const ShapeNoSmokingIcon = (0, react.forwardRef)(function ShapeNoSmokingIcon$1(props, ref) {
	return (0, react.createElement)(ts_base.IconBase, Object.assign({}, props, {
		id: "shape-no-smoking-icon",
		ref,
		icon: element
	}));
});
ShapeNoSmokingIcon.displayName = "ShapeNoSmokingIcon";
var shape_no_smoking_icon_default = ShapeNoSmokingIcon;

//#endregion
exports.ShapeNoSmokingIcon = ShapeNoSmokingIcon;
exports.default = shape_no_smoking_icon_default;