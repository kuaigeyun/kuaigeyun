...
function dehydrateQuery(query, serializeData, shouldRedactErrors) {
  const dehydratePromise = () => {
    var _a12;
    const promise = (_a12 = query.promise) == null ? void 0 : _a12.then(serializeData).catch((error) => {
...
function dehydrate(client, options = {}) {
  ...
  const filterMutation = (_c = (_b2 = options.shouldDehydrateMutation) != null ? _b2 : (_a12 = client.getDefaultOptions().dehydrate) == null ? void 0 : _a12.shouldDehydrateMutation) != null ? _c : defaultShouldDehydrateMutation;
...
function hydrate(client, dehydratedState, options) {
  ...
  const deserializeData = (_d = (_c = (_a12 = options == null ? void 0 : options.defaultOptions) == null ? void 0 : _a12.deserializeData) != null ? _c : (_b2 = client.getDefaultOptions().hydrate) == null ? void 0 : _b2.deserializeData) != null ? _d : defaultTransformerFn;
  const mutations = dehydratedState.mutations || [];
  const queries = dehydratedState.queries || [];
  mutations.forEach((_e) => {
    var _f = _e, { state } = _f, mutationOptions2 = __objRest(_f, ["state"]);
    var _a13, _b3;
    mutationCache.build(
      client,
      __spreadValues(__spreadValues(__spreadValues({}, (_a13 = client.getDefaultOptions().hydrate) == null ? void 0 : _a13.mutations), (_b3 = options == null ? void 0 : options.defaultOptions) == null ? void 0 : _b3.mutations), mutationOptions2),
      state
    );
  });
  queries.forEach(
    ({ queryKey, state, queryHash, meta, promise, dehydratedAt }) => {
      ...
      if (query) {
        ...
        if (state.dataUpdatedAt > query.state.dataUpdatedAt || hasNewerSyncData) {
          const _a13 = state, { fetchStatus: _ignored } = _a13, serializedState = __objRest(_a13, ["fetchStatus"]);
        ...
        query = queryCache.build(
          client,
          __spreadProps(__spreadValues(__spreadValues({}, (_b3 = client.getDefaultOptions().hydrate) == null ? void 0 : _b3.queries), (_c2 = options == null ? void 0 : options.defaultOptions) == null ? void 0 : _c2.queries), {
            queryKey,
            queryHash,
            meta
          }),
...
function infiniteQueryBehavior(pages) {
  return {
    onFetch: (context, query) => {
      var _a12, _b2, _c, _d, _e;
      const options = context.options;
      const direction = (_c = (_b2 = (_a12 = context.fetchOptions) == null ? void 0 : _a12.meta) == null ? void 0 : _b2.fetchMore) == null ? void 0 : _c.direction;
      ...
      if (context.options.persister) {
        context.fetchFn = () => {
          var _a13, _b3;
          return (_b3 = (_a13 = context.options).persister) == null ? void 0 : _b3.call(
            _a13,
            fetchFn,
            {
              client: context.client,
...
var InfiniteQueryObserver = class extends QueryObserver {
  ...
  createResult(query, options) {
    ...
    const fetchDirection = (_b2 = (_a12 = state.fetchMeta) == null ? void 0 : _a12.fetchMore) == null ? void 0 : _b2.direction;
...
var _client3, _observers, _mutationCache, _retryer2, _Mutation_instances, dispatch_fn2, _a6;
var Mutation = (_a6 = class extends Removable {
  ...
  continue() {
    var _a12, _b2;
    return (_b2 = (_a12 = __privateGet(this, _retryer2)) == null ? void 0 : _a12.continue()) != null ? _b2 : (
  ...
  execute(variables) {
    return __async(this, null, function* () {
      var _a12, _b2, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s;
      const onContinue = () => {
      ...
      try {
        if (restored) {
          ...
          if (__privateGet(this, _mutationCache).config.onMutate) {
            yield __privateGet(this, _mutationCache).config.onMutate(
              variables,
              this,
              mutationFnContext
            );
          }
          const context = yield (_c = (_b2 = this.options).onMutate) == null ? void 0 : _c.call(
            _b2,
            variables,
            mutationFnContext
          );
        ...
        yield (_e = (_d = __privateGet(this, _mutationCache).config).onSuccess) == null ? void 0 : _e.call(
          _d,
          data,
          variables,
          this.state.context,
        ...
        yield (_g = (_f = this.options).onSuccess) == null ? void 0 : _g.call(
          _f,
          data,
          variables,
          this.state.context,
        ...
        yield (_i = (_h = __privateGet(this, _mutationCache).config).onSettled) == null ? void 0 : _i.call(
          _h,
          data,
          null,
        ...
        yield (_k = (_j = this.options).onSettled) == null ? void 0 : _k.call(
          _j,
          data,
          null,
          variables,
        ...
        try {
          yield (_m = (_l = __privateGet(this, _mutationCache).config).onError) == null ? void 0 : _m.call(
            _l,
            error,
            variables,
            this.state.context,
        ...
        try {
          yield (_o = (_n = this.options).onError) == null ? void 0 : _o.call(
            _n,
            error,
            variables,
            this.state.context,
        ...
        try {
          yield (_q = (_p = __privateGet(this, _mutationCache).config).onSettled) == null ? void 0 : _q.call(
            _p,
            void 0,
            error,
            this.state.variables,
        ...
        try {
          yield (_s = (_r = this.options).onSettled) == null ? void 0 : _s.call(
            _r,
            void 0,
            error,
            variables,
...
var _client4, _currentResult2, _currentMutation, _mutateOptions, _MutationObserver_instances, updateResult_fn, notify_fn2, _a8;
var MutationObserver = (_a8 = class extends Subscribable {
  constructor(client, options) {
    super();
  ...
  var _a12, _b2;
  const state = (_b2 = (_a12 = __privateGet(this, _currentMutation)) == null ? void 0 : _a12.state) != null ? _b2 : getDefaultState2();
  ...
  notifyManager.batch(() => {
    ...
    if (__privateGet(this, _mutateOptions) && this.hasListeners()) {
      ...
      if ((action == null ? void 0 : action.type) === "success") {
        try {
          (_b2 = (_a12 = __privateGet(this, _mutateOptions)).onSuccess) == null ? void 0 : _b2.call(
            _a12,
            action.data,
            variables,
            onMutateResult,
...
var _client5, _result, _queries, _options, _observers2, _combinedResult, _lastCombine, _lastResult, _lastQueryHashes, _observerMatches, _QueriesObserver_instances, trackResult_fn, combineResult_fn, findMatchingObservers_fn, onUpdate_fn, notify_fn3, _a9;
var QueriesObserver = (_a9 = class extends Subscribable {
  ...
  getOptimisticResult(queries, combine) {
    ...
    return [
      result,
      (r) => {
        return __privateMethod(this, _QueriesObserver_instances, combineResult_fn).call(this, r != null ? r : result, combine, queryHashes);
      },
      () => {
  ...
  queries.forEach((options) => {
    ...
    const match = (_a12 = prevObserversMap.get(defaultedOptions.queryHash)) == null ? void 0 : _a12.shift();
    const observer = match != null ? match : new QueryObserver(__privateGet(this, _client5), defaultedOptions);
    observers.push({
...
var QueryClient = (_a11 = class {
    ...
    return notifyManager.batch(() => {
      ...
      return this.refetchQueries(
        __spreadProps(__spreadValues({}, filters), {
          type: (_b2 = (_a12 = filters == null ? void 0 : filters.refetchType) != null ? _a12 : filters == null ? void 0 : filters.type) != null ? _b2 : "active"
        }),
        options
      );
    });
  ...
  refetchQueries(filters, options = {}) {
    ...
    const fetchOptions = __spreadProps(__spreadValues({}, options), {
      cancelRefetch: (_a12 = options.cancelRefetch) != null ? _a12 : true
    });
    const promises = notifyManager.batch(
...
function streamedQuery({
  ...
  return (context) => __async(this, null, function* () {
    ...
    const stream = yield streamFn(streamFnContext);
    ...
    return (_a12 = context.client.getQueryData(context.queryKey)) != null ? _a12 : initialValue;
  });
}
...
// node_modules/@tanstack/react-query/build/modern/useQueries.js
function useQueries(_a12, queryClient) {
  var _b2 = _a12, {
    queries
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  (_b2 = (_a12 = client.getDefaultOptions().queries) == null ? void 0 : _a12._experimental_beforeQuery) == null ? void 0 : _b2.call(
    _a12,
    defaultedOptions
  );
...
function useIsMutating(filters, queryClient) {
  ...
  return useMutationState(
    { filters: __spreadProps(__spreadValues({}, filters), { status: "pending" }) },
    client
  ).length;
}
