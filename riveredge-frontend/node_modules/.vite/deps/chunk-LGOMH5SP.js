...
function Panel(_a) {
  var _b = _a, { position, children: children2, className, style: style2 } = _b, rest = __objRest(_b, ["position", "children", "className", "style"]);
  const pointerEvents = useStore(selector$g);
  const positionClasses = `${position}`.split("-");
  return import_react2.default.createElement("div", __spreadValues({ className: cc(["react-flow__panel", className, ...positionClasses]), style: __spreadProps(__spreadValues({}, style2), { pointerEvents }) }, rest), children2);
}
...
var EdgeText = (_a) => {
  var _b = _a, { x, y, label, labelStyle = {}, labelShowBg = true, labelBgStyle = {}, labelBgPadding = [2, 4], labelBgBorderRadius = 2, children: children2, className } = _b, rest = __objRest(_b, ["x", "y", "label", "labelStyle", "labelShowBg", "labelBgStyle", "labelBgPadding", "labelBgBorderRadius", "children", "className"]);
  ...
  return import_react2.default.createElement(
    "g",
    __spreadValues({ transform: `translate(${x - edgeTextBbox.width / 2} ${y - edgeTextBbox.height / 2})`, className: edgeTextClasses, visibility: edgeTextBbox.width ? "visible" : "hidden" }, rest),
...
var nodeToRect = (node) => __spreadProps(__spreadValues({}, node.positionAbsolute || { x: 0, y: 0 }), {
  width: node.width || 0,
...
var StepEdge = (0, import_react2.memo)((props) => {
  var _a;
  return import_react2.default.createElement(SmoothStepEdge, __spreadProps(__spreadValues({}, props), { pathOptions: (0, import_react2.useMemo)(() => {
    var _a2;
...
function getClosestHandle(event, doc, pos, connectionRadius, handles, validator) {
  ...
  handles.forEach((handle) => {
    const distance2 = Math.sqrt(__pow(handle.x - pos.x, 2) + __pow(handle.y - pos.y, 2));
...
var Handle = (0, import_react2.forwardRef)((_a, ref) => {
  var _b = _a, { type = "source", position = Position.Top, isValidConnection, isConnectable = true, isConnectableStart = true, isConnectableEnd = true, id: id2, onConnect, children: children2, className, onMouseDown, onTouchStart } = _b, rest = __objRest(_b, ["type", "position", "isValidConnection", "isConnectable", "isConnectableStart", "isConnectableEnd", "id", "onConnect", "children", "className", "onMouseDown", "onTouchStart"]);
  var _a2, _b2;
  ...
  if (!nodeId) {
    (_b2 = (_a2 = store.getState()).onError) == null ? void 0 : _b2.call(_a2, "010", errorMessages["error010"]());
  }
  ...
  return import_react2.default.createElement("div", __spreadValues({ "data-handleid": handleId, "data-nodeid": nodeId, "data-handlepos": position, "data-id": `${nodeId}-${handleId}-${type}`, className: cc([
    "react-flow__handle",
...
var StoreUpdater = ({ nodes, edges, defaultNodes, defaultEdges, onConnect, onConnectStart, onConnectEnd, onClickConnectStart, onClickConnectEnd, nodesDraggable, nodesConnectable, nodesFocusable, edgesFocusable, edgesUpdatable, elevateNodesOnSelect, minZoom, maxZoom, nodeExtent, onNodesChange, onEdgesChange, elementsSelectable, connectionMode, snapGrid, snapToGrid, translateExtent, connectOnClick, defaultEdgeOptions, fitView: fitView2, fitViewOptions, onNodesDelete, onEdgesDelete, onNodeDrag, onNodeDragStart, onNodeDragStop, onSelectionDrag, onSelectionDragStart, onSelectionDragStop, noPanClassName, nodeOrigin, rfId, autoPanOnConnect, autoPanOnNodeDrag, onError, connectionRadius, isValidConnection, nodeDragThreshold }) => {
  ...
  const store = useStoreApi();
  (0, import_react2.useEffect)(() => {
    const edgesWithDefaults = defaultEdges == null ? void 0 : defaultEdges.map((e) => __spreadValues(__spreadValues({}, e), defaultEdgeOptions));
...
function updateAbsoluteNodePositions(nodeInternals, nodeOrigin, parentNodes) {
  nodeInternals.forEach((node) => {
    ...
    if (parentId || (parentNodes == null ? void 0 : parentNodes[node.id])) {
      const { x, y, z } = calculateXYZPosition(node, nodeInternals, __spreadProps(__spreadValues({}, node.position), {
    ...
    [edge.markerStart, edge.markerEnd].forEach((marker) => {
      if (marker && typeof marker === "object") {
        ...
        if (!ids.includes(markerId)) {
          markers.push(__spreadValues({ id: markerId, color: marker.color || defaultColor2 }, marker));
          ids.push(markerId);
        }
      }
    });
...
var createRFStore = () => createWithEqualityFn((set2, get2) => __spreadProps(__spreadValues({}, initialState), {
  setNodes: (nodes) => {
  ...
  setEdges: (edges) => {
    ...
    set2({ edges: edges.map((e) => __spreadValues(__spreadValues({}, defaultEdgeOptions), e)) });
  },
  ...
  updateNodeDimensions: (updates) => {
    ...
    const nextFitViewOnInitDone = fitViewOnInitDone || fitViewOnInit && !fitViewOnInitDone && fitView(get2, __spreadValues({ initial: true }, fitViewOnInitOptions));
  ...
  reset: () => set2(__spreadValues({}, initialState))
}), Object.is);
...
var ControlButton = (_a) => {
  var _b = _a, { children: children2, className } = _b, rest = __objRest(_b, ["children", "className"]);
  return import_react4.default.createElement("button", __spreadValues({ type: "button", className: cc(["react-flow__controls-button", className]) }, rest), children2);
};
...
function Background({
  ...
  return import_react5.default.createElement(
    "svg",
    { className: cc(["react-flow__background", className]), style: __spreadProps(__spreadValues({}, style2), {
      position: "absolute",
      width: "100%",
      height: "100%",
      top: 0,
...
function NodeToolbar(_a) {
  var _b = _a, { nodeId, children: children2, className, style: style2, isVisible, position = Position.Top, offset = 10, align = "center" } = _b, rest = __objRest(_b, ["nodeId", "children", "className", "style", "isVisible", "position", "offset", "align"]);
  ...
  const zIndex = Math.max(...nodes.map((node) => {
    var _a2;
    return (((_a2 = node[internalsSymbol]) == null ? void 0 : _a2.z) || 1) + 1;
  }));
  ...
  return import_react6.default.createElement(
    NodeToolbarPortal,
    null,
    import_react6.default.createElement("div", __spreadValues({ style: wrapperStyle2, className: cc(["react-flow__node-toolbar", className]) }, rest), children2)
  );
}
...
function ResizeControl({ nodeId, position, variant = ResizeControlVariant.Handle, className, style: style2 = {}, children: children2, color: color2, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, shouldResize, onResizeStart, onResize, onResizeEnd }) {
  ...
  (0, import_react7.useEffect)(() => {
    ...
    const dragHandler = drag_default().on("start", (event) => {
      ...
      onResizeStart == null ? void 0 : onResizeStart(event, __spreadValues({}, prevValues.current));
    }).on("drag", (event) => {
      ...
      if (node) {
        ...
        const nextValues = __spreadProps(__spreadValues({}, prevValues.current), { direction });
      ...
      onResizeEnd == null ? void 0 : onResizeEnd(event, __spreadValues({}, prevValues.current));
  ...
  const controlStyle = color2 ? __spreadProps(__spreadValues({}, style2), { [colorStyleProp]: color2 }) : style2;
...
//# sourceMappingURL=chunk-LGOMH5SP.js.map
