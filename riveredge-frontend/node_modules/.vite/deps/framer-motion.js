...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime.jsx)(MeasureLayoutWithContext, __spreadProps(__spreadValues({}, props), { layoutGroup, switchLayoutGroup: (0, import_react5.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove }));
}
...
var createMotionComponent = createMotionComponentFactory(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, animations), gestureAnimations), drag), layout), createDomVisualElement);
...
function ReorderItemComponent(_a, externalRef) {
  ...
  return (0, import_jsx_runtime11.jsx)(Component3, __spreadProps(__spreadValues({ drag: axis }, props), { dragSnapToOrigin: true, style: __spreadProps(__spreadValues({}, style), { x: point2.x, y: point2.y, zIndex }), layout: layout2, onDrag: (event, gesturePoint) => {
