import {
  devtools
} from "./chunk-LPELZQOY.js";
import {
  require_with_selector
} from "./chunk-KOH5FCVX.js";
import {
  require_color,
...
import {
  ...
  createCache,
  extractStyle
} from "./chunk-ZZG5QB7Y.js";
import {
  init_emotion_memoize_esm,
  memoize
} from "./chunk-YZIFLJUH.js";
import {
  require_jsx_runtime
...
var createEmotionContext = function createEmotionContext2(emotion) {
  return (0, import_react2.createContext)(emotion);
};
...
var createGlobalStyleFactory = function createGlobalStyleFactory2(useTheme3) {
  return function() {
    ...
    return (0, import_react5.memo)(function(props) {
      var theme = useTheme3();
...
var createStylishFactory = function createStylishFactory2(createStyles3) {
  return function(cssStyleOrGetCssStyleFn) {
    var useStyles2 = createStyles3(cssStyleOrGetCssStyleFn);
    return function(props) {
      var _useStyles = useStyles2(props), styles = _useStyles.styles;
      return styles;
    };
  };
};
...
var createStyleProvider = function createStyleProvider2(EmotionContext) {
  return (0, import_react6.memo)(function(_ref) {
    ...
    var defaultEmotion = (0, import_react6.useContext)(EmotionContext);
    ...
    var emotion = (0, import_react6.useMemo)(function() {
...
var ThemeModeContext = (0, import_react7.createContext)({
  appearance: "light",
...
var useThemeMode = function useThemeMode2() {
  return (0, import_react8.useContext)(ThemeModeContext);
};
...
var createStylesFactory = function createStylesFactory2(_ref) {
  ...
  return function(styleOrGetStyle, options) {
    ...
    return function(props) {
      var theme = useTheme3();
      var _useContext = (0, import_react13.useContext)(EmotionContext), cache2 = _useContext.cache;
...
var AntdProvider = (0, import_react15.memo)(function(_ref) {
  ...
  var antdTheme = (0, import_react15.useMemo)(function() {
...
var createInstance = function createInstance2(options) {
  ...
  var createStyles3 = createStylesFactory({
    hashPriority: internalOptions.hashPriority,
    useTheme: useTheme3,
    EmotionContext
  });
  var createGlobalStyle2 = createGlobalStyleFactory(useTheme3);
  var createStylish2 = createStylishFactory(createStyles3);
  var ThemeProvider5 = createThemeProvider({
    styledConfig: internalOptions.styled,
    StyleEngineContext,
    useTheme: useTheme3
  });
  ThemeProvider5.displayName = "AntdStyleThemeProvider";
...
// node_modules/@ant-design/pro-editor/es/Awareness/Avatars/Avatar.js
var import_color = __toESM(require_color());
var import_react22 = __toESM(require_react());
var import_jsx_runtime10 = __toESM(require_jsx_runtime());
var import_jsx_runtime11 = __toESM(require_jsx_runtime());
var Avatar = (0, import_react22.memo)(function(_ref) {
  var name = _ref.name, color = _ref.color, onClick = _ref.onClick, active = _ref.active, current = _ref.current, following = _ref.following;
  if (!name) return (0, import_jsx_runtime10.jsx)(avatar_default, {});
  var colorModel = (0, import_color.default)(color);
  return (0, import_jsx_runtime10.jsx)(tooltip_default, {
    title: name,
    showArrow: false,
    children: (0, import_jsx_runtime11.jsxs)(avatar_default, {
      shape: "circle",
      style: {
        background: color,
        outline: following ? "2px solid ".concat(color) : "",
        color: colorModel.isLight() ? "black" : "inherit",
        zIndex: following ? 1e3 : active ? 100 : 0,
        filter: active ? "none" : "grayscale(80%)",
        overflow: "initial",
        cursor: current ? "inherit" : "pointer"
      },
      onClick,
      children: [name.slice(0, 1), (0, import_jsx_runtime10.jsx)(badge_default, {
        status: active ? "success" : "default",
        color: active ? void 0 : "#d9d9d9",
        style: {
          position: "absolute",
          left: 11,
          top: 11
...
// node_modules/@ant-design/pro-editor/es/Awareness/Cursors/Cursor.js
var import_color2 = __toESM(require_color());
var import_react24 = __toESM(require_react());

// node_modules/@ant-design/pro-editor/es/theme/themes/darkAlgorithm.js
var studioDarkAlgorithm = function studioDarkAlgorithm2(seedToken, mapToken) {
  var mergeToken = theme_default.darkAlgorithm(seedToken, mapToken);
  return _objectSpread2(_objectSpread2({}, mergeToken), {}, {
...
// node_modules/@ant-design/pro-editor/es/theme/themes/antdTheme.js
var createStudioAntdTheme = function createStudioAntdTheme2(appearance) {
  var themeConfig = {
    algorithm: [theme_default.compactAlgorithm]
  };
  if (appearance === "dark") {
...
// node_modules/@ant-design/pro-editor/es/theme/themes/stylish.js
var _templateObject;
...
var getStudioStylish = function getStudioStylish2(_ref) {
  var token2 = _ref.token, css3 = _ref.css;
  var containerBgHover = css3(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    cursor: pointer;\n    transition: 150ms background-color ease-in-out;\n    &:hover {\n      background: ", ";\n    }\n  "])), token2.colorFillQuaternary);
  var controlContainerHover = css3(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    color: ", ";\n    background-color: ", ";\n    border-color: transparent;\n  "])), token2.colorText, token2.colorFillTertiary);
  var controlContainerFocused = css3(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n    color: ", " !important;\n    background-color: ", " !important;\n    border-color: ", " !important;\n    box-shadow: none;\n  "])), token2.colorText, token2.colorFillQuaternary, token2.colorPrimary);
  var defaultButtonBase = css3(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n    color: ", ";\n    background: ", ";\n    border-color: transparent;\n  "])), token2.colorTextSecondary, token2.colorFillQuaternary);
  return {
    defaultButton: css3(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n      ", ";\n\n      &:hover {\n        color: ", " !important;\n        background: ", " !important;\n        border-color: transparent !important;\n      }\n      &:focus {\n        ", ";\n        border-color: ", " !important;\n      }\n    "])), defaultButtonBase, token2.colorText, token2.colorFillSecondary, defaultButtonBase, token2.colorPrimary),
    textInfo: css3(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n      color: ", ";\n      &:hover {\n        color: ", ";\n      }\n    "])), token2.colorTextSecondary, token2.colorText),
    textDefault: css3(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n      color: ", ";\n    "])), token2.colorTextSecondary),
    containerBgHover: css3(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n      cursor: pointer;\n      transition: 150ms background-color ease-in-out;\n\n      &:hover {\n        background: ", ";\n      }\n    "])), token2.colorFillQuaternary),
    containerBgL2: css3(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n      ", ";\n      border-radius: 4px;\n      background: ", ";\n\n      &:hover {\n        background: ", ";\n      }\n    "])), containerBgHover, token2.colorFillQuaternary, token2.colorFillTertiary),
    controlContainerFocused,
    controlContainer: css3(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n      &:hover {\n        ", "\n      }\n      &:focus {\n        ", "\n      }\n    "])), controlContainerHover, controlContainerFocused),
    backgroundBlur: css3(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n      background: ", ";\n      backdrop-filter: blur(10px);\n    "])), curriedTransparentize$1(0.4)(token2.colorBgElevated))
  };
};

// node_modules/@ant-design/pro-editor/es/theme/themes/token.js
var getStudioToken = function getStudioToken2() {
  return {
...
// node_modules/@ant-design/pro-editor/es/theme/index.js
var _createInstance = createInstance({
  customToken: {
    editorPrefix: "editor"
  }
});
var createStyles2 = _createInstance.createStyles;
var ThemeProvider4 = _createInstance.ThemeProvider;

// node_modules/@ant-design/pro-editor/es/Awareness/Cursors/CursorSvg.js
var import_react23 = __toESM(require_react());
var import_jsx_runtime12 = __toESM(require_jsx_runtime());
var import_jsx_runtime13 = __toESM(require_jsx_runtime());
var Cursor = (0, import_react23.memo)(function(_ref) {
  var color = _ref.color;
  return (0, import_jsx_runtime12.jsx)("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "22",
    height: "24",
    children: (0, import_jsx_runtime13.jsxs)("g", {
      fill: "none",
      fillRule: "evenodd",
...
var useStyles = createStyles2(function(_ref) {
  var css3 = _ref.css;
  return {
    container: css3(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n    position: fixed;\n\n    z-index: 5000;\n  "]))),
    name: css3(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["\n    position: absolute;\n    top: 20px;\n    left: 20px;\n    font-size: 12px;\n    max-width: 96px;\n    padding: 2px 12px;\n    border-radius: 4px;\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n  "])))
  };
});
var Cursor2 = (0, import_react24.memo)(function(_ref2) {
  var position2 = _ref2.position, color = _ref2.color, name = _ref2.name;
  ...
  return (0, import_jsx_runtime15.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime14.jsx)(CursorSvg_default, {
      color
    }), (0, import_jsx_runtime14.jsx)("div", {
      className: styles.name,
      style: {
        backgroundColor: color,
        color: (0, import_color2.default)(color).isLight() ? "black" : "white"
      },
      children: name
    })]
  });
});
var Cursor_default = Cursor2;

// node_modules/@ant-design/pro-editor/node_modules/zustand/esm/shallow.mjs
...
// node_modules/@ant-design/pro-editor/node_modules/nanoid/url-alphabet/index.js
var urlAlphabet = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";

// node_modules/@ant-design/pro-editor/node_modules/nanoid/index.browser.js
var nanoid = (size = 21) => {
  let id = "";
...
function useStoreWithEqualityFn(api, selector = identity, equalityFn) {
  ...
  import_react25.default.useDebugValue(slice2);
  return slice2;
}

// node_modules/zustand-utils/es/context.js
var createContext5 = function createContext6() {
  var ZustandContext = (0, import_react26.createContext)(void 0);
  var Provider = function Provider2(_ref) {
    var createStore3 = _ref.createStore, children = _ref.children;
    var storeRef = (0, import_react26.useRef)();
    if (!storeRef.current) {
      storeRef.current = createStore3();
    }
    return (0, import_react26.createElement)(ZustandContext.Provider, {
      value: storeRef.current
    }, children);
  };
  var useContextStore = function useContextStore2(selector, equalityFn) {
    var store = (0, import_react26.useContext)(ZustandContext);
    if (!store) {
      throw new Error("Seems like you have not used zustand provider as an ancestor.");
    }
    return useStoreWithEqualityFn(store, selector, equalityFn);
  };
  var useStoreApi = function useStoreApi2() {
    var store = (0, import_react26.useContext)(ZustandContext);
    if (!store) {
      throw new Error("Seems like you have not used zustand provider as an ancestor.");
    }
...
var createStoreUpdater = function createStoreUpdater2(storeApi) {
  return function(key, value) {
    var deps = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [value];
    var setStateFn = arguments.length > 3 ? arguments[3] : void 0;
    ...
    (0, import_react27.useEffect)(function() {
      if (typeof value !== "undefined") {
        ...
        if ((0, import_fast_deep_equal.default)(_state === null || _state === void 0 ? void 0 : _state[key], value)) return;
...
var optionalDevtools = function optionalDevtools2(showDevTools) {
  return showDevTools ? devtools : function(f) {
    return f;
  };
};

// node_modules/zustand-utils/es/storeApiSetStore.js
var storeApiSetState = function storeApiSetState2(storeApi, state, replace2, action) {
  storeApi.setState(state, false, action);
};

// node_modules/@ant-design/pro-editor/node_modules/zustand/esm/traditional.mjs
var import_react28 = __toESM(require_react(), 1);
var import_with_selector2 = __toESM(require_with_selector(), 1);

// node_modules/@ant-design/pro-editor/node_modules/zustand/esm/vanilla.mjs
...
// node_modules/@ant-design/pro-editor/node_modules/zustand/esm/traditional.mjs
var { useDebugValue } = import_react28.default;
...
function useStoreWithEqualityFn2(api, selector = identity2, equalityFn) {
  const slice2 = useSyncExternalStoreWithSelector2(
    api.subscribe,
    api.getState,
...
var createWithEqualityFnImpl = (createState, defaultEqualityFn) => {
  ...
  const useBoundStoreWithEqualityFn = (selector, equalityFn = defaultEqualityFn) => useStoreWithEqualityFn2(api, selector, equalityFn);
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WJGV63MB.js.map
