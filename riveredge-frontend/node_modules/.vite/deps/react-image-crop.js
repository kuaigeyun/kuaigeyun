...
function v(a, h, e) {
  return a.unit === "%" ? __spreadProps(__spreadValues(__spreadValues({}, E), a), { unit: "%" }) : {
    unit: "%",
    x: a.x ? a.x / h * 100 : 0,
    y: a.y ? a.y / e * 100 : 0,
...
function D(a, h, e) {
  return a.unit ? a.unit === "px" ? __spreadProps(__spreadValues(__spreadValues({}, E), a), { unit: "px" }) : {
    unit: "px",
    x: a.x ? a.x * h / 100 : 0,
    y: a.y ? a.y * e / 100 : 0,
    width: a.width ? a.width * h / 100 : 0,
    height: a.height ? a.height * e / 100 : 0
  } : __spreadProps(__spreadValues(__spreadValues({}, E), a), { unit: "px" });
}
function k(a, h, e, n, t, d = 0, r = 0, o = n, w = t) {
  const i = __spreadValues({}, a);
...
var x = class x2 extends import_react.PureComponent {
  ...
  makePixelCrop(e) {
    const n = __spreadValues(__spreadValues({}, E), this.props.crop || {});
