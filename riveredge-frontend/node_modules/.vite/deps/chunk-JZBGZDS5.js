...
var x = class extends Ve {
  ...
  registerHTTPInterceptor(t) {
    ...
    }), this._pipe = null, Be(() => vs(this._interceptors, t));
  }
  get(t, r) {
...
var N = class {
  ...
  _send(e, t, r) {
    return __async(this, null, function* () {
      ...
      let n;
      try {
        const a = Z(e), g = e.getUrlWithParams(), p = fetch(g, __spreadValues({
          signal: r.signal
        }, a));
        this._logService.debug(`[FetchHTTPImplementation]: sending request to url ${g} with params ${a}`), n = yield p;
      } catch (a) {
        const g = new v({
          request: e,
          error: a,
      ...
      let c = null;
      if (n.body && (c = yield this._readBody(e, n, t)), o >= L.Ok && o < L.MultipleChoices)
        t.next(new q({
          body: c,
          headers: s,
          status: o,
  ...
  _readBody(e, t, r) {
    return __async(this, null, function* () {
      ...
      let l, h;
      for (; ; ) {
        const { done: f, value: y } = yield s.read();
        if (f) break;
...
var Ye = class extends Ve {
  createSocket(t) {
    try {
      const r = new WebSocket(t), n = new ho();
      return {
        URL: t,
        close: (o, i) => {
        ...
        open$: new Observable((o) => {
          const i = (c) => o.next(c);
          r.addEventListener("open", i), n.add(Be(() => r.removeEventListener("open", i)));
        }).pipe(share()),
        close$: new Observable((o) => {
          const i = (c) => o.next(c);
          r.addEventListener("close", i), n.add(Be(() => r.removeEventListener("close", i)));
        }).pipe(share()),
        error$: new Observable((o) => {
          const i = (c) => o.next(c);
          r.addEventListener("error", i), n.add(Be(() => r.removeEventListener("error", i)));
        }).pipe(share()),
        message$: new Observable((o) => {
          const i = (c) => o.next(c);
          r.addEventListener("message", i), n.add(Be(() => r.removeEventListener("message", i)));
        }).pipe(share())
      };
    } catch (r) {
...
//# sourceMappingURL=chunk-JZBGZDS5.js.map
