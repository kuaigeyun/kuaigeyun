...
var ActiveDraggableContext = (0, import_react2.createContext)(__spreadProps(__spreadValues({}, defaultCoordinates), {
  scaleX: 1,
  scaleY: 1
}));
var Status;
...
var DndContext = (0, import_react2.memo)(function DndContext2(_ref) {
  ...
  })), import_react2.default.createElement(Accessibility, __spreadProps(__spreadValues({}, accessibility), {
...
var PositionedOverlay = (0, import_react2.forwardRef)((_ref, ref) => {
  ...
  const scaleAdjustedTransform = adjustScale2 ? transform : __spreadProps(__spreadValues({}, transform), {
    scaleX: 1,
    scaleY: 1
  });
  const styles = __spreadValues(__spreadProps(__spreadValues({}, baseStyles), {
    width: rect.width,
    height: rect.height,
    top: rect.top,
    left: rect.left,
...
function createDefaultDropAnimation(options) {
  const {
    ...
    sideEffects,
    keyframes
  } = __spreadValues(__spreadValues({}, defaultDropAnimationConfiguration), options);
  return (_ref4) => {
    let _a = _ref4, {
      active,
      dragOverlay,
    ...
    const finalTransform = __spreadValues({
      x: transform.x - delta.x,
      y: transform.y - delta.y
    }, scale);
    const animationKeyframes = keyframes(__spreadProps(__spreadValues({}, rest), {
      active,
      dragOverlay,
      transform: {
        initial: transform,
    ...
    const cleanup = sideEffects == null ? void 0 : sideEffects(__spreadValues({
      active,
      dragOverlay
    }, rest));
...
//# sourceMappingURL=chunk-PXYDURDI.js.map
