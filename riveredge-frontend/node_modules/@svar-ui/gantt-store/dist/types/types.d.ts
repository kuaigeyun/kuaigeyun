...
import type { DataArray, TID, IEventBus, IPublicWritable, IEventConfig } from "@svar-ui/lib-state";
...
export type TLengthUnit = "minute" | "hour" | "day" | "week" | "month" | "quarter" | "year" | string;
...
export type GanttScaleData = {
    ...
    diff: {
        (a: Date, b: Date, lengthUnit?: TLengthUnit, unitSize?: boolean): number;
    };
};
...
export type TEditorItem = TTextFieldShape | TCounterShape | TComboFieldShape | TSliderShape | TDateFieldShape | TRadioShape | ILinksShape | ITwoStateShape;
