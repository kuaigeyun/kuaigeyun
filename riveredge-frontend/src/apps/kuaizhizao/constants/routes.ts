...
export const ROUTES = {
  ...
  AFTER_SALES_REPAIR_ORDERS: `${APP_BASE}/after-sales-service/repair-orders`,
  AFTER_SALES_DISPATCH_ORDERS: `${APP_BASE}/after-sales-service/dispatch-orders`,
  AFTER_SALES_SPARE_PART_REQUISITIONS: `${APP_BASE}/after-sales-service/spare-part-requisitions`,
  AFTER_SALES_SERVICE_SETTLEMENTS: `${APP_BASE}/after-sales-service/service-settlements`,
  AFTER_SALES_RETURN_VISITS: `${APP_BASE}/after-sales-service/return-visits`,
  ...
  INSTALL_EXECUTION: `${APP_BASE}/after-sales-service/install-execution`,
  ...
  EQUIPMENT_SPOT_CHECKS: `${APP_BASE}/equipment-management/spot-checks`,
  EQUIPMENT_ROUTE_PATROLS: `${APP_BASE}/equipment-management/route-patrols`,
  EQUIPMENT_REPAIRS: `${APP_BASE}/equipment-management/equipment-repairs`,
  MAINTENANCE_PLANS: `${APP_BASE}/equipment-management/maintenance-plans`,
  MAINTENANCE_EXECUTIONS: `${APP_BASE}/equipment-management/maintenance-executions`,
