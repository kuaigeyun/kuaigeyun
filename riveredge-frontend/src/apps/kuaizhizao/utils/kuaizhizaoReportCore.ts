...
export const REPORT_TYPE_ROUTES: Record<string, ReportTypeRoute> = {
  ...
  first_pass_yield: { api: 'production', backendType: 'first-pass-yield-analysis', templateId: 'queryTable' },
  first_pass_yield_work_order: { api: 'production', backendType: 'first-pass-yield-work-order', templateId: 'queryTable' },
  first_pass_yield_rty: { api: 'production', backendType: 'first-pass-yield-rty', templateId: 'queryTable' },
