...
export const PARAMETER_CATEGORIES: ConfigCategory[] = createCategories({
  ...
  production: [
    ...
    {
      key: 'work_order.allow_work_order_without_bom',
      nameKey: 'pages.system.configCenter.param.work_order_allow_work_order_without_bom',
      descriptionKey: 'pages.system.configCenter.param.work_order_allow_work_order_without_bom_desc',
      source: 'business_config',
      sourcePath: 'parameters.work_order.allow_work_order_without_bom',
      type: 'boolean',
    },
    ...
    {
      key: 'work_order.show_customer_name',
      nameKey: 'pages.system.configCenter.param.work_order_show_customer_name',
      descriptionKey: 'pages.system.configCenter.param.work_order_show_customer_name_desc',
      source: 'business_config',
      sourcePath: 'parameters.work_order.show_customer_name',
      type: 'boolean',
    },
