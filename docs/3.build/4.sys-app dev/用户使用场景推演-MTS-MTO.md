...
3. **第三步：关联产品工艺路线（支持物料分组绑定）**
   - **方式1：单个产品关联**（传统方式）
     - 进入"主数据管理" → "产品管理" → "物料主数据"
     - 编辑产品：产品A
     - 选择默认工艺路线：产品A工艺路线
     - 保存
   - **方式2：物料分组关联**（核心功能，新增，推荐）
     - 进入"主数据管理" → "产品管理" → "物料分组管理"
     - 创建物料分组：注塑件分组
     - 添加物料到分组：产品A、产品B、产品C（同一分组的物料）
     - 选择默认工艺路线：注塑件通用工艺路线
     - 保存
     - **系统自动应用**：
       - 产品A、产品B、产品C自动使用"注塑件通用工艺路线"
       - 创建工单时，自动应用该工艺路线
       - 如果产品有单独工艺路线，优先使用产品工艺路线（可覆盖分组工艺路线）
